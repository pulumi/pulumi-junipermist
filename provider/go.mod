...
replace github.com/Juniper/terraform-provider-mist => ../upstream
...
require (
	...
	github.com/apimatic/go-core-runtime v0.0.28 // indirect
	...
	github.com/tmunzer/mistapi-go v0.4.33 // indirect
