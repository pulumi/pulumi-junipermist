...
configured access the Junper Mist provider with Pulumi using the environment variables. After configuring the connection, run the tests by running `make test` in the project root.
