...
@CustomType
public final class DeviceprofileGatewayRoutingPoliciesTermAction {
    ...
    public static Builder builder(DeviceprofileGatewayRoutingPoliciesTermAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> prependAsPaths;
        public Builder() {}
        public Builder(DeviceprofileGatewayRoutingPoliciesTermAction defaults) {
        ...
        public DeviceprofileGatewayRoutingPoliciesTermAction build() {
            final var _resultValue = new DeviceprofileGatewayRoutingPoliciesTermAction();
