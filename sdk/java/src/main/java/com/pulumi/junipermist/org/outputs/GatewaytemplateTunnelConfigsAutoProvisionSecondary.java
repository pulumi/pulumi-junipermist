...
public final class GatewaytemplateTunnelConfigsAutoProvisionSecondary {
    ...
    public static Builder builder(GatewaytemplateTunnelConfigsAutoProvisionSecondary defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> wanNames;
        public Builder() {}
        public Builder(GatewaytemplateTunnelConfigsAutoProvisionSecondary defaults) {
        ...
        public GatewaytemplateTunnelConfigsAutoProvisionSecondary build() {
            final var _resultValue = new GatewaytemplateTunnelConfigsAutoProvisionSecondary();
