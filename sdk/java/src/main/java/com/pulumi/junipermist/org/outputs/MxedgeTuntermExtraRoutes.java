...
public final class MxedgeTuntermExtraRoutes {
    ...
    public static Builder builder(MxedgeTuntermExtraRoutes defaults) {
    ...
    public static final class Builder {
        private @Nullable String via;
        public Builder() {}
        public Builder(MxedgeTuntermExtraRoutes defaults) {
        ...
        public MxedgeTuntermExtraRoutes build() {
            final var _resultValue = new MxedgeTuntermExtraRoutes();
