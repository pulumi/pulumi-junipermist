...
public final class GatewayTunnelConfigsPrimaryArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewayTunnelConfigsPrimaryArgs Empty = new GatewayTunnelConfigsPrimaryArgs();
    ...
    private GatewayTunnelConfigsPrimaryArgs() {}
    ...
    public static Builder builder(GatewayTunnelConfigsPrimaryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayTunnelConfigsPrimaryArgs();
        }

        public Builder(GatewayTunnelConfigsPrimaryArgs defaults) {
            $ = new GatewayTunnelConfigsPrimaryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewayTunnelConfigsPrimaryArgs build() {
            if ($.hosts == null) {
                throw new MissingRequiredPropertyException("GatewayTunnelConfigsPrimaryArgs", "hosts");
            }
            if ($.wanNames == null) {
                throw new MissingRequiredPropertyException("GatewayTunnelConfigsPrimaryArgs", "wanNames");
            }
            return $;
        }
    }
