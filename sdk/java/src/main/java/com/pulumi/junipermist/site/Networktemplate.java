...
public class Networktemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public Networktemplate(String name, @Nullable NetworktemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Networktemplate(String name, @Nullable NetworktemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("junipermist:site/networktemplate:Networktemplate", name, args == null ? NetworktemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Networktemplate(String name, Output<String> id, @Nullable NetworktemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("junipermist:site/networktemplate:Networktemplate", name, state, makeResourceOptions(options, id));
    }
