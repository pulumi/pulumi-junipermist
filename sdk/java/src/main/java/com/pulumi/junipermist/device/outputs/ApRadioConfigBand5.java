...
@CustomType
public final class ApRadioConfigBand5 {
    ...
    public static Builder builder(ApRadioConfigBand5 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String preamble;
        public Builder() {}
        public Builder(ApRadioConfigBand5 defaults) {
        ...
        public ApRadioConfigBand5 build() {
            final var _resultValue = new ApRadioConfigBand5();
