...
public final class DeviceprofileSwitchAclTagsSpecArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchAclTagsSpecArgs Empty = new DeviceprofileSwitchAclTagsSpecArgs();
    ...
    private DeviceprofileSwitchAclTagsSpecArgs() {}

    private DeviceprofileSwitchAclTagsSpecArgs(DeviceprofileSwitchAclTagsSpecArgs $) {
    ...
    public static Builder builder(DeviceprofileSwitchAclTagsSpecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchAclTagsSpecArgs();
        }

        public Builder(DeviceprofileSwitchAclTagsSpecArgs defaults) {
            $ = new DeviceprofileSwitchAclTagsSpecArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileSwitchAclTagsSpecArgs build() {
            return $;
        }
    }
