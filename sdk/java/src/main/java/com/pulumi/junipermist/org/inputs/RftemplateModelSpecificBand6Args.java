...
public final class RftemplateModelSpecificBand6Args extends com.pulumi.resources.ResourceArgs {

    public static final RftemplateModelSpecificBand6Args Empty = new RftemplateModelSpecificBand6Args();
    ...
    private RftemplateModelSpecificBand6Args() {}

    private RftemplateModelSpecificBand6Args(RftemplateModelSpecificBand6Args $) {
    ...
    public static Builder builder(RftemplateModelSpecificBand6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RftemplateModelSpecificBand6Args();
        }

        public Builder(RftemplateModelSpecificBand6Args defaults) {
            $ = new RftemplateModelSpecificBand6Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder standardPower(@Nullable Output<Boolean> standardPower) {
        ...
        public RftemplateModelSpecificBand6Args build() {
            return $;
        }
    }
