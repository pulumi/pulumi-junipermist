...
public final class ApUplinkPortConfig {
    ...
    public static Builder builder(ApUplinkPortConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean keepWlansUpIfDown;
        public Builder() {}
        public Builder(ApUplinkPortConfig defaults) {
        ...
        public ApUplinkPortConfig build() {
            final var _resultValue = new ApUplinkPortConfig();
