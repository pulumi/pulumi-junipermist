...
public final class SettingMxtunnelsRadsecAcctServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final SettingMxtunnelsRadsecAcctServerArgs Empty = new SettingMxtunnelsRadsecAcctServerArgs();
    ...
    private SettingMxtunnelsRadsecAcctServerArgs() {}

    private SettingMxtunnelsRadsecAcctServerArgs(SettingMxtunnelsRadsecAcctServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(SettingMxtunnelsRadsecAcctServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SettingMxtunnelsRadsecAcctServerArgs();
        }

        public Builder(SettingMxtunnelsRadsecAcctServerArgs defaults) {
            $ = new SettingMxtunnelsRadsecAcctServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SettingMxtunnelsRadsecAcctServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("SettingMxtunnelsRadsecAcctServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("SettingMxtunnelsRadsecAcctServerArgs", "secret");
            }
            return $;
        }
    }
