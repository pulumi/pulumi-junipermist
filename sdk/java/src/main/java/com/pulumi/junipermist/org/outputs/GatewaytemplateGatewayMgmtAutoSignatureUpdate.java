...
public final class GatewaytemplateGatewayMgmtAutoSignatureUpdate {
    ...
    public static Builder builder(GatewaytemplateGatewayMgmtAutoSignatureUpdate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeOfDay;
        public Builder() {}
        public Builder(GatewaytemplateGatewayMgmtAutoSignatureUpdate defaults) {
        ...
        public GatewaytemplateGatewayMgmtAutoSignatureUpdate build() {
            final var _resultValue = new GatewaytemplateGatewayMgmtAutoSignatureUpdate();
