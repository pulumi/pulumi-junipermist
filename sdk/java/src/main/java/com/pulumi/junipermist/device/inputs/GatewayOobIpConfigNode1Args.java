...
public final class GatewayOobIpConfigNode1Args extends com.pulumi.resources.ResourceArgs {
    ...
    private GatewayOobIpConfigNode1Args() {}

    private GatewayOobIpConfigNode1Args(GatewayOobIpConfigNode1Args $) {
    ...
    public static Builder builder(GatewayOobIpConfigNode1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayOobIpConfigNode1Args();
        }

        public Builder(GatewayOobIpConfigNode1Args defaults) {
            $ = new GatewayOobIpConfigNode1Args(Objects.requireNonNull(defaults));
        }
        ...
        public GatewayOobIpConfigNode1Args build() {
            return $;
        }
    }
