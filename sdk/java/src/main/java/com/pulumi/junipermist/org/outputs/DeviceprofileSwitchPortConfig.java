...
@CustomType
public final class DeviceprofileSwitchPortConfig {
    /**
    ...
    private DeviceprofileSwitchPortConfig() {}
    /**
     * @return To disable LACP support for the AE interface
     * 
     */
    ...
    public static Builder builder(DeviceprofileSwitchPortConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String usage;
        public Builder() {}
        public Builder(DeviceprofileSwitchPortConfig defaults) {
        ...
        public Builder usage(String usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("DeviceprofileSwitchPortConfig", "usage");
            }
            this.usage = usage;
            return this;
        }
        public DeviceprofileSwitchPortConfig build() {
            final var _resultValue = new DeviceprofileSwitchPortConfig();
