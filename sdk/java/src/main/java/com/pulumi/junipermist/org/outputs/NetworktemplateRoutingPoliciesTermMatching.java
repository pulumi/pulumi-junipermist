...
@CustomType
public final class NetworktemplateRoutingPoliciesTermMatching {
    /**
    ...
    private NetworktemplateRoutingPoliciesTermMatching() {}
    /**
     * @return BGP AS, value in range 1-4294967294. Can be a Variable (e.g. `{{bgp_as}}`)
     * 
     */
    ...
    public static Builder builder(NetworktemplateRoutingPoliciesTermMatching defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> protocols;
        public Builder() {}
        public Builder(NetworktemplateRoutingPoliciesTermMatching defaults) {
        ...
        public NetworktemplateRoutingPoliciesTermMatching build() {
            final var _resultValue = new NetworktemplateRoutingPoliciesTermMatching();
