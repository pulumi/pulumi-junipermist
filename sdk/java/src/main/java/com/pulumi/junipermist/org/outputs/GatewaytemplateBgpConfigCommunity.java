...
@CustomType
public final class GatewaytemplateBgpConfigCommunity {
    private @Nullable String id;
    private @Nullable Integer localPreference;
    private @Nullable String vpnName;

    private GatewaytemplateBgpConfigCommunity() {}
    ...
    public static Builder builder(GatewaytemplateBgpConfigCommunity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vpnName;
        public Builder() {}
        public Builder(GatewaytemplateBgpConfigCommunity defaults) {
        ...
        public GatewaytemplateBgpConfigCommunity build() {
            final var _resultValue = new GatewaytemplateBgpConfigCommunity();
            _resultValue.id = id;
