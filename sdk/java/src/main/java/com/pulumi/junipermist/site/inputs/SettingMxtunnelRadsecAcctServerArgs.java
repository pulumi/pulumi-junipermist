...
public final class SettingMxtunnelRadsecAcctServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final SettingMxtunnelRadsecAcctServerArgs Empty = new SettingMxtunnelRadsecAcctServerArgs();
    ...
    private SettingMxtunnelRadsecAcctServerArgs() {}

    private SettingMxtunnelRadsecAcctServerArgs(SettingMxtunnelRadsecAcctServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(SettingMxtunnelRadsecAcctServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SettingMxtunnelRadsecAcctServerArgs();
        }

        public Builder(SettingMxtunnelRadsecAcctServerArgs defaults) {
            $ = new SettingMxtunnelRadsecAcctServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SettingMxtunnelRadsecAcctServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("SettingMxtunnelRadsecAcctServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("SettingMxtunnelRadsecAcctServerArgs", "secret");
            }
            return $;
        }
    }
