...
public final class DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs Empty = new DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs();
    ...
    private DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs() {}

    private DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs(DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs $) {
    ...
    public static Builder builder(DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs();
        }

        public Builder(DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs defaults) {
            $ = new DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs build() {
            if ($.messageProcessingModel == null) {
                throw new MissingRequiredPropertyException("DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs", "messageProcessingModel");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DeviceprofileSwitchSnmpConfigV3ConfigTargetParameterArgs", "name");
            }
            return $;
        }
    }
