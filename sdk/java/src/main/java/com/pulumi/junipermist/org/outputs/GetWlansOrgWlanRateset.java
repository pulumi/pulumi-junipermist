...
@CustomType
public final class GetWlansOrgWlanRateset {
    /**
    ...
    private GetWlansOrgWlanRateset() {}
    /**
     * @return If `template`==`custom`. EHT MCS bitmasks for 4 streams (16-bit for each stream, MCS0 is least significant bit)
     * 
     */
    ...
    public static Builder builder(GetWlansOrgWlanRateset defaults) {
    ...
    public static final class Builder {
        ...
        private String vht;
        public Builder() {}
        public Builder(GetWlansOrgWlanRateset defaults) {
        ...
        public Builder eht(String eht) {
            if (eht == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanRateset", "eht");
            }
            this.eht = eht;
            return this;
        }
        ...
        public Builder he(String he) {
            if (he == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanRateset", "he");
            }
            this.he = he;
            return this;
        }
        ...
        public Builder ht(String ht) {
            if (ht == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanRateset", "ht");
            }
            this.ht = ht;
            return this;
        }
        ...
        public Builder legacies(List<String> legacies) {
            if (legacies == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanRateset", "legacies");
            }
        ...
        public Builder minRssi(Integer minRssi) {
            if (minRssi == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanRateset", "minRssi");
            }
        ...
        public Builder template(String template) {
            if (template == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanRateset", "template");
            }
        ...
        public Builder vht(String vht) {
            if (vht == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanRateset", "vht");
            }
            this.vht = vht;
            return this;
        }
        public GetWlansOrgWlanRateset build() {
            final var _resultValue = new GetWlansOrgWlanRateset();
