...
@CustomType
public final class SwitchLocalPortConfigStormControl {
    /**
    ...
    public static Builder builder(SwitchLocalPortConfigStormControl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer percentage;
        public Builder() {}
        public Builder(SwitchLocalPortConfigStormControl defaults) {
        ...
        public SwitchLocalPortConfigStormControl build() {
            final var _resultValue = new SwitchLocalPortConfigStormControl();
