...
import com.pulumi.junipermist.org.inputs.DeviceprofileSwitchRemoteSyslogServerContentArgs;
...
public final class DeviceprofileSwitchRemoteSyslogServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchRemoteSyslogServerArgs Empty = new DeviceprofileSwitchRemoteSyslogServerArgs();
    ...
    private @Nullable Output<List<DeviceprofileSwitchRemoteSyslogServerContentArgs>> contents;

    /**
     * @return Syslog facilities and severities sent to this server
     * 
     */
    public Optional<Output<List<DeviceprofileSwitchRemoteSyslogServerContentArgs>>> contents() {
    ...
    private DeviceprofileSwitchRemoteSyslogServerArgs() {}

    private DeviceprofileSwitchRemoteSyslogServerArgs(DeviceprofileSwitchRemoteSyslogServerArgs $) {
    ...
    public static Builder builder(DeviceprofileSwitchRemoteSyslogServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchRemoteSyslogServerArgs();
        }

        public Builder(DeviceprofileSwitchRemoteSyslogServerArgs defaults) {
            $ = new DeviceprofileSwitchRemoteSyslogServerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder contents(@Nullable Output<List<DeviceprofileSwitchRemoteSyslogServerContentArgs>> contents) {
            $.contents = contents;
            return this;
        }
         ...
         * 
         */
        public Builder contents(List<DeviceprofileSwitchRemoteSyslogServerContentArgs> contents) {
         ...
         * 
         */
        public Builder contents(DeviceprofileSwitchRemoteSyslogServerContentArgs... contents) {
        ...
        public DeviceprofileSwitchRemoteSyslogServerArgs build() {
            return $;
        }
    }
