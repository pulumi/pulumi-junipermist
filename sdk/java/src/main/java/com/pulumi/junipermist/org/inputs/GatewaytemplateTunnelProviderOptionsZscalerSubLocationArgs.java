...
public final class GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs Empty = new GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs();
    ...
    private GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs() {}

    private GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs(GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs $) {
    ...
    public static Builder builder(GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs();
        }

        public Builder(GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs defaults) {
            $ = new GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewaytemplateTunnelProviderOptionsZscalerSubLocationArgs build() {
            return $;
        }
    }
