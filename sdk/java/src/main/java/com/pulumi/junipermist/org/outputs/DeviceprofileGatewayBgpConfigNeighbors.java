...
@CustomType
public final class DeviceprofileGatewayBgpConfigNeighbors {
    /**
    ...
    public static Builder builder(DeviceprofileGatewayBgpConfigNeighbors defaults) {
    ...
    public static final class Builder {
        ...
        public DeviceprofileGatewayBgpConfigNeighbors build() {
            final var _resultValue = new DeviceprofileGatewayBgpConfigNeighbors();
