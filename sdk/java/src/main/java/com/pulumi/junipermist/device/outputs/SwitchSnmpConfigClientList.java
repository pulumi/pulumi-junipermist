...
@CustomType
public final class SwitchSnmpConfigClientList {
    ...
    public static Builder builder(SwitchSnmpConfigClientList defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> clients;
        public Builder() {}
        public Builder(SwitchSnmpConfigClientList defaults) {
        ...
        public SwitchSnmpConfigClientList build() {
            final var _resultValue = new SwitchSnmpConfigClientList();
