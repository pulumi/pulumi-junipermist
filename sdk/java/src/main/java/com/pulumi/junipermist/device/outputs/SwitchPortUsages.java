...
public final class SwitchPortUsages {
    ...
    public static Builder builder(SwitchPortUsages defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder rules(@Nullable List<SwitchPortUsagesRule> rules) {
        ...
        @CustomType.Setter
        public Builder stormControl(@Nullable SwitchPortUsagesStormControl stormControl) {
        ...
        public SwitchPortUsages build() {
            final var _resultValue = new SwitchPortUsages();
