...
public final class DeviceprofileApState extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileApState Empty = new DeviceprofileApState();
    ...
    public static Builder builder(DeviceprofileApState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileApState();
        }

        public Builder(DeviceprofileApState defaults) {
            $ = new DeviceprofileApState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param type Device type discriminator for AP device profiles
         * 
         * @return builder
         * 
         */
        ...
        public DeviceprofileApState build() {
            return $;
        }
    }
