...
public final class MxtunnelAutoPreemptionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MxtunnelAutoPreemptionArgs() {}

    private MxtunnelAutoPreemptionArgs(MxtunnelAutoPreemptionArgs $) {
    ...
    public static Builder builder(MxtunnelAutoPreemptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MxtunnelAutoPreemptionArgs();
        }

        public Builder(MxtunnelAutoPreemptionArgs defaults) {
            $ = new MxtunnelAutoPreemptionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MxtunnelAutoPreemptionArgs build() {
            return $;
        }
    }
