...
@CustomType
public final class RftemplateBand5 {
    ...
    public static Builder builder(RftemplateBand5 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String preamble;
        public Builder() {}
        public Builder(RftemplateBand5 defaults) {
        ...
        public RftemplateBand5 build() {
            final var _resultValue = new RftemplateBand5();
