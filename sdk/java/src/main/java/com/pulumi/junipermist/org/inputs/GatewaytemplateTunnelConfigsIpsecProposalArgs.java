...
public final class GatewaytemplateTunnelConfigsIpsecProposalArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewaytemplateTunnelConfigsIpsecProposalArgs Empty = new GatewaytemplateTunnelConfigsIpsecProposalArgs();
    ...
    private GatewaytemplateTunnelConfigsIpsecProposalArgs() {}

    private GatewaytemplateTunnelConfigsIpsecProposalArgs(GatewaytemplateTunnelConfigsIpsecProposalArgs $) {
    ...
    public static Builder builder(GatewaytemplateTunnelConfigsIpsecProposalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewaytemplateTunnelConfigsIpsecProposalArgs();
        }

        public Builder(GatewaytemplateTunnelConfigsIpsecProposalArgs defaults) {
            $ = new GatewaytemplateTunnelConfigsIpsecProposalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewaytemplateTunnelConfigsIpsecProposalArgs build() {
            return $;
        }
    }
