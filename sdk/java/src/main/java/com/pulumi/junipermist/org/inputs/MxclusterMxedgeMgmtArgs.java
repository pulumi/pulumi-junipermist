...
public final class MxclusterMxedgeMgmtArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MxclusterMxedgeMgmtArgs() {}

    private MxclusterMxedgeMgmtArgs(MxclusterMxedgeMgmtArgs $) {
    ...
    public static Builder builder(MxclusterMxedgeMgmtArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MxclusterMxedgeMgmtArgs();
        }

        public Builder(MxclusterMxedgeMgmtArgs defaults) {
        ...
        public MxclusterMxedgeMgmtArgs build() {
            return $;
        }
    }
