...
import com.pulumi.junipermist.org.inputs.DeviceprofileApPortConfigRadsecServerArgs;
...
public final class DeviceprofileApPortConfigRadsecArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileApPortConfigRadsecArgs Empty = new DeviceprofileApPortConfigRadsecArgs();
     ...
     */
    @Import(name="servers")
    private @Nullable Output<List<DeviceprofileApPortConfigRadsecServerArgs>> servers;

    /**
     * @return List of RadSec Servers. Only if not Mist Edge.
     * 
     */
    public Optional<Output<List<DeviceprofileApPortConfigRadsecServerArgs>>> servers() {
    ...
    private DeviceprofileApPortConfigRadsecArgs() {}

    private DeviceprofileApPortConfigRadsecArgs(DeviceprofileApPortConfigRadsecArgs $) {
    ...
    public static Builder builder(DeviceprofileApPortConfigRadsecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileApPortConfigRadsecArgs();
        }

        public Builder(DeviceprofileApPortConfigRadsecArgs defaults) {
            $ = new DeviceprofileApPortConfigRadsecArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder servers(@Nullable Output<List<DeviceprofileApPortConfigRadsecServerArgs>> servers) {
            $.servers = servers;
            return this;
        }
         ...
         * 
         */
        public Builder servers(List<DeviceprofileApPortConfigRadsecServerArgs> servers) {
         ...
         * 
         */
        public Builder servers(DeviceprofileApPortConfigRadsecServerArgs... servers) {
        ...
        public DeviceprofileApPortConfigRadsecArgs build() {
            return $;
        }
    }
