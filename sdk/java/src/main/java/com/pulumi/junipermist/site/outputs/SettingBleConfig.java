...
public final class SettingBleConfig {
    ...
    public static Builder builder(SettingBleConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String powerMode;
        public Builder() {}
        public Builder(SettingBleConfig defaults) {
        ...
        public SettingBleConfig build() {
            final var _resultValue = new SettingBleConfig();
