...
import com.pulumi.junipermist.org.inputs.DeviceprofileSwitchRemoteSyslogFileArchiveArgs;
import com.pulumi.junipermist.org.inputs.DeviceprofileSwitchRemoteSyslogFileContentArgs;
...
public final class DeviceprofileSwitchRemoteSyslogFileArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchRemoteSyslogFileArgs Empty = new DeviceprofileSwitchRemoteSyslogFileArgs();
     ...
     */
    @Import(name="archive")
    private @Nullable Output<DeviceprofileSwitchRemoteSyslogFileArchiveArgs> archive;

    /**
     * @return Retention settings for this generated syslog file
     * 
     */
    public Optional<Output<DeviceprofileSwitchRemoteSyslogFileArchiveArgs>> archive() {
    ...
    private @Nullable Output<List<DeviceprofileSwitchRemoteSyslogFileContentArgs>> contents;

    /**
     * @return Syslog facilities and severities written to this file
     * 
     */
    public Optional<Output<List<DeviceprofileSwitchRemoteSyslogFileContentArgs>>> contents() {
    ...
    private DeviceprofileSwitchRemoteSyslogFileArgs() {}

    private DeviceprofileSwitchRemoteSyslogFileArgs(DeviceprofileSwitchRemoteSyslogFileArgs $) {
    ...
    public static Builder builder(DeviceprofileSwitchRemoteSyslogFileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchRemoteSyslogFileArgs();
        }

        public Builder(DeviceprofileSwitchRemoteSyslogFileArgs defaults) {
            $ = new DeviceprofileSwitchRemoteSyslogFileArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder archive(@Nullable Output<DeviceprofileSwitchRemoteSyslogFileArchiveArgs> archive) {
            $.archive = archive;
            return this;
        }
         ...
         * 
         */
        public Builder archive(DeviceprofileSwitchRemoteSyslogFileArchiveArgs archive) {
         ...
         * 
         */
        public Builder contents(@Nullable Output<List<DeviceprofileSwitchRemoteSyslogFileContentArgs>> contents) {
            $.contents = contents;
            return this;
        }
         ...
         * 
         */
        public Builder contents(List<DeviceprofileSwitchRemoteSyslogFileContentArgs> contents) {
         ...
         * 
         */
        public Builder contents(DeviceprofileSwitchRemoteSyslogFileContentArgs... contents) {
        ...
        public DeviceprofileSwitchRemoteSyslogFileArgs build() {
            return $;
        }
    }
