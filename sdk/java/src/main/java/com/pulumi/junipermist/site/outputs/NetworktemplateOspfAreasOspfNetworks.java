...
@CustomType
public final class NetworktemplateOspfAreasOspfNetworks {
    /**
    ...
    private NetworktemplateOspfAreasOspfNetworks() {}
    /**
     * @return Required if `auth_type`==`md5`. Property key is the key number
     * 
     */
    ...
    public static Builder builder(NetworktemplateOspfAreasOspfNetworks defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean passive;
        public Builder() {}
        public Builder(NetworktemplateOspfAreasOspfNetworks defaults) {
        ...
        public NetworktemplateOspfAreasOspfNetworks build() {
            final var _resultValue = new NetworktemplateOspfAreasOspfNetworks();
