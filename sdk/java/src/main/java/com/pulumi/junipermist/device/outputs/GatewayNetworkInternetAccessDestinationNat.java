...
public final class GatewayNetworkInternetAccessDestinationNat {
    ...
    public static Builder builder(GatewayNetworkInternetAccessDestinationNat defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wanName;
        public Builder() {}
        public Builder(GatewayNetworkInternetAccessDestinationNat defaults) {
        ...
        public GatewayNetworkInternetAccessDestinationNat build() {
            final var _resultValue = new GatewayNetworkInternetAccessDestinationNat();
