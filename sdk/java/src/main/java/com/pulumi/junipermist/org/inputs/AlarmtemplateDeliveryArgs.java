...
public final class AlarmtemplateDeliveryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AlarmtemplateDeliveryArgs() {}

    private AlarmtemplateDeliveryArgs(AlarmtemplateDeliveryArgs $) {
    ...
    public static Builder builder(AlarmtemplateDeliveryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlarmtemplateDeliveryArgs();
        }

        public Builder(AlarmtemplateDeliveryArgs defaults) {
            $ = new AlarmtemplateDeliveryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AlarmtemplateDeliveryArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("AlarmtemplateDeliveryArgs", "enabled");
            }
            return $;
        }
    }
