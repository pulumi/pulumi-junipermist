...
import com.pulumi.junipermist.org.outputs.DeviceprofileGatewayPortConfigVpnPathsTrafficShaping;
...
public final class DeviceprofileGatewayPortConfigVpnPaths {
    ...
    public Optional<DeviceprofileGatewayPortConfigVpnPathsTrafficShaping> trafficShaping() {
    ...
    public static Builder builder(DeviceprofileGatewayPortConfigVpnPaths defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable DeviceprofileGatewayPortConfigVpnPathsTrafficShaping trafficShaping;
        public Builder() {}
        public Builder(DeviceprofileGatewayPortConfigVpnPaths defaults) {
        ...
        @CustomType.Setter
        public Builder trafficShaping(@Nullable DeviceprofileGatewayPortConfigVpnPathsTrafficShaping trafficShaping) {

            this.trafficShaping = trafficShaping;
            return this;
        }
        public DeviceprofileGatewayPortConfigVpnPaths build() {
