...
public final class SwitchRemoteSyslogServerContentArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchRemoteSyslogServerContentArgs Empty = new SwitchRemoteSyslogServerContentArgs();
    ...
    private SwitchRemoteSyslogServerContentArgs() {}

    private SwitchRemoteSyslogServerContentArgs(SwitchRemoteSyslogServerContentArgs $) {
    ...
    public static Builder builder(SwitchRemoteSyslogServerContentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchRemoteSyslogServerContentArgs();
        }

        public Builder(SwitchRemoteSyslogServerContentArgs defaults) {
            $ = new SwitchRemoteSyslogServerContentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchRemoteSyslogServerContentArgs build() {
            return $;
        }
    }
