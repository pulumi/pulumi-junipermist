...
public final class ServicepolicyAntivirus {
    ...
    public static Builder builder(ServicepolicyAntivirus defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String profile;
        public Builder() {}
        public Builder(ServicepolicyAntivirus defaults) {
        ...
        public ServicepolicyAntivirus build() {
            final var _resultValue = new ServicepolicyAntivirus();
