...
public final class DeviceprofileGatewayIdpProfilesOverwriteMatching {
    ...
    public static Builder builder(DeviceprofileGatewayIdpProfilesOverwriteMatching defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> severities;
        public Builder() {}
        public Builder(DeviceprofileGatewayIdpProfilesOverwriteMatching defaults) {
        ...
        public DeviceprofileGatewayIdpProfilesOverwriteMatching build() {
            final var _resultValue = new DeviceprofileGatewayIdpProfilesOverwriteMatching();
