...
public final class SwitchRemoteSyslogFileContentArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchRemoteSyslogFileContentArgs Empty = new SwitchRemoteSyslogFileContentArgs();
    ...
    private SwitchRemoteSyslogFileContentArgs() {}

    private SwitchRemoteSyslogFileContentArgs(SwitchRemoteSyslogFileContentArgs $) {
    ...
    public static Builder builder(SwitchRemoteSyslogFileContentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchRemoteSyslogFileContentArgs();
        }

        public Builder(SwitchRemoteSyslogFileContentArgs defaults) {
            $ = new SwitchRemoteSyslogFileContentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchRemoteSyslogFileContentArgs build() {
            return $;
        }
    }
