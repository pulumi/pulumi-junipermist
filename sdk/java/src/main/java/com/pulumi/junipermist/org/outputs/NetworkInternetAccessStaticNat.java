...
@CustomType
public final class NetworkInternetAccessStaticNat {
    /**
    ...
    private NetworkInternetAccessStaticNat() {}
    /**
     * @return The Static NAT destination IP Address. Must be an IP Address (i.e. &#34;192.168.70.3&#34;) or a Variable (i.e. &#34;{{myvar}}&#34;)
     * 
     */
    ...
    public static Builder builder(NetworkInternetAccessStaticNat defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wanName;
        public Builder() {}
        public Builder(NetworkInternetAccessStaticNat defaults) {
        ...
        public Builder internalIp(String internalIp) {
            if (internalIp == null) {
              throw new MissingRequiredPropertyException("NetworkInternetAccessStaticNat", "internalIp");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("NetworkInternetAccessStaticNat", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public NetworkInternetAccessStaticNat build() {
            final var _resultValue = new NetworkInternetAccessStaticNat();
