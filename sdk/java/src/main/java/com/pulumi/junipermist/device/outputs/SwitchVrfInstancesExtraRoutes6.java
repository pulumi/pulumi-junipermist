...
public final class SwitchVrfInstancesExtraRoutes6 {
    ...
    public static Builder builder(SwitchVrfInstancesExtraRoutes6 defaults) {
    ...
    public static final class Builder {
        private @Nullable String via;
        public Builder() {}
        public Builder(SwitchVrfInstancesExtraRoutes6 defaults) {
        ...
        public SwitchVrfInstancesExtraRoutes6 build() {
            final var _resultValue = new SwitchVrfInstancesExtraRoutes6();
