...
import com.pulumi.junipermist.device.inputs.SwitchDhcpdConfigConfigFixedBindingsArgs;
import com.pulumi.junipermist.device.inputs.SwitchDhcpdConfigConfigOptionsArgs;
import com.pulumi.junipermist.device.inputs.SwitchDhcpdConfigConfigVendorEncapulatedArgs;
...
public final class SwitchDhcpdConfigConfigArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<Map<String,SwitchDhcpdConfigConfigVendorEncapulatedArgs>>> vendorEncapulated() {
        return Optional.ofNullable(this.vendorEncapulated);
    }

    private SwitchDhcpdConfigConfigArgs() {}

    private SwitchDhcpdConfigConfigArgs(SwitchDhcpdConfigConfigArgs $) {
    ...
    public static Builder builder(SwitchDhcpdConfigConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchDhcpdConfigConfigArgs();
        }

        public Builder(SwitchDhcpdConfigConfigArgs defaults) {
            $ = new SwitchDhcpdConfigConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder fixedBindings(@Nullable Output<Map<String,SwitchDhcpdConfigConfigFixedBindingsArgs>> fixedBindings) {
         ...
         * 
         */
        public Builder fixedBindings(Map<String,SwitchDhcpdConfigConfigFixedBindingsArgs> fixedBindings) {
         ...
         * 
         */
        public Builder options(@Nullable Output<Map<String,SwitchDhcpdConfigConfigOptionsArgs>> options) {
            $.options = options;
            return this;
        }
         ...
         * 
         */
        public Builder options(Map<String,SwitchDhcpdConfigConfigOptionsArgs> options) {
         ...
         * 
         */
        public Builder vendorEncapulated(@Nullable Output<Map<String,SwitchDhcpdConfigConfigVendorEncapulatedArgs>> vendorEncapulated) {
         ...
         * 
         */
        public Builder vendorEncapulated(Map<String,SwitchDhcpdConfigConfigVendorEncapulatedArgs> vendorEncapulated) {
            return vendorEncapulated(Output.of(vendorEncapulated));
        }

        public SwitchDhcpdConfigConfigArgs build() {
            return $;
        }
    }
