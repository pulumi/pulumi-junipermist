...
public final class GatewaytemplateRoutingPoliciesTermMatchingVpnPathSla {
    ...
    public static Builder builder(GatewaytemplateRoutingPoliciesTermMatchingVpnPathSla defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maxLoss;
        public Builder() {}
        public Builder(GatewaytemplateRoutingPoliciesTermMatchingVpnPathSla defaults) {
        ...
        public GatewaytemplateRoutingPoliciesTermMatchingVpnPathSla build() {
            final var _resultValue = new GatewaytemplateRoutingPoliciesTermMatchingVpnPathSla();
