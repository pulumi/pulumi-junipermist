...
@CustomType
public final class GatewayIpConfigs {
    private String ip;
    ...
    public static Builder builder(GatewayIpConfigs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(GatewayIpConfigs defaults) {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("GatewayIpConfigs", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public Builder netmask(String netmask) {
            if (netmask == null) {
              throw new MissingRequiredPropertyException("GatewayIpConfigs", "netmask");
            }
        ...
        public GatewayIpConfigs build() {
            final var _resultValue = new GatewayIpConfigs();
            _resultValue.ip = ip;
