...
public final class ApIpConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ApIpConfigArgs() {}

    private ApIpConfigArgs(ApIpConfigArgs $) {
        this.dns = $.dns;
    ...
    public static Builder builder(ApIpConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApIpConfigArgs defaults) {
            $ = new ApIpConfigArgs(Objects.requireNonNull(defaults));
        }
