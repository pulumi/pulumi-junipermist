...
public final class WlanAuthServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final WlanAuthServerArgs Empty = new WlanAuthServerArgs();
    ...
    private WlanAuthServerArgs() {}

    private WlanAuthServerArgs(WlanAuthServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(WlanAuthServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WlanAuthServerArgs();
        }

        public Builder(WlanAuthServerArgs defaults) {
            $ = new WlanAuthServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WlanAuthServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("WlanAuthServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("WlanAuthServerArgs", "secret");
            }
            return $;
        }
    }
