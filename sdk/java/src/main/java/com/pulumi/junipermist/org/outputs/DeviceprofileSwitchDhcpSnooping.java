...
@CustomType
public final class DeviceprofileSwitchDhcpSnooping {
    /**
    ...
    private DeviceprofileSwitchDhcpSnooping() {}
    /**
     * @return Whether DHCP snooping applies to all configured networks
     * 
     */
    ...
    public static Builder builder(DeviceprofileSwitchDhcpSnooping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> networks;
        public Builder() {}
        public Builder(DeviceprofileSwitchDhcpSnooping defaults) {
        ...
        public DeviceprofileSwitchDhcpSnooping build() {
            final var _resultValue = new DeviceprofileSwitchDhcpSnooping();
