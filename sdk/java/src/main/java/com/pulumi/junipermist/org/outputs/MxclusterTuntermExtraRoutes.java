...
public final class MxclusterTuntermExtraRoutes {
    ...
    public static Builder builder(MxclusterTuntermExtraRoutes defaults) {
    ...
    public static final class Builder {
        private @Nullable String via;
        public Builder() {}
        public Builder(MxclusterTuntermExtraRoutes defaults) {
        ...
        public MxclusterTuntermExtraRoutes build() {
            final var _resultValue = new MxclusterTuntermExtraRoutes();
