...
@CustomType
public final class WlanRatesetBand5 {
    /**
    ...
    public static Builder builder(WlanRatesetBand5 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vht;
        public Builder() {}
        public Builder(WlanRatesetBand5 defaults) {
        ...
        public WlanRatesetBand5 build() {
            final var _resultValue = new WlanRatesetBand5();
            _resultValue.ht = ht;
