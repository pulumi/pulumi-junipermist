...
@CustomType
public final class GetGatewayStatsDeviceGatewayStatServiceStat {
    ...
    private GetGatewayStatsDeviceGatewayStatServiceStat() {}
    ...
    public static Builder builder(GetGatewayStatsDeviceGatewayStatServiceStat defaults) {
    ...
    public static final class Builder {
        ...
        private String wheeljackVersion;
        public Builder() {}
        public Builder(GetGatewayStatsDeviceGatewayStatServiceStat defaults) {
        ...
        public Builder ashVersion(String ashVersion) {
            if (ashVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "ashVersion");
            }
        ...
        public Builder ciaVersion(String ciaVersion) {
            if (ciaVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "ciaVersion");
            }
        ...
        public Builder emberVersion(String emberVersion) {
            if (emberVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "emberVersion");
            }
        ...
        public Builder ipsecClientVersion(String ipsecClientVersion) {
            if (ipsecClientVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "ipsecClientVersion");
            }
        ...
        public Builder mistAgentVersion(String mistAgentVersion) {
            if (mistAgentVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "mistAgentVersion");
            }
        ...
        public Builder packageVersion(String packageVersion) {
            if (packageVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "packageVersion");
            }
        ...
        public Builder testingToolsVersion(String testingToolsVersion) {
            if (testingToolsVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "testingToolsVersion");
            }
        ...
        public Builder wheeljackVersion(String wheeljackVersion) {
            if (wheeljackVersion == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatServiceStat", "wheeljackVersion");
            }
            this.wheeljackVersion = wheeljackVersion;
            return this;
        }
        public GetGatewayStatsDeviceGatewayStatServiceStat build() {
            final var _resultValue = new GetGatewayStatsDeviceGatewayStatServiceStat();
