...
@CustomType
public final class GetGatewayStatsDeviceGatewayStatCpu2Stat {
    /**
    ...
    private GetGatewayStatsDeviceGatewayStatCpu2Stat() {}
    /**
     * @return Percentage of CPU time that is idle
     * 
     */
    ...
    public static Builder builder(GetGatewayStatsDeviceGatewayStatCpu2Stat defaults) {
    ...
    public static final class Builder {
        ...
        private Double user;
        public Builder() {}
        public Builder(GetGatewayStatsDeviceGatewayStatCpu2Stat defaults) {
        ...
        public Builder idle(Double idle) {
            if (idle == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpu2Stat", "idle");
            }
            this.idle = idle;
            return this;
        }
        ...
        public Builder interrupt(Double interrupt) {
            if (interrupt == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpu2Stat", "interrupt");
            }
        ...
        public Builder loadAvgs(List<Double> loadAvgs) {
            if (loadAvgs == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpu2Stat", "loadAvgs");
            }
        ...
        public Builder system(Double system) {
            if (system == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpu2Stat", "system");
            }
            this.system = system;
            return this;
        }
        ...
        public Builder usage(Double usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpu2Stat", "usage");
            }
            this.usage = usage;
            return this;
        }
        ...
        public Builder user(Double user) {
            if (user == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpu2Stat", "user");
            }
            this.user = user;
            return this;
        }
        public GetGatewayStatsDeviceGatewayStatCpu2Stat build() {
            final var _resultValue = new GetGatewayStatsDeviceGatewayStatCpu2Stat();
