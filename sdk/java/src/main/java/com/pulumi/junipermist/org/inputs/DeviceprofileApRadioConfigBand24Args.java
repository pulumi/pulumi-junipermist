...
public final class DeviceprofileApRadioConfigBand24Args extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileApRadioConfigBand24Args Empty = new DeviceprofileApRadioConfigBand24Args();
    ...
    private DeviceprofileApRadioConfigBand24Args() {}

    private DeviceprofileApRadioConfigBand24Args(DeviceprofileApRadioConfigBand24Args $) {
    ...
    public static Builder builder(DeviceprofileApRadioConfigBand24Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileApRadioConfigBand24Args();
        }

        public Builder(DeviceprofileApRadioConfigBand24Args defaults) {
            $ = new DeviceprofileApRadioConfigBand24Args(Objects.requireNonNull(defaults));
        }

        /**
         * @param allowRrmDisable Whether RRM may disable the 2.4 GHz radio when optimizing RF settings
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param antGain External antenna gain for the 2.4 GHz radio
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param channels Allowed channel list for the 2.4 GHz radio; null or an empty array uses automatic selection
         * 
         * @return builder
         * 
         */
        ...
        public DeviceprofileApRadioConfigBand24Args build() {
            return $;
        }
    }
