...
public final class GatewayBgpConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewayBgpConfigArgs Empty = new GatewayBgpConfigArgs();
    ...
    private @Nullable Output<Map<String,GatewayBgpConfigNeighborsArgs>> neighbors;

    /**
     * @return Required if `via`==`lan`, `via`==`tunnel` or `via`==`wan`. If per-neighbor as is desired. Property key is the neighbor address
     * 
     */
    public Optional<Output<Map<String,GatewayBgpConfigNeighborsArgs>>> neighbors() {
    ...
    private GatewayBgpConfigArgs() {}

    private GatewayBgpConfigArgs(GatewayBgpConfigArgs $) {
    ...
    public static Builder builder(GatewayBgpConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayBgpConfigArgs();
        }

        public Builder(GatewayBgpConfigArgs defaults) {
            $ = new GatewayBgpConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder neighbors(@Nullable Output<Map<String,GatewayBgpConfigNeighborsArgs>> neighbors) {
            $.neighbors = neighbors;
            return this;
        }
         ...
         * 
         */
        public Builder neighbors(Map<String,GatewayBgpConfigNeighborsArgs> neighbors) {
        ...
        public GatewayBgpConfigArgs build() {
            if ($.via == null) {
                throw new MissingRequiredPropertyException("GatewayBgpConfigArgs", "via");
            }
            return $;
        }
    }
