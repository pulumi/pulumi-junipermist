...
@CustomType
public final class ApRadioConfigBand5On24Radio {
    ...
    private ApRadioConfigBand5On24Radio() {}
    ...
    public static Builder builder(ApRadioConfigBand5On24Radio defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String preamble;
        public Builder() {}
        public Builder(ApRadioConfigBand5On24Radio defaults) {
        ...
        public ApRadioConfigBand5On24Radio build() {
