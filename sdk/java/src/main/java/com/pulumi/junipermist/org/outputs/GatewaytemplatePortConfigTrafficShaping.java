...
@CustomType
public final class GatewaytemplatePortConfigTrafficShaping {
    /**
    ...
    private GatewaytemplatePortConfigTrafficShaping() {}
    /**
     * @return percentages for different class of traffic: high / medium / low / best-effort. Sum must be equal to 100
     * 
     */
    ...
    public static Builder builder(GatewaytemplatePortConfigTrafficShaping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maxTxKbps;
        public Builder() {}
        public Builder(GatewaytemplatePortConfigTrafficShaping defaults) {
        ...
        public GatewaytemplatePortConfigTrafficShaping build() {
            final var _resultValue = new GatewaytemplatePortConfigTrafficShaping();
