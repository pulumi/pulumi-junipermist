...
@CustomType
public final class SwitchRemoteSyslogFileContent {
    /**
    ...
    public static Builder builder(SwitchRemoteSyslogFileContent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String severity;
        public Builder() {}
        public Builder(SwitchRemoteSyslogFileContent defaults) {
        ...
        public SwitchRemoteSyslogFileContent build() {
            final var _resultValue = new SwitchRemoteSyslogFileContent();
