...
@CustomType
public final class DeviceprofileApPortConfigRadiusConfigAcctServer {
    /**
    ...
    private DeviceprofileApPortConfigRadiusConfigAcctServer() {}
    /**
     * @return IP/ hostname of RADIUS server
     * 
     */
    ...
    public static Builder builder(DeviceprofileApPortConfigRadiusConfigAcctServer defaults) {
    ...
    public static final class Builder {
        ...
        private String secret;
        public Builder() {}
        public Builder(DeviceprofileApPortConfigRadiusConfigAcctServer defaults) {
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("DeviceprofileApPortConfigRadiusConfigAcctServer", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("DeviceprofileApPortConfigRadiusConfigAcctServer", "secret");
            }
            this.secret = secret;
            return this;
        }
        public DeviceprofileApPortConfigRadiusConfigAcctServer build() {
            final var _resultValue = new DeviceprofileApPortConfigRadiusConfigAcctServer();
