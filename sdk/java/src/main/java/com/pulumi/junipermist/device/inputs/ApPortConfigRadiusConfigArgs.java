...
import com.pulumi.junipermist.device.inputs.ApPortConfigRadiusConfigAcctServerArgs;
import com.pulumi.junipermist.device.inputs.ApPortConfigRadiusConfigAuthServerArgs;
...
public final class ApPortConfigRadiusConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApPortConfigRadiusConfigArgs Empty = new ApPortConfigRadiusConfigArgs();
    ...
    private @Nullable Output<List<ApPortConfigRadiusConfigAcctServerArgs>> acctServers;

    public Optional<Output<List<ApPortConfigRadiusConfigAcctServerArgs>>> acctServers() {
        return Optional.ofNullable(this.acctServers);
    }

    @Import(name="authServers")
    private @Nullable Output<List<ApPortConfigRadiusConfigAuthServerArgs>> authServers;

    public Optional<Output<List<ApPortConfigRadiusConfigAuthServerArgs>>> authServers() {
    ...
    private ApPortConfigRadiusConfigArgs() {}

    private ApPortConfigRadiusConfigArgs(ApPortConfigRadiusConfigArgs $) {
    ...
    public static Builder builder(ApPortConfigRadiusConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApPortConfigRadiusConfigArgs();
        }

        public Builder(ApPortConfigRadiusConfigArgs defaults) {
            $ = new ApPortConfigRadiusConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder acctServers(@Nullable Output<List<ApPortConfigRadiusConfigAcctServerArgs>> acctServers) {
            $.acctServers = acctServers;
            return this;
        }

        public Builder acctServers(List<ApPortConfigRadiusConfigAcctServerArgs> acctServers) {
            return acctServers(Output.of(acctServers));
        }

        public Builder acctServers(ApPortConfigRadiusConfigAcctServerArgs... acctServers) {
            return acctServers(List.of(acctServers));
        }

        public Builder authServers(@Nullable Output<List<ApPortConfigRadiusConfigAuthServerArgs>> authServers) {
            $.authServers = authServers;
            return this;
        }

        public Builder authServers(List<ApPortConfigRadiusConfigAuthServerArgs> authServers) {
            return authServers(Output.of(authServers));
        }

        public Builder authServers(ApPortConfigRadiusConfigAuthServerArgs... authServers) {
        ...
        public ApPortConfigRadiusConfigArgs build() {
            return $;
        }
    }
