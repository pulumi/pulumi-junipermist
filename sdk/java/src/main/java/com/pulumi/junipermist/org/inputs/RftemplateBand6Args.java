...
public final class RftemplateBand6Args extends com.pulumi.resources.ResourceArgs {

    public static final RftemplateBand6Args Empty = new RftemplateBand6Args();
    ...
    private RftemplateBand6Args() {}

    private RftemplateBand6Args(RftemplateBand6Args $) {
    ...
    public static Builder builder(RftemplateBand6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RftemplateBand6Args();
        }

        public Builder(RftemplateBand6Args defaults) {
            $ = new RftemplateBand6Args(Objects.requireNonNull(defaults));
        }
        ...
        public RftemplateBand6Args build() {
            return $;
        }
    }
