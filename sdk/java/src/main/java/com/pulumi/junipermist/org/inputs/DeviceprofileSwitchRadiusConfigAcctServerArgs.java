...
public final class DeviceprofileSwitchRadiusConfigAcctServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchRadiusConfigAcctServerArgs Empty = new DeviceprofileSwitchRadiusConfigAcctServerArgs();
    ...
    private DeviceprofileSwitchRadiusConfigAcctServerArgs() {}

    private DeviceprofileSwitchRadiusConfigAcctServerArgs(DeviceprofileSwitchRadiusConfigAcctServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(DeviceprofileSwitchRadiusConfigAcctServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchRadiusConfigAcctServerArgs();
        }

        public Builder(DeviceprofileSwitchRadiusConfigAcctServerArgs defaults) {
            $ = new DeviceprofileSwitchRadiusConfigAcctServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileSwitchRadiusConfigAcctServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("DeviceprofileSwitchRadiusConfigAcctServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("DeviceprofileSwitchRadiusConfigAcctServerArgs", "secret");
            }
            return $;
        }
    }
