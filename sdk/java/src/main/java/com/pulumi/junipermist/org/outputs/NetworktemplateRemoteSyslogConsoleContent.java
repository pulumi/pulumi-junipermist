...
@CustomType
public final class NetworktemplateRemoteSyslogConsoleContent {
    /**
    ...
    private NetworktemplateRemoteSyslogConsoleContent() {}
    /**
     * @return enum: `any`, `authorization`, `change-log`, `config`, `conflict-log`, `daemon`, `dfc`, `external`, `firewall`, `ftp`, `interactive-commands`, `kernel`, `ntp`, `pfe`, `security`, `user`
     * 
     */
    ...
    public static Builder builder(NetworktemplateRemoteSyslogConsoleContent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String severity;
        public Builder() {}
        public Builder(NetworktemplateRemoteSyslogConsoleContent defaults) {
        ...
        public NetworktemplateRemoteSyslogConsoleContent build() {
            final var _resultValue = new NetworktemplateRemoteSyslogConsoleContent();
