...
import com.pulumi.junipermist.org.outputs.GatewaytemplateGatewayMgmtAppProbing;
import com.pulumi.junipermist.org.outputs.GatewaytemplateGatewayMgmtAutoSignatureUpdate;
import com.pulumi.junipermist.org.outputs.GatewaytemplateGatewayMgmtProtectRe;
...
@CustomType
public final class GatewaytemplateGatewayMgmt {
    /**
     * @return For SSR only, as direct root access is not allowed
     * 
     */
    private @Nullable List<String> adminSshkeys;
    private @Nullable GatewaytemplateGatewayMgmtAppProbing appProbing;
    /**
     * @return Consumes uplink bandwidth, requires WA license
     * 
     */
    private @Nullable Boolean appUsage;
    private @Nullable GatewaytemplateGatewayMgmtAutoSignatureUpdate autoSignatureUpdate;
    /**
     ...
     * 
     */
    private @Nullable GatewaytemplateGatewayMgmtProtectRe protectRe;
    /**
     * @return SRX only
     * 
     */
    ...
    public Optional<GatewaytemplateGatewayMgmtAppProbing> appProbing() {
    ...
    public Optional<GatewaytemplateGatewayMgmtAutoSignatureUpdate> autoSignatureUpdate() {
     ...
     * 
     */
    public Optional<GatewaytemplateGatewayMgmtProtectRe> protectRe() {
    ...
    public static Builder builder(GatewaytemplateGatewayMgmt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String securityLogSourceInterface;
        public Builder() {}
        public Builder(GatewaytemplateGatewayMgmt defaults) {
        ...
        @CustomType.Setter
        public Builder appProbing(@Nullable GatewaytemplateGatewayMgmtAppProbing appProbing) {
        ...
        @CustomType.Setter
        public Builder autoSignatureUpdate(@Nullable GatewaytemplateGatewayMgmtAutoSignatureUpdate autoSignatureUpdate) {
        ...
        @CustomType.Setter
        public Builder protectRe(@Nullable GatewaytemplateGatewayMgmtProtectRe protectRe) {
        ...
        public GatewaytemplateGatewayMgmt build() {
            final var _resultValue = new GatewaytemplateGatewayMgmt();
