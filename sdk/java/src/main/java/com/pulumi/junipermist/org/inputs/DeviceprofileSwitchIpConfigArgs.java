...
public final class DeviceprofileSwitchIpConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchIpConfigArgs Empty = new DeviceprofileSwitchIpConfigArgs();
    ...
    /**
     * @return Configured DNS server addresses for Junos management traffic
     * 
     */
    ...
    private DeviceprofileSwitchIpConfigArgs() {}

    private DeviceprofileSwitchIpConfigArgs(DeviceprofileSwitchIpConfigArgs $) {
        this.dns = $.dns;
    ...
    public static Builder builder(DeviceprofileSwitchIpConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchIpConfigArgs();
        }

        public Builder(DeviceprofileSwitchIpConfigArgs defaults) {
            $ = new DeviceprofileSwitchIpConfigArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param dns Configured DNS server addresses for Junos management traffic
         * 
         * @return builder
         * 
         */
        ...
        public DeviceprofileSwitchIpConfigArgs build() {
            return $;
        }
    }
