...
import com.pulumi.junipermist.org.inputs.GatewaytemplateGatewayMgmtAppProbingArgs;
import com.pulumi.junipermist.org.inputs.GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs;
import com.pulumi.junipermist.org.inputs.GatewaytemplateGatewayMgmtProtectReArgs;
...
public final class GatewaytemplateGatewayMgmtArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewaytemplateGatewayMgmtArgs Empty = new GatewaytemplateGatewayMgmtArgs();
    ...
    private @Nullable Output<GatewaytemplateGatewayMgmtAppProbingArgs> appProbing;

    public Optional<Output<GatewaytemplateGatewayMgmtAppProbingArgs>> appProbing() {
    ...
    private @Nullable Output<GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs> autoSignatureUpdate;

    public Optional<Output<GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs>> autoSignatureUpdate() {
    ...
    private @Nullable Output<GatewaytemplateGatewayMgmtProtectReArgs> protectRe;
     ...
     * 
     */
    public Optional<Output<GatewaytemplateGatewayMgmtProtectReArgs>> protectRe() {
    ...
    private GatewaytemplateGatewayMgmtArgs() {}

    private GatewaytemplateGatewayMgmtArgs(GatewaytemplateGatewayMgmtArgs $) {
    ...
    public static Builder builder(GatewaytemplateGatewayMgmtArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewaytemplateGatewayMgmtArgs();
        }

        public Builder(GatewaytemplateGatewayMgmtArgs defaults) {
            $ = new GatewaytemplateGatewayMgmtArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder appProbing(@Nullable Output<GatewaytemplateGatewayMgmtAppProbingArgs> appProbing) {
            $.appProbing = appProbing;
            return this;
        }

        public Builder appProbing(GatewaytemplateGatewayMgmtAppProbingArgs appProbing) {
        ...
        public Builder autoSignatureUpdate(@Nullable Output<GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs> autoSignatureUpdate) {
            $.autoSignatureUpdate = autoSignatureUpdate;
            return this;
        }

        public Builder autoSignatureUpdate(GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs autoSignatureUpdate) {
         ...
         * 
         */
        public Builder protectRe(@Nullable Output<GatewaytemplateGatewayMgmtProtectReArgs> protectRe) {
            $.protectRe = protectRe;
            return this;
        }
         ...
         * 
         */
        public Builder protectRe(GatewaytemplateGatewayMgmtProtectReArgs protectRe) {
        ...
        public GatewaytemplateGatewayMgmtArgs build() {
            return $;
        }
    }
