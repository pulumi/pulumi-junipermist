...
@CustomType
public final class MxclusterMxedgeMgmt {
    ...
    public static Builder builder(MxclusterMxedgeMgmt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootPassword;
        public Builder() {}
        public Builder(MxclusterMxedgeMgmt defaults) {
        ...
        public MxclusterMxedgeMgmt build() {
            final var _resultValue = new MxclusterMxedgeMgmt();
