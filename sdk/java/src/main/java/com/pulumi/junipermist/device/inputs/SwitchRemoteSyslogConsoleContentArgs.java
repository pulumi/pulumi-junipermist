...
public final class SwitchRemoteSyslogConsoleContentArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchRemoteSyslogConsoleContentArgs Empty = new SwitchRemoteSyslogConsoleContentArgs();
    ...
    private SwitchRemoteSyslogConsoleContentArgs() {}

    private SwitchRemoteSyslogConsoleContentArgs(SwitchRemoteSyslogConsoleContentArgs $) {
    ...
    public static Builder builder(SwitchRemoteSyslogConsoleContentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchRemoteSyslogConsoleContentArgs();
        }

        public Builder(SwitchRemoteSyslogConsoleContentArgs defaults) {
            $ = new SwitchRemoteSyslogConsoleContentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchRemoteSyslogConsoleContentArgs build() {
            return $;
        }
    }
