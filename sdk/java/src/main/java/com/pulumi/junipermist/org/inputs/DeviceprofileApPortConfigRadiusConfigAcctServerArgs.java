...
public final class DeviceprofileApPortConfigRadiusConfigAcctServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileApPortConfigRadiusConfigAcctServerArgs Empty = new DeviceprofileApPortConfigRadiusConfigAcctServerArgs();
    ...
    private DeviceprofileApPortConfigRadiusConfigAcctServerArgs() {}

    private DeviceprofileApPortConfigRadiusConfigAcctServerArgs(DeviceprofileApPortConfigRadiusConfigAcctServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(DeviceprofileApPortConfigRadiusConfigAcctServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileApPortConfigRadiusConfigAcctServerArgs();
        }

        public Builder(DeviceprofileApPortConfigRadiusConfigAcctServerArgs defaults) {
            $ = new DeviceprofileApPortConfigRadiusConfigAcctServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileApPortConfigRadiusConfigAcctServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("DeviceprofileApPortConfigRadiusConfigAcctServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("DeviceprofileApPortConfigRadiusConfigAcctServerArgs", "secret");
            }
            return $;
        }
    }
