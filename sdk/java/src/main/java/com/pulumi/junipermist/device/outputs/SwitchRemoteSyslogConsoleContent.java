...
@CustomType
public final class SwitchRemoteSyslogConsoleContent {
    /**
    ...
    private SwitchRemoteSyslogConsoleContent() {}
    /**
     * @return enum: `any`, `authorization`, `change-log`, `config`, `conflict-log`, `daemon`, `dfc`, `external`, `firewall`, `ftp`, `interactive-commands`, `kernel`, `ntp`, `pfe`, `security`, `user`
     * 
     */
    ...
    public static Builder builder(SwitchRemoteSyslogConsoleContent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String severity;
        public Builder() {}
        public Builder(SwitchRemoteSyslogConsoleContent defaults) {
        ...
        public SwitchRemoteSyslogConsoleContent build() {
            final var _resultValue = new SwitchRemoteSyslogConsoleContent();
