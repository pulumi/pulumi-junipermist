...
@CustomType
public final class SwitchRoutingPoliciesTermActions {
    ...
    private SwitchRoutingPoliciesTermActions() {}
    ...
    public static Builder builder(SwitchRoutingPoliciesTermActions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> prependAsPaths;
        public Builder() {}
        public Builder(SwitchRoutingPoliciesTermActions defaults) {
        ...
        public SwitchRoutingPoliciesTermActions build() {
            final var _resultValue = new SwitchRoutingPoliciesTermActions();
