...
import com.pulumi.junipermist.device.inputs.GatewayGatewayMgmtProtectReCustomArgs;
...
public final class GatewayGatewayMgmtProtectReArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GatewayGatewayMgmtProtectReArgs() {}

    private GatewayGatewayMgmtProtectReArgs(GatewayGatewayMgmtProtectReArgs $) {
    ...
    public static Builder builder(GatewayGatewayMgmtProtectReArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayGatewayMgmtProtectReArgs();
        }

        public Builder(GatewayGatewayMgmtProtectReArgs defaults) {
            $ = new GatewayGatewayMgmtProtectReArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewayGatewayMgmtProtectReArgs build() {
            return $;
        }
    }
