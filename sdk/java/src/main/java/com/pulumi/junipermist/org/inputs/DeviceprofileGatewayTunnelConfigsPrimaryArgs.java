...
import com.pulumi.junipermist.org.inputs.DeviceprofileGatewayTunnelConfigsPrimaryProbeHttpArgs;
...
public final class DeviceprofileGatewayTunnelConfigsPrimaryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileGatewayTunnelConfigsPrimaryArgs Empty = new DeviceprofileGatewayTunnelConfigsPrimaryArgs();
    ...
    private @Nullable Output<DeviceprofileGatewayTunnelConfigsPrimaryProbeHttpArgs> probeHttp;

    /**
     * @return HTTP probe settings for this tunnel node; success from any ICMP or HTTP probe indicates the tunnel is up
     * 
     */
    public Optional<Output<DeviceprofileGatewayTunnelConfigsPrimaryProbeHttpArgs>> probeHttp() {
    ...
    private DeviceprofileGatewayTunnelConfigsPrimaryArgs() {}

    private DeviceprofileGatewayTunnelConfigsPrimaryArgs(DeviceprofileGatewayTunnelConfigsPrimaryArgs $) {
        this.hosts = $.hosts;
    ...
    public static Builder builder(DeviceprofileGatewayTunnelConfigsPrimaryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileGatewayTunnelConfigsPrimaryArgs();
        }

        public Builder(DeviceprofileGatewayTunnelConfigsPrimaryArgs defaults) {
            $ = new DeviceprofileGatewayTunnelConfigsPrimaryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder probeHttp(@Nullable Output<DeviceprofileGatewayTunnelConfigsPrimaryProbeHttpArgs> probeHttp) {
            $.probeHttp = probeHttp;
            return this;
        }
         ...
         * 
         */
        public Builder probeHttp(DeviceprofileGatewayTunnelConfigsPrimaryProbeHttpArgs probeHttp) {
        ...
        public DeviceprofileGatewayTunnelConfigsPrimaryArgs build() {
            if ($.hosts == null) {
                throw new MissingRequiredPropertyException("DeviceprofileGatewayTunnelConfigsPrimaryArgs", "hosts");
            }
            if ($.wanNames == null) {
                throw new MissingRequiredPropertyException("DeviceprofileGatewayTunnelConfigsPrimaryArgs", "wanNames");
            }
            return $;
        }
    }
