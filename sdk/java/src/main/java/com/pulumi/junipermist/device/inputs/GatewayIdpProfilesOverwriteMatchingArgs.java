...
public final class GatewayIdpProfilesOverwriteMatchingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewayIdpProfilesOverwriteMatchingArgs Empty = new GatewayIdpProfilesOverwriteMatchingArgs();
    ...
    private GatewayIdpProfilesOverwriteMatchingArgs() {}

    private GatewayIdpProfilesOverwriteMatchingArgs(GatewayIdpProfilesOverwriteMatchingArgs $) {
    ...
    public static Builder builder(GatewayIdpProfilesOverwriteMatchingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayIdpProfilesOverwriteMatchingArgs();
        }

        public Builder(GatewayIdpProfilesOverwriteMatchingArgs defaults) {
            $ = new GatewayIdpProfilesOverwriteMatchingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewayIdpProfilesOverwriteMatchingArgs build() {
            return $;
        }
    }
