...
public final class DeviceprofileSwitchRadiusConfigAuthServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchRadiusConfigAuthServerArgs Empty = new DeviceprofileSwitchRadiusConfigAuthServerArgs();
    ...
    private DeviceprofileSwitchRadiusConfigAuthServerArgs() {}

    private DeviceprofileSwitchRadiusConfigAuthServerArgs(DeviceprofileSwitchRadiusConfigAuthServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(DeviceprofileSwitchRadiusConfigAuthServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchRadiusConfigAuthServerArgs();
        }

        public Builder(DeviceprofileSwitchRadiusConfigAuthServerArgs defaults) {
            $ = new DeviceprofileSwitchRadiusConfigAuthServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileSwitchRadiusConfigAuthServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("DeviceprofileSwitchRadiusConfigAuthServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("DeviceprofileSwitchRadiusConfigAuthServerArgs", "secret");
            }
            return $;
        }
    }
