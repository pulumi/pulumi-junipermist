...
public final class MxedgeMxedgeMgmt {
    ...
    public static Builder builder(MxedgeMxedgeMgmt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootPassword;
        public Builder() {}
        public Builder(MxedgeMxedgeMgmt defaults) {
        ...
        public MxedgeMxedgeMgmt build() {
            final var _resultValue = new MxedgeMxedgeMgmt();
