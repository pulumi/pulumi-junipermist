...
@CustomType
public final class DeviceprofileSwitchStpConfig {
    /**
    ...
    private DeviceprofileSwitchStpConfig() {}
    /**
     * @return Switch STP priority. Range [0, 4k, 8k.. 60k] in steps of 4k. Bridge priority applies to both VSTP and RSTP.
     * 
     */
    ...
    public static Builder builder(DeviceprofileSwitchStpConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable String bridgePriority;
        public Builder() {}
        public Builder(DeviceprofileSwitchStpConfig defaults) {
        ...
        public DeviceprofileSwitchStpConfig build() {
            final var _resultValue = new DeviceprofileSwitchStpConfig();
