...
public final class NetworktemplateSwitchMatchingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return list of rules to define custom switch configuration based on different criteria. Each list must have at least one of `matchModel`, `matchName` or `matchRole` must be defined
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param rules list of rules to define custom switch configuration based on different criteria. Each list must have at least one of `matchModel`, `matchName` or `matchRole` must be defined
         * 
         * @return builder
         * 
         */
