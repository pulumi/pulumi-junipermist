...
import com.pulumi.junipermist.org.outputs.GatewaytemplatePortConfigWanProbeOverrideHttp;
...
public final class GatewaytemplatePortConfigWanProbeOverride {
     ...
     * 
     */
    private @Nullable GatewaytemplatePortConfigWanProbeOverrideHttp http;
    /**
     ...
     * 
     */
    public Optional<GatewaytemplatePortConfigWanProbeOverrideHttp> http() {
    ...
    public static Builder builder(GatewaytemplatePortConfigWanProbeOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String probeProfile;
        public Builder() {}
        public Builder(GatewaytemplatePortConfigWanProbeOverride defaults) {
        ...
        @CustomType.Setter
        public Builder http(@Nullable GatewaytemplatePortConfigWanProbeOverrideHttp http) {
        ...
        public GatewaytemplatePortConfigWanProbeOverride build() {
            final var _resultValue = new GatewaytemplatePortConfigWanProbeOverride();
