...
public final class GetWlansSiteWlanAppQosApps {
    ...
    private GetWlansSiteWlanAppQosApps() {}
    public String dscp() {
        return this.dscp;
    }
    /**
    ...
    public static Builder builder(GetWlansSiteWlanAppQosApps defaults) {
    ...
    public static final class Builder {
        ...
        private String srcSubnet;
        public Builder() {}
        public Builder(GetWlansSiteWlanAppQosApps defaults) {
        ...
        public Builder dscp(String dscp) {
            if (dscp == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAppQosApps", "dscp");
            }
            this.dscp = dscp;
            return this;
        }
        ...
        public Builder dstSubnet(String dstSubnet) {
            if (dstSubnet == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAppQosApps", "dstSubnet");
            }
        ...
        public Builder srcSubnet(String srcSubnet) {
            if (srcSubnet == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAppQosApps", "srcSubnet");
            }
            this.srcSubnet = srcSubnet;
            return this;
        }
        public GetWlansSiteWlanAppQosApps build() {
            final var _resultValue = new GetWlansSiteWlanAppQosApps();
