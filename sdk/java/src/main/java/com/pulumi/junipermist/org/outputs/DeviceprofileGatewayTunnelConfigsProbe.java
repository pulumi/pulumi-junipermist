...
@CustomType
public final class DeviceprofileGatewayTunnelConfigsProbe {
    /**
    ...
    public static Builder builder(DeviceprofileGatewayTunnelConfigsProbe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(DeviceprofileGatewayTunnelConfigsProbe defaults) {
        ...
        public DeviceprofileGatewayTunnelConfigsProbe build() {
            final var _resultValue = new DeviceprofileGatewayTunnelConfigsProbe();
