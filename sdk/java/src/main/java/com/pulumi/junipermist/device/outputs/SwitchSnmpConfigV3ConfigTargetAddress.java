...
public final class SwitchSnmpConfigV3ConfigTargetAddress {
    ...
    public static final class Builder {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("SwitchSnmpConfigV3ConfigTargetAddress", "address");
            }
        ...
        public Builder addressMask(String addressMask) {
            if (addressMask == null) {
              throw new MissingRequiredPropertyException("SwitchSnmpConfigV3ConfigTargetAddress", "addressMask");
            }
        ...
        public Builder targetAddressName(String targetAddressName) {
            if (targetAddressName == null) {
              throw new MissingRequiredPropertyException("SwitchSnmpConfigV3ConfigTargetAddress", "targetAddressName");
            }
