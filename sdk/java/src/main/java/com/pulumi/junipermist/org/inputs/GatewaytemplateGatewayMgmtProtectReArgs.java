...
import com.pulumi.junipermist.org.inputs.GatewaytemplateGatewayMgmtProtectReCustomArgs;
...
public final class GatewaytemplateGatewayMgmtProtectReArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewaytemplateGatewayMgmtProtectReArgs Empty = new GatewaytemplateGatewayMgmtProtectReArgs();
    ...
    @Import(name="customs")
    private @Nullable Output<List<GatewaytemplateGatewayMgmtProtectReCustomArgs>> customs;

    public Optional<Output<List<GatewaytemplateGatewayMgmtProtectReCustomArgs>>> customs() {
    ...
    private GatewaytemplateGatewayMgmtProtectReArgs() {}

    private GatewaytemplateGatewayMgmtProtectReArgs(GatewaytemplateGatewayMgmtProtectReArgs $) {
    ...
    public static Builder builder(GatewaytemplateGatewayMgmtProtectReArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewaytemplateGatewayMgmtProtectReArgs();
        }

        public Builder(GatewaytemplateGatewayMgmtProtectReArgs defaults) {
            $ = new GatewaytemplateGatewayMgmtProtectReArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder customs(@Nullable Output<List<GatewaytemplateGatewayMgmtProtectReCustomArgs>> customs) {
            $.customs = customs;
            return this;
        }

        public Builder customs(List<GatewaytemplateGatewayMgmtProtectReCustomArgs> customs) {
            return customs(Output.of(customs));
        }

        public Builder customs(GatewaytemplateGatewayMgmtProtectReCustomArgs... customs) {
        ...
        public GatewaytemplateGatewayMgmtProtectReArgs build() {
            return $;
        }
    }
