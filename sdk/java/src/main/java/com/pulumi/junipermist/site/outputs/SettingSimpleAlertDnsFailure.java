...
public final class SettingSimpleAlertDnsFailure {
    ...
    public static Builder builder(SettingSimpleAlertDnsFailure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer incidentCount;
        public Builder() {}
        public Builder(SettingSimpleAlertDnsFailure defaults) {
        ...
        public SettingSimpleAlertDnsFailure build() {
            final var _resultValue = new SettingSimpleAlertDnsFailure();
