...
@CustomType
public final class GatewayGatewayMgmtAutoSignatureUpdate {
    /**
    ...
    public static Builder builder(GatewayGatewayMgmtAutoSignatureUpdate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeOfDay;
        public Builder() {}
        public Builder(GatewayGatewayMgmtAutoSignatureUpdate defaults) {
        ...
        public GatewayGatewayMgmtAutoSignatureUpdate build() {
            final var _resultValue = new GatewayGatewayMgmtAutoSignatureUpdate();
