...
public final class DeviceprofileSwitchSnmpConfigV2cConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchSnmpConfigV2cConfigArgs Empty = new DeviceprofileSwitchSnmpConfigV2cConfigArgs();
    ...
    private DeviceprofileSwitchSnmpConfigV2cConfigArgs() {}

    private DeviceprofileSwitchSnmpConfigV2cConfigArgs(DeviceprofileSwitchSnmpConfigV2cConfigArgs $) {
    ...
    public static Builder builder(DeviceprofileSwitchSnmpConfigV2cConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchSnmpConfigV2cConfigArgs();
        }

        public Builder(DeviceprofileSwitchSnmpConfigV2cConfigArgs defaults) {
            $ = new DeviceprofileSwitchSnmpConfigV2cConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileSwitchSnmpConfigV2cConfigArgs build() {
            return $;
        }
    }
