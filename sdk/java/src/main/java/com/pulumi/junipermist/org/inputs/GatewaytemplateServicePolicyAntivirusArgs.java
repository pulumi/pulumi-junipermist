...
public final class GatewaytemplateServicePolicyAntivirusArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewaytemplateServicePolicyAntivirusArgs Empty = new GatewaytemplateServicePolicyAntivirusArgs();
    ...
    private GatewaytemplateServicePolicyAntivirusArgs() {}

    private GatewaytemplateServicePolicyAntivirusArgs(GatewaytemplateServicePolicyAntivirusArgs $) {
    ...
    public static Builder builder(GatewaytemplateServicePolicyAntivirusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewaytemplateServicePolicyAntivirusArgs();
        }

        public Builder(GatewaytemplateServicePolicyAntivirusArgs defaults) {
            $ = new GatewaytemplateServicePolicyAntivirusArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewaytemplateServicePolicyAntivirusArgs build() {
            return $;
        }
    }
