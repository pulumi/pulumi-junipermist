...
import com.pulumi.junipermist.device.inputs.GatewayGatewayMgmtAppProbingArgs;
import com.pulumi.junipermist.device.inputs.GatewayGatewayMgmtAutoSignatureUpdateArgs;
import com.pulumi.junipermist.device.inputs.GatewayGatewayMgmtProtectReArgs;
...
public final class GatewayGatewayMgmtArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GatewayGatewayMgmtAppProbingArgs> appProbing;

    public Optional<Output<GatewayGatewayMgmtAppProbingArgs>> appProbing() {
    ...
    private @Nullable Output<GatewayGatewayMgmtAutoSignatureUpdateArgs> autoSignatureUpdate;

    public Optional<Output<GatewayGatewayMgmtAutoSignatureUpdateArgs>> autoSignatureUpdate() {
    ...
    private @Nullable Output<GatewayGatewayMgmtProtectReArgs> protectRe;
     ...
     * 
     */
    public Optional<Output<GatewayGatewayMgmtProtectReArgs>> protectRe() {
    ...
    public static final class Builder {
        ...
        public Builder appProbing(@Nullable Output<GatewayGatewayMgmtAppProbingArgs> appProbing) {
            $.appProbing = appProbing;
            return this;
        }

        public Builder appProbing(GatewayGatewayMgmtAppProbingArgs appProbing) {
        ...
        public Builder autoSignatureUpdate(@Nullable Output<GatewayGatewayMgmtAutoSignatureUpdateArgs> autoSignatureUpdate) {
            $.autoSignatureUpdate = autoSignatureUpdate;
            return this;
        }

        public Builder autoSignatureUpdate(GatewayGatewayMgmtAutoSignatureUpdateArgs autoSignatureUpdate) {
         ...
         * 
         */
        public Builder protectRe(@Nullable Output<GatewayGatewayMgmtProtectReArgs> protectRe) {
            $.protectRe = protectRe;
            return this;
        }
         ...
         * 
         */
        public Builder protectRe(GatewayGatewayMgmtProtectReArgs protectRe) {
