...
public class DeviceprofileAp extends com.pulumi.resources.CustomResource {
     ...
     */
    public DeviceprofileAp(String name) {
     ...
     */
    public DeviceprofileAp(String name, DeviceprofileApArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("junipermist:org/deviceprofileAp:DeviceprofileAp", name, args == null ? DeviceprofileApArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DeviceprofileAp(String name, Output<String> id, @Nullable DeviceprofileApState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("junipermist:org/deviceprofileAp:DeviceprofileAp", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DeviceprofileAp get(String name, Output<String> id, @Nullable DeviceprofileApState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
