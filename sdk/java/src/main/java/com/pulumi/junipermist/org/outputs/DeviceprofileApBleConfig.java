...
@CustomType
public final class DeviceprofileApBleConfig {
    /**
    ...
    public static Builder builder(DeviceprofileApBleConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String powerMode;
        public Builder() {}
        public Builder(DeviceprofileApBleConfig defaults) {
        ...
        public DeviceprofileApBleConfig build() {
            final var _resultValue = new DeviceprofileApBleConfig();
