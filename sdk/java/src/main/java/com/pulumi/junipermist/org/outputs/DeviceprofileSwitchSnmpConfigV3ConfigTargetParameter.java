...
public final class DeviceprofileSwitchSnmpConfigV3ConfigTargetParameter {
    ...
    public static Builder builder(DeviceprofileSwitchSnmpConfigV3ConfigTargetParameter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String securityName;
        public Builder() {}
        public Builder(DeviceprofileSwitchSnmpConfigV3ConfigTargetParameter defaults) {
        ...
        public Builder messageProcessingModel(String messageProcessingModel) {
            if (messageProcessingModel == null) {
              throw new MissingRequiredPropertyException("DeviceprofileSwitchSnmpConfigV3ConfigTargetParameter", "messageProcessingModel");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DeviceprofileSwitchSnmpConfigV3ConfigTargetParameter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public DeviceprofileSwitchSnmpConfigV3ConfigTargetParameter build() {
            final var _resultValue = new DeviceprofileSwitchSnmpConfigV3ConfigTargetParameter();
