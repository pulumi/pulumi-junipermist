...
public final class DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs Empty = new DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs();
    ...
    private DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs() {}

    private DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs(DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs $) {
    ...
    public static Builder builder(DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs();
        }

        public Builder(DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs defaults) {
            $ = new DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileGatewayIdpProfilesOverwriteMatchingArgs build() {
            return $;
        }
    }
