...
public final class GatewaytemplatePathPreferencesPath {
    ...
    public static Builder builder(GatewaytemplatePathPreferencesPath defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wanName;
        public Builder() {}
        public Builder(GatewaytemplatePathPreferencesPath defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GatewaytemplatePathPreferencesPath", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public GatewaytemplatePathPreferencesPath build() {
            final var _resultValue = new GatewaytemplatePathPreferencesPath();
