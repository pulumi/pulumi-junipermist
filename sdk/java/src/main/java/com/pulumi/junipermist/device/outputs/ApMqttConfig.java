...
@CustomType
public final class ApMqttConfig {
    /**
    ...
    public static Builder builder(ApMqttConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String username;
        public Builder() {}
        public Builder(ApMqttConfig defaults) {
        ...
        public ApMqttConfig build() {
            final var _resultValue = new ApMqttConfig();
