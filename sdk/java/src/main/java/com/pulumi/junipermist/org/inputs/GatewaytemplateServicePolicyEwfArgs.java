...
public final class GatewaytemplateServicePolicyEwfArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewaytemplateServicePolicyEwfArgs Empty = new GatewaytemplateServicePolicyEwfArgs();
    ...
    private GatewaytemplateServicePolicyEwfArgs() {}

    private GatewaytemplateServicePolicyEwfArgs(GatewaytemplateServicePolicyEwfArgs $) {
    ...
    public static Builder builder(GatewaytemplateServicePolicyEwfArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewaytemplateServicePolicyEwfArgs();
        }

        public Builder(GatewaytemplateServicePolicyEwfArgs defaults) {
            $ = new GatewaytemplateServicePolicyEwfArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewaytemplateServicePolicyEwfArgs build() {
            return $;
        }
    }
