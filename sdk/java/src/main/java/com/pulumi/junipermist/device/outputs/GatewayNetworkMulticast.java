...
import com.pulumi.junipermist.device.outputs.GatewayNetworkMulticastGroups;
...
@CustomType
public final class GatewayNetworkMulticast {
    /**
    ...
    public static Builder builder(GatewayNetworkMulticast defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,GatewayNetworkMulticastGroups> groups;
        public Builder() {}
        public Builder(GatewayNetworkMulticast defaults) {
        ...
        @CustomType.Setter
        public Builder groups(@Nullable Map<String,GatewayNetworkMulticastGroups> groups) {

            this.groups = groups;
            return this;
        }
        public GatewayNetworkMulticast build() {
            final var _resultValue = new GatewayNetworkMulticast();
