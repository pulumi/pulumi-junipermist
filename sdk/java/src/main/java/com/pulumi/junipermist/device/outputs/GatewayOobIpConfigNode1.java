...
@CustomType
public final class GatewayOobIpConfigNode1 {
    /**
    ...
    public static Builder builder(GatewayOobIpConfigNode1 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vlanId;
        public Builder() {}
        public Builder(GatewayOobIpConfigNode1 defaults) {
        ...
        public GatewayOobIpConfigNode1 build() {
            final var _resultValue = new GatewayOobIpConfigNode1();
