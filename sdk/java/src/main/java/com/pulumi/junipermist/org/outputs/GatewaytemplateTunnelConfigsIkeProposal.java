...
@CustomType
public final class GatewaytemplateTunnelConfigsIkeProposal {
    /**
    ...
    public static Builder builder(GatewaytemplateTunnelConfigsIkeProposal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String encAlgo;
        public Builder() {}
        public Builder(GatewaytemplateTunnelConfigsIkeProposal defaults) {
        ...
        public GatewaytemplateTunnelConfigsIkeProposal build() {
            final var _resultValue = new GatewaytemplateTunnelConfigsIkeProposal();
