...
public final class GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs() {}

    private GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs(GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs $) {
    ...
    public static Builder builder(GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs();
        }

        public Builder(GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs defaults) {
            $ = new GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewaytemplateGatewayMgmtAutoSignatureUpdateArgs build() {
            return $;
        }
    }
