...
public final class GatewayRoutingPoliciesTermActions {
    ...
    public static Builder builder(GatewayRoutingPoliciesTermActions defaults) {
    ...
    public static final class Builder {
        ...
        public GatewayRoutingPoliciesTermActions build() {
            final var _resultValue = new GatewayRoutingPoliciesTermActions();
