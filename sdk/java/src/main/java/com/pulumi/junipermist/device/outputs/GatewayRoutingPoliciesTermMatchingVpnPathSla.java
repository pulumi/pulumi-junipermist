...
@CustomType
public final class GatewayRoutingPoliciesTermMatchingVpnPathSla {
    ...
    public static Builder builder(GatewayRoutingPoliciesTermMatchingVpnPathSla defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maxLoss;
        public Builder() {}
        public Builder(GatewayRoutingPoliciesTermMatchingVpnPathSla defaults) {
        ...
        public GatewayRoutingPoliciesTermMatchingVpnPathSla build() {
            final var _resultValue = new GatewayRoutingPoliciesTermMatchingVpnPathSla();
