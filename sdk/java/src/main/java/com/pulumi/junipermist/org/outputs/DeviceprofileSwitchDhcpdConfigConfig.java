...
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchDhcpdConfigConfigFixedBindings;
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchDhcpdConfigConfigOptions;
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulated;
...
@CustomType
public final class DeviceprofileSwitchDhcpdConfigConfig {
    /**
     ...
     * 
     */
    private @Nullable Map<String,DeviceprofileSwitchDhcpdConfigConfigFixedBindings> fixedBindings;
    /**
     ...
     * 
     */
    private @Nullable Map<String,DeviceprofileSwitchDhcpdConfigConfigOptions> options;
    /**
     ...
     * 
     */
    private @Nullable Map<String,DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulated> vendorEncapsulated;

    private DeviceprofileSwitchDhcpdConfigConfig() {}
    /**
     * @return If `type`==`server` or `type6`==`server`, DNS servers advertised to DHCP clients
     * 
     */
     ...
     * 
     */
    public Map<String,DeviceprofileSwitchDhcpdConfigConfigFixedBindings> fixedBindings() {
     ...
     * 
     */
    public Map<String,DeviceprofileSwitchDhcpdConfigConfigOptions> options() {
     ...
     * 
     */
    public Map<String,DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulated> vendorEncapsulated() {
    ...
    public static Builder builder(DeviceprofileSwitchDhcpdConfigConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulated> vendorEncapsulated;
        public Builder() {}
        public Builder(DeviceprofileSwitchDhcpdConfigConfig defaults) {
        ...
        @CustomType.Setter
        public Builder fixedBindings(@Nullable Map<String,DeviceprofileSwitchDhcpdConfigConfigFixedBindings> fixedBindings) {
        ...
        @CustomType.Setter
        public Builder options(@Nullable Map<String,DeviceprofileSwitchDhcpdConfigConfigOptions> options) {
        ...
        @CustomType.Setter
        public Builder vendorEncapsulated(@Nullable Map<String,DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulated> vendorEncapsulated) {

            this.vendorEncapsulated = vendorEncapsulated;
            return this;
        }
        public DeviceprofileSwitchDhcpdConfigConfig build() {
            final var _resultValue = new DeviceprofileSwitchDhcpdConfigConfig();
