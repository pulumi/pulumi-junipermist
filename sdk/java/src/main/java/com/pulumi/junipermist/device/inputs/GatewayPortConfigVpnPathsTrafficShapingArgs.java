...
public final class GatewayPortConfigVpnPathsTrafficShapingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewayPortConfigVpnPathsTrafficShapingArgs Empty = new GatewayPortConfigVpnPathsTrafficShapingArgs();
    ...
    private GatewayPortConfigVpnPathsTrafficShapingArgs() {}

    private GatewayPortConfigVpnPathsTrafficShapingArgs(GatewayPortConfigVpnPathsTrafficShapingArgs $) {
    ...
    public static Builder builder(GatewayPortConfigVpnPathsTrafficShapingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayPortConfigVpnPathsTrafficShapingArgs();
        }

        public Builder(GatewayPortConfigVpnPathsTrafficShapingArgs defaults) {
            $ = new GatewayPortConfigVpnPathsTrafficShapingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewayPortConfigVpnPathsTrafficShapingArgs build() {
            return $;
        }
    }
