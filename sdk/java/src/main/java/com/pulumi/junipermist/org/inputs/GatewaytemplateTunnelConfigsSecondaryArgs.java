...
import com.pulumi.junipermist.org.inputs.GatewaytemplateTunnelConfigsSecondaryProbeHttpArgs;
...
public final class GatewaytemplateTunnelConfigsSecondaryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GatewaytemplateTunnelConfigsSecondaryProbeHttpArgs> probeHttp;

    /**
     * @return HTTP probe settings for this tunnel node; success from any ICMP or HTTP probe indicates the tunnel is up
     * 
     */
    public Optional<Output<GatewaytemplateTunnelConfigsSecondaryProbeHttpArgs>> probeHttp() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder probeHttp(@Nullable Output<GatewaytemplateTunnelConfigsSecondaryProbeHttpArgs> probeHttp) {
            $.probeHttp = probeHttp;
            return this;
        }
         ...
         * 
         */
        public Builder probeHttp(GatewaytemplateTunnelConfigsSecondaryProbeHttpArgs probeHttp) {
        ...
        public GatewaytemplateTunnelConfigsSecondaryArgs build() {
            if ($.hosts == null) {
                throw new MissingRequiredPropertyException("GatewaytemplateTunnelConfigsSecondaryArgs", "hosts");
            }
            if ($.wanNames == null) {
                throw new MissingRequiredPropertyException("GatewaytemplateTunnelConfigsSecondaryArgs", "wanNames");
            }
            return $;
        }
    }
