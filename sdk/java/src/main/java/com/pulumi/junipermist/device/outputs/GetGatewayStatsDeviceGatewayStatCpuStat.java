...
@CustomType
public final class GetGatewayStatsDeviceGatewayStatCpuStat {
    /**
    ...
    private GetGatewayStatsDeviceGatewayStatCpuStat() {}
    /**
     * @return Percentage of CPU time that is idle
     * 
     */
    ...
    public static Builder builder(GetGatewayStatsDeviceGatewayStatCpuStat defaults) {
    ...
    public static final class Builder {
        ...
        private Double user;
        public Builder() {}
        public Builder(GetGatewayStatsDeviceGatewayStatCpuStat defaults) {
        ...
        public Builder idle(Double idle) {
            if (idle == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpuStat", "idle");
            }
            this.idle = idle;
            return this;
        }
        ...
        public Builder interrupt(Double interrupt) {
            if (interrupt == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpuStat", "interrupt");
            }
        ...
        public Builder loadAvgs(List<Double> loadAvgs) {
            if (loadAvgs == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpuStat", "loadAvgs");
            }
        ...
        public Builder system(Double system) {
            if (system == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpuStat", "system");
            }
            this.system = system;
            return this;
        }
        ...
        public Builder usage(Double usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpuStat", "usage");
            }
            this.usage = usage;
            return this;
        }
        ...
        public Builder user(Double user) {
            if (user == null) {
              throw new MissingRequiredPropertyException("GetGatewayStatsDeviceGatewayStatCpuStat", "user");
            }
            this.user = user;
            return this;
        }
        public GetGatewayStatsDeviceGatewayStatCpuStat build() {
            final var _resultValue = new GetGatewayStatsDeviceGatewayStatCpuStat();
