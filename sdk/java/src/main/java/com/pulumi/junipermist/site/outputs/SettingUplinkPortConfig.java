...
@CustomType
public final class SettingUplinkPortConfig {
    /**
    ...
    public static Builder builder(SettingUplinkPortConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean keepWlansUpIfDown;
        public Builder() {}
        public Builder(SettingUplinkPortConfig defaults) {
        ...
        public SettingUplinkPortConfig build() {
            final var _resultValue = new SettingUplinkPortConfig();
