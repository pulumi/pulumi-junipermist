...
public final class SwitchDhcpdConfigConfigFixedBindingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SwitchDhcpdConfigConfigFixedBindingsArgs() {}
    ...
    public static Builder builder(SwitchDhcpdConfigConfigFixedBindingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchDhcpdConfigConfigFixedBindingsArgs();
        }

        public Builder(SwitchDhcpdConfigConfigFixedBindingsArgs defaults) {
