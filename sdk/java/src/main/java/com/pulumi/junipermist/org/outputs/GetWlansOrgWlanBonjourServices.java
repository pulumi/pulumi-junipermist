...
public final class GetWlansOrgWlanBonjourServices {
    ...
    public static Builder builder(GetWlansOrgWlanBonjourServices defaults) {
    ...
    public static final class Builder {
        ...
        private String scope;
        public Builder() {}
        public Builder(GetWlansOrgWlanBonjourServices defaults) {
        ...
        public Builder disableLocal(Boolean disableLocal) {
            if (disableLocal == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanBonjourServices", "disableLocal");
            }
        ...
        public Builder radiusGroups(List<String> radiusGroups) {
            if (radiusGroups == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanBonjourServices", "radiusGroups");
            }
        ...
        public Builder scope(String scope) {
            if (scope == null) {
              throw new MissingRequiredPropertyException("GetWlansOrgWlanBonjourServices", "scope");
            }
            this.scope = scope;
            return this;
        }
        public GetWlansOrgWlanBonjourServices build() {
            final var _resultValue = new GetWlansOrgWlanBonjourServices();
