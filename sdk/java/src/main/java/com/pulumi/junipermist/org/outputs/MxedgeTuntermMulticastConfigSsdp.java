...
public final class MxedgeTuntermMulticastConfigSsdp {
    ...
    public static Builder builder(MxedgeTuntermMulticastConfigSsdp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> vlanIds;
        public Builder() {}
        public Builder(MxedgeTuntermMulticastConfigSsdp defaults) {
        ...
        public MxedgeTuntermMulticastConfigSsdp build() {
            final var _resultValue = new MxedgeTuntermMulticastConfigSsdp();
