...
@CustomType
public final class DeviceprofileApRadioConfigBand24 {
    ...
    private DeviceprofileApRadioConfigBand24() {}
    ...
    public static Builder builder(DeviceprofileApRadioConfigBand24 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String preamble;
        public Builder() {}
        public Builder(DeviceprofileApRadioConfigBand24 defaults) {
        ...
        public DeviceprofileApRadioConfigBand24 build() {
            final var _resultValue = new DeviceprofileApRadioConfigBand24();
