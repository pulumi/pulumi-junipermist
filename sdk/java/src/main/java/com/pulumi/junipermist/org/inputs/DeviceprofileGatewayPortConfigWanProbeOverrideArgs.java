...
public final class DeviceprofileGatewayPortConfigWanProbeOverrideArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(DeviceprofileGatewayPortConfigWanProbeOverrideArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileGatewayPortConfigWanProbeOverrideArgs();
        }
        ...
        public DeviceprofileGatewayPortConfigWanProbeOverrideArgs build() {
            return $;
        }
    }
