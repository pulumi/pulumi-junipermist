...
public final class DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs Empty = new DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs();
    ...
    private DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs() {}

    private DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs(DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs $) {
    ...
    public static Builder builder(DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs();
        }

        public Builder(DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs defaults) {
            $ = new DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileSwitchSnmpConfigV3ConfigUsmUserArgs build() {
            return $;
        }
    }
