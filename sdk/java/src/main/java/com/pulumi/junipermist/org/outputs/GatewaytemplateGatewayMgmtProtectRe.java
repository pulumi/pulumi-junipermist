...
import com.pulumi.junipermist.org.outputs.GatewaytemplateGatewayMgmtProtectReCustom;
...
@CustomType
public final class GatewaytemplateGatewayMgmtProtectRe {
    /**
     * @return Optionally, services we&#39;ll allow
     * 
     */
    private @Nullable List<String> allowedServices;
    private @Nullable List<GatewaytemplateGatewayMgmtProtectReCustom> customs;
    /**
    ...
    private GatewaytemplateGatewayMgmtProtectRe() {}
    /**
     * @return Optionally, services we&#39;ll allow
     * 
     */
    ...
    public List<GatewaytemplateGatewayMgmtProtectReCustom> customs() {
    ...
    public static Builder builder(GatewaytemplateGatewayMgmtProtectRe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> trustedHosts;
        public Builder() {}
        public Builder(GatewaytemplateGatewayMgmtProtectRe defaults) {
        ...
        @CustomType.Setter
        public Builder customs(@Nullable List<GatewaytemplateGatewayMgmtProtectReCustom> customs) {

            this.customs = customs;
            return this;
        }
        public Builder customs(GatewaytemplateGatewayMgmtProtectReCustom... customs) {
        ...
        public GatewaytemplateGatewayMgmtProtectRe build() {
            final var _resultValue = new GatewaytemplateGatewayMgmtProtectRe();
