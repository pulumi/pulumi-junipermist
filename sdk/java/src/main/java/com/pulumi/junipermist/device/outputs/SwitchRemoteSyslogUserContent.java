...
public final class SwitchRemoteSyslogUserContent {
    ...
    public static Builder builder(SwitchRemoteSyslogUserContent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String severity;
        public Builder() {}
        public Builder(SwitchRemoteSyslogUserContent defaults) {
        ...
        public SwitchRemoteSyslogUserContent build() {
            final var _resultValue = new SwitchRemoteSyslogUserContent();
