...
import com.pulumi.junipermist.device.outputs.GatewayGatewayMgmtProtectReCustom;
...
public final class GatewayGatewayMgmtProtectRe {
    ...
    public static Builder builder(GatewayGatewayMgmtProtectRe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> trustedHosts;
        public Builder() {}
        public Builder(GatewayGatewayMgmtProtectRe defaults) {
        ...
        @CustomType.Setter
        public Builder customs(@Nullable List<GatewayGatewayMgmtProtectReCustom> customs) {

            this.customs = customs;
            return this;
        }
        public Builder customs(GatewayGatewayMgmtProtectReCustom... customs) {
        ...
        public GatewayGatewayMgmtProtectRe build() {
            final var _resultValue = new GatewayGatewayMgmtProtectRe();
