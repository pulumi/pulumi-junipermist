...
public final class RftemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RftemplateArgs() {}

    private RftemplateArgs(RftemplateArgs $) {
    ...
    public static Builder builder(RftemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RftemplateArgs defaults) {
        ...
        public RftemplateArgs build() {
            if ($.orgId == null) {
                throw new MissingRequiredPropertyException("RftemplateArgs", "orgId");
            }
            return $;
        }
    }
