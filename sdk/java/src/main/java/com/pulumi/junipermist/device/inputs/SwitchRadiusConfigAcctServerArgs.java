...
public final class SwitchRadiusConfigAcctServerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SwitchRadiusConfigAcctServerArgs() {}

    private SwitchRadiusConfigAcctServerArgs(SwitchRadiusConfigAcctServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(SwitchRadiusConfigAcctServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchRadiusConfigAcctServerArgs();
        }

        public Builder(SwitchRadiusConfigAcctServerArgs defaults) {
            $ = new SwitchRadiusConfigAcctServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchRadiusConfigAcctServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("SwitchRadiusConfigAcctServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("SwitchRadiusConfigAcctServerArgs", "secret");
            }
            return $;
        }
    }
