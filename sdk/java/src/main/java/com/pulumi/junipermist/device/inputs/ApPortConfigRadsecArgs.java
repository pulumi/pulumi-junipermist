...
import com.pulumi.junipermist.device.inputs.ApPortConfigRadsecServerArgs;
...
public final class ApPortConfigRadsecArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApPortConfigRadsecArgs Empty = new ApPortConfigRadsecArgs();
     ...
     */
    @Import(name="servers")
    private @Nullable Output<List<ApPortConfigRadsecServerArgs>> servers;

    /**
     * @return List of RadSec Servers. Only if not Mist Edge.
     * 
     */
    public Optional<Output<List<ApPortConfigRadsecServerArgs>>> servers() {
    ...
    private ApPortConfigRadsecArgs() {}

    private ApPortConfigRadsecArgs(ApPortConfigRadsecArgs $) {
    ...
    public static Builder builder(ApPortConfigRadsecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApPortConfigRadsecArgs();
        }

        public Builder(ApPortConfigRadsecArgs defaults) {
            $ = new ApPortConfigRadsecArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder servers(@Nullable Output<List<ApPortConfigRadsecServerArgs>> servers) {
            $.servers = servers;
            return this;
        }
         ...
         * 
         */
        public Builder servers(List<ApPortConfigRadsecServerArgs> servers) {
         ...
         * 
         */
        public Builder servers(ApPortConfigRadsecServerArgs... servers) {
        ...
        public ApPortConfigRadsecArgs build() {
            return $;
        }
    }
