...
public final class SwitchSnmpConfigV3ConfigVacmSecurityToGroupContent {
    ...
    public static Builder builder(SwitchSnmpConfigV3ConfigVacmSecurityToGroupContent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String securityName;
        public Builder() {}
        public Builder(SwitchSnmpConfigV3ConfigVacmSecurityToGroupContent defaults) {
        ...
        public SwitchSnmpConfigV3ConfigVacmSecurityToGroupContent build() {
            final var _resultValue = new SwitchSnmpConfigV3ConfigVacmSecurityToGroupContent();
