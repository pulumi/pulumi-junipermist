...
@CustomType
public final class DeviceprofileSwitchRadiusConfigAcctServer {
    /**
    ...
    private DeviceprofileSwitchRadiusConfigAcctServer() {}
    /**
     * @return Address or hostname of the RADIUS accounting server
     * 
     */
    ...
    public static Builder builder(DeviceprofileSwitchRadiusConfigAcctServer defaults) {
    ...
    public static final class Builder {
        ...
        private String secret;
        public Builder() {}
        public Builder(DeviceprofileSwitchRadiusConfigAcctServer defaults) {
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("DeviceprofileSwitchRadiusConfigAcctServer", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("DeviceprofileSwitchRadiusConfigAcctServer", "secret");
            }
            this.secret = secret;
            return this;
        }
        public DeviceprofileSwitchRadiusConfigAcctServer build() {
            final var _resultValue = new DeviceprofileSwitchRadiusConfigAcctServer();
