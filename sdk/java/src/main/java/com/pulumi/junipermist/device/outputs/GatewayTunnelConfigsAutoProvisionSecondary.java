...
@CustomType
public final class GatewayTunnelConfigsAutoProvisionSecondary {
    ...
    public static Builder builder(GatewayTunnelConfigsAutoProvisionSecondary defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> wanNames;
        public Builder() {}
        public Builder(GatewayTunnelConfigsAutoProvisionSecondary defaults) {
        ...
        public GatewayTunnelConfigsAutoProvisionSecondary build() {
            final var _resultValue = new GatewayTunnelConfigsAutoProvisionSecondary();
