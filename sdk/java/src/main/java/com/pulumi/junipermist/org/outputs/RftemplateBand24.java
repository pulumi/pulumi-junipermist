...
public final class RftemplateBand24 {
    ...
    public static Builder builder(RftemplateBand24 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String preamble;
        public Builder() {}
        public Builder(RftemplateBand24 defaults) {
        ...
        public RftemplateBand24 build() {
            final var _resultValue = new RftemplateBand24();
