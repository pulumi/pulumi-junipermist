...
@CustomType
public final class NetworktemplateRemoteSyslogUserContent {
    /**
    ...
    public static Builder builder(NetworktemplateRemoteSyslogUserContent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String severity;
        public Builder() {}
        public Builder(NetworktemplateRemoteSyslogUserContent defaults) {
        ...
        public NetworktemplateRemoteSyslogUserContent build() {
            final var _resultValue = new NetworktemplateRemoteSyslogUserContent();
