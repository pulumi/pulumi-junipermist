...
public final class RftemplateBand5Args extends com.pulumi.resources.ResourceArgs {

    public static final RftemplateBand5Args Empty = new RftemplateBand5Args();
    ...
    private RftemplateBand5Args() {}

    private RftemplateBand5Args(RftemplateBand5Args $) {
    ...
    public static Builder builder(RftemplateBand5Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RftemplateBand5Args();
        }

        public Builder(RftemplateBand5Args defaults) {
            $ = new RftemplateBand5Args(Objects.requireNonNull(defaults));
        }
        ...
        public RftemplateBand5Args build() {
            return $;
        }
    }
