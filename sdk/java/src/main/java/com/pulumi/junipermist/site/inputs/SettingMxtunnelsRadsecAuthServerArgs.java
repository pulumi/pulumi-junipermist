...
public final class SettingMxtunnelsRadsecAuthServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final SettingMxtunnelsRadsecAuthServerArgs Empty = new SettingMxtunnelsRadsecAuthServerArgs();
    ...
    private SettingMxtunnelsRadsecAuthServerArgs() {}

    private SettingMxtunnelsRadsecAuthServerArgs(SettingMxtunnelsRadsecAuthServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(SettingMxtunnelsRadsecAuthServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SettingMxtunnelsRadsecAuthServerArgs();
        }

        public Builder(SettingMxtunnelsRadsecAuthServerArgs defaults) {
            $ = new SettingMxtunnelsRadsecAuthServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SettingMxtunnelsRadsecAuthServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("SettingMxtunnelsRadsecAuthServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("SettingMxtunnelsRadsecAuthServerArgs", "secret");
            }
            return $;
        }
    }
