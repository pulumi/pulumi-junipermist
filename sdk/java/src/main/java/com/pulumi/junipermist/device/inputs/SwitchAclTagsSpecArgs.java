...
public final class SwitchAclTagsSpecArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SwitchAclTagsSpecArgs() {}

    private SwitchAclTagsSpecArgs(SwitchAclTagsSpecArgs $) {
    ...
    public static Builder builder(SwitchAclTagsSpecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchAclTagsSpecArgs();
        }

        public Builder(SwitchAclTagsSpecArgs defaults) {
            $ = new SwitchAclTagsSpecArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchAclTagsSpecArgs build() {
            return $;
        }
    }
