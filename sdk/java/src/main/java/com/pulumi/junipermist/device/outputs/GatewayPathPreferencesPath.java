...
@CustomType
public final class GatewayPathPreferencesPath {
    ...
    private GatewayPathPreferencesPath() {}
    ...
    public static Builder builder(GatewayPathPreferencesPath defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wanName;
        public Builder() {}
        public Builder(GatewayPathPreferencesPath defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GatewayPathPreferencesPath", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public GatewayPathPreferencesPath build() {
            final var _resultValue = new GatewayPathPreferencesPath();
