...
@CustomType
public final class GetWlansSiteWlanAuth {
    /**
    ...
    public static Builder builder(GetWlansSiteWlanAuth defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean wepAsSecondaryAuth;
        public Builder() {}
        public Builder(GetWlansSiteWlanAuth defaults) {
        ...
        public Builder anticlogThreshold(Integer anticlogThreshold) {
            if (anticlogThreshold == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "anticlogThreshold");
            }
        ...
        public Builder eapReauth(Boolean eapReauth) {
            if (eapReauth == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "eapReauth");
            }
        ...
        public Builder enableMacAuth(Boolean enableMacAuth) {
            if (enableMacAuth == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "enableMacAuth");
            }
        ...
        public Builder keyIdx(Integer keyIdx) {
            if (keyIdx == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "keyIdx");
            }
            this.keyIdx = keyIdx;
            return this;
        }
        ...
        public Builder keys(List<String> keys) {
            if (keys == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "keys");
            }
            this.keys = keys;
            return this;
        }
        ...
        public Builder multiPskOnly(Boolean multiPskOnly) {
            if (multiPskOnly == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "multiPskOnly");
            }
        ...
        public Builder owe(String owe) {
            if (owe == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "owe");
            }
            this.owe = owe;
            return this;
        }
        ...
        public Builder pairwises(List<String> pairwises) {
            if (pairwises == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "pairwises");
            }
        ...
        public Builder privateWlan(Boolean privateWlan) {
            if (privateWlan == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "privateWlan");
            }
        ...
        public Builder psk(String psk) {
            if (psk == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "psk");
            }
            this.psk = psk;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder wepAsSecondaryAuth(Boolean wepAsSecondaryAuth) {
            if (wepAsSecondaryAuth == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuth", "wepAsSecondaryAuth");
            }
            this.wepAsSecondaryAuth = wepAsSecondaryAuth;
            return this;
        }
        public GetWlansSiteWlanAuth build() {
            final var _resultValue = new GetWlansSiteWlanAuth();
