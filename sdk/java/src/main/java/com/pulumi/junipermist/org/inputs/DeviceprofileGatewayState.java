...
public final class DeviceprofileGatewayState extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileGatewayState Empty = new DeviceprofileGatewayState();
    ...
    private DeviceprofileGatewayState() {}
    ...
    public static Builder builder(DeviceprofileGatewayState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileGatewayState();
        }

        public Builder(DeviceprofileGatewayState defaults) {
            $ = new DeviceprofileGatewayState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param type Device type discriminator for gateway profiles
         * 
         * @return builder
         * 
         */
        ...
        public DeviceprofileGatewayState build() {
            return $;
        }
    }
