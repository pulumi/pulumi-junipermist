...
@CustomType
public final class ApRadioConfigBand24 {
    ...
    public static Builder builder(ApRadioConfigBand24 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String preamble;
        public Builder() {}
        public Builder(ApRadioConfigBand24 defaults) {
        ...
        public ApRadioConfigBand24 build() {
            final var _resultValue = new ApRadioConfigBand24();
