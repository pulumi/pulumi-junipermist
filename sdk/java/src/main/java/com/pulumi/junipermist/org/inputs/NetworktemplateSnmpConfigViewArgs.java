...
public final class NetworktemplateSnmpConfigViewArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NetworktemplateSnmpConfigViewArgs() {}

    private NetworktemplateSnmpConfigViewArgs(NetworktemplateSnmpConfigViewArgs $) {
    ...
    public static Builder builder(NetworktemplateSnmpConfigViewArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworktemplateSnmpConfigViewArgs();
        }

        public Builder(NetworktemplateSnmpConfigViewArgs defaults) {
            $ = new NetworktemplateSnmpConfigViewArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworktemplateSnmpConfigViewArgs build() {
            return $;
        }
    }
