...
import com.pulumi.junipermist.org.outputs.NetworkMulticastGroups;
...
@CustomType
public final class NetworkMulticast {
    /**
     ...
     * 
     */
    private @Nullable Map<String,NetworkMulticastGroups> groups;

    private NetworkMulticast() {}
    /**
     * @return if the network will only be the soruce of the multicast traffic, IGMP can be disabled
     * 
     */
     ...
     * 
     */
    public Map<String,NetworkMulticastGroups> groups() {
    ...
    public static Builder builder(NetworkMulticast defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,NetworkMulticastGroups> groups;
        public Builder() {}
        public Builder(NetworkMulticast defaults) {
        ...
        @CustomType.Setter
        public Builder groups(@Nullable Map<String,NetworkMulticastGroups> groups) {

            this.groups = groups;
            return this;
        }
        public NetworkMulticast build() {
            final var _resultValue = new NetworkMulticast();
