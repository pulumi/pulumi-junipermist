...
@CustomType
public final class DeviceprofileSwitchAclTagsSpec {
    /**
    ...
    private DeviceprofileSwitchAclTagsSpec() {}
    /**
     * @return Matched dst port, &#34;0&#34; means any
     * 
     */
    ...
    public static Builder builder(DeviceprofileSwitchAclTagsSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String protocol;
        public Builder() {}
        public Builder(DeviceprofileSwitchAclTagsSpec defaults) {
        ...
        public DeviceprofileSwitchAclTagsSpec build() {
            final var _resultValue = new DeviceprofileSwitchAclTagsSpec();
