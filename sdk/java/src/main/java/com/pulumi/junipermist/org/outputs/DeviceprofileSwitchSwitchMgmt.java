...
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchSwitchMgmtLocalAccounts;
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchSwitchMgmtProtectRe;
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchSwitchMgmtTacacs;
...
@CustomType
public final class DeviceprofileSwitchSwitchMgmt {
    /**
     ...
     * 
     */
    private @Nullable Map<String,DeviceprofileSwitchSwitchMgmtLocalAccounts> localAccounts;
    /**
     ...
     * 
     */
    private @Nullable DeviceprofileSwitchSwitchMgmtProtectRe protectRe;
    /**
     ...
     * 
     */
    private @Nullable DeviceprofileSwitchSwitchMgmtTacacs tacacs;
    /**
    ...
    private DeviceprofileSwitchSwitchMgmt() {}
    /**
     * @return AP affinity threshold for switch management. If set in both site settings and organization settings, the site setting value is used.
     * 
     */
     ...
     * 
     */
    public Map<String,DeviceprofileSwitchSwitchMgmtLocalAccounts> localAccounts() {
     ...
     * 
     */
    public Optional<DeviceprofileSwitchSwitchMgmtProtectRe> protectRe() {
     ...
     * 
     */
    public Optional<DeviceprofileSwitchSwitchMgmtTacacs> tacacs() {
    ...
    public static Builder builder(DeviceprofileSwitchSwitchMgmt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useMxedgeProxy;
        public Builder() {}
        public Builder(DeviceprofileSwitchSwitchMgmt defaults) {
        ...
        @CustomType.Setter
        public Builder localAccounts(@Nullable Map<String,DeviceprofileSwitchSwitchMgmtLocalAccounts> localAccounts) {
        ...
        @CustomType.Setter
        public Builder protectRe(@Nullable DeviceprofileSwitchSwitchMgmtProtectRe protectRe) {
        ...
        @CustomType.Setter
        public Builder tacacs(@Nullable DeviceprofileSwitchSwitchMgmtTacacs tacacs) {
        ...
        public DeviceprofileSwitchSwitchMgmt build() {
            final var _resultValue = new DeviceprofileSwitchSwitchMgmt();
