...
public final class WlantemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WlantemplateArgs() {}

    private WlantemplateArgs(WlantemplateArgs $) {
    ...
    public static Builder builder(WlantemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WlantemplateArgs();
        }

        public Builder(WlantemplateArgs defaults) {
            $ = new WlantemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WlantemplateArgs build() {
            if ($.orgId == null) {
                throw new MissingRequiredPropertyException("WlantemplateArgs", "orgId");
            }
            return $;
        }
    }
