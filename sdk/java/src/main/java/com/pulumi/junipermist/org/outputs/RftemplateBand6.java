...
@CustomType
public final class RftemplateBand6 {
    ...
    public static Builder builder(RftemplateBand6 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean standardPower;
        public Builder() {}
        public Builder(RftemplateBand6 defaults) {
        ...
        public RftemplateBand6 build() {
            final var _resultValue = new RftemplateBand6();
