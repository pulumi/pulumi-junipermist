...
@CustomType
public final class DeviceprofileSwitchSnmpConfigClientList {
    /**
    ...
    public static Builder builder(DeviceprofileSwitchSnmpConfigClientList defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> clients;
        public Builder() {}
        public Builder(DeviceprofileSwitchSnmpConfigClientList defaults) {
        ...
        public DeviceprofileSwitchSnmpConfigClientList build() {
            final var _resultValue = new DeviceprofileSwitchSnmpConfigClientList();
