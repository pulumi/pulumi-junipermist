...
@CustomType
public final class SwitchVrfInstancesMulticastConfig {
    /**
    ...
    private SwitchVrfInstancesMulticastConfig() {}
    /**
     * @return When `true`, auto-generates a shared RP on `isL3Border` devices (ERB/IPClos topologies only)
     * 
     */
    ...
    public static Builder builder(SwitchVrfInstancesMulticastConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer sbdVlanId;
        public Builder() {}
        public Builder(SwitchVrfInstancesMulticastConfig defaults) {
        ...
        public SwitchVrfInstancesMulticastConfig build() {
            final var _resultValue = new SwitchVrfInstancesMulticastConfig();
