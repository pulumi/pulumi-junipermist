...
@CustomType
public final class NetworktemplateMulticastConfig {
    /**
    ...
    private NetworktemplateMulticastConfig() {}
    /**
     * @return When `true`, auto-generates a shared RP on `isL3Border` devices (ERB/IPClos topologies only)
     * 
     */
    ...
    public static Builder builder(NetworktemplateMulticastConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer sbdVlanId;
        public Builder() {}
        public Builder(NetworktemplateMulticastConfig defaults) {
        ...
        public NetworktemplateMulticastConfig build() {
            final var _resultValue = new NetworktemplateMulticastConfig();
