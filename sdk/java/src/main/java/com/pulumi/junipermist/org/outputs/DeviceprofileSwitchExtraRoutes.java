...
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchExtraRoutesNextQualified;
...
@CustomType
public final class DeviceprofileSwitchExtraRoutes {
    /**
     ...
     * 
     */
    private @Nullable Map<String,DeviceprofileSwitchExtraRoutesNextQualified> nextQualified;
    /**
    ...
    private DeviceprofileSwitchExtraRoutes() {}
    /**
     * @return Whether to install a discard route; this takes precedence over next-hop settings
     * 
     */
     ...
     * 
     */
    public Map<String,DeviceprofileSwitchExtraRoutesNextQualified> nextQualified() {
    ...
    public static Builder builder(DeviceprofileSwitchExtraRoutes defaults) {
    ...
    public static final class Builder {
        ...
        private String via;
        public Builder() {}
        public Builder(DeviceprofileSwitchExtraRoutes defaults) {
        ...
        @CustomType.Setter
        public Builder nextQualified(@Nullable Map<String,DeviceprofileSwitchExtraRoutesNextQualified> nextQualified) {
        ...
        public Builder via(String via) {
            if (via == null) {
              throw new MissingRequiredPropertyException("DeviceprofileSwitchExtraRoutes", "via");
            }
            this.via = via;
            return this;
        }
        public DeviceprofileSwitchExtraRoutes build() {
            final var _resultValue = new DeviceprofileSwitchExtraRoutes();
