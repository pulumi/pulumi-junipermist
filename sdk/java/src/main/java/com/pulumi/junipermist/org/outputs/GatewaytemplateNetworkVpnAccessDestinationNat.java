...
public final class GatewaytemplateNetworkVpnAccessDestinationNat {
    ...
    public static Builder builder(GatewaytemplateNetworkVpnAccessDestinationNat defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer port;
        public Builder() {}
        public Builder(GatewaytemplateNetworkVpnAccessDestinationNat defaults) {
        ...
        public GatewaytemplateNetworkVpnAccessDestinationNat build() {
            final var _resultValue = new GatewaytemplateNetworkVpnAccessDestinationNat();
