...
public final class SwitchRadiusConfigAuthServerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SwitchRadiusConfigAuthServerArgs() {}

    private SwitchRadiusConfigAuthServerArgs(SwitchRadiusConfigAuthServerArgs $) {
        this.host = $.host;
    ...
    public static Builder builder(SwitchRadiusConfigAuthServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchRadiusConfigAuthServerArgs();
        }

        public Builder(SwitchRadiusConfigAuthServerArgs defaults) {
            $ = new SwitchRadiusConfigAuthServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchRadiusConfigAuthServerArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("SwitchRadiusConfigAuthServerArgs", "host");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("SwitchRadiusConfigAuthServerArgs", "secret");
            }
            return $;
        }
    }
