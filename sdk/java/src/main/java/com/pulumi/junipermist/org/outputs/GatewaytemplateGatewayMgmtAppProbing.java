...
import com.pulumi.junipermist.org.outputs.GatewaytemplateGatewayMgmtAppProbingCustomApp;
...
public final class GatewaytemplateGatewayMgmtAppProbing {
    ...
    public static Builder builder(GatewaytemplateGatewayMgmtAppProbing defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean enabled;
        public Builder() {}
        public Builder(GatewaytemplateGatewayMgmtAppProbing defaults) {
        ...
        @CustomType.Setter
        public Builder customApps(@Nullable List<GatewaytemplateGatewayMgmtAppProbingCustomApp> customApps) {

            this.customApps = customApps;
            return this;
        }
        public Builder customApps(GatewaytemplateGatewayMgmtAppProbingCustomApp... customApps) {
        ...
        public GatewaytemplateGatewayMgmtAppProbing build() {
            final var _resultValue = new GatewaytemplateGatewayMgmtAppProbing();
