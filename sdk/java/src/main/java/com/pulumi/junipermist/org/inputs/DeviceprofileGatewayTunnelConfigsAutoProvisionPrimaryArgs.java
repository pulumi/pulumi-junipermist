...
public final class DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs Empty = new DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs();
    ...
    private DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs(DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs $) {
    ...
    public static Builder builder(DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs();
        }

        public Builder(DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs defaults) {
            $ = new DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileGatewayTunnelConfigsAutoProvisionPrimaryArgs build() {
            return $;
        }
    }
