...
public final class DeviceprofileGatewayRoutingPoliciesTermMatchingRouteExists {
    ...
    public static Builder builder(DeviceprofileGatewayRoutingPoliciesTermMatchingRouteExists defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vrfName;
        public Builder() {}
        public Builder(DeviceprofileGatewayRoutingPoliciesTermMatchingRouteExists defaults) {
        ...
        public DeviceprofileGatewayRoutingPoliciesTermMatchingRouteExists build() {
            final var _resultValue = new DeviceprofileGatewayRoutingPoliciesTermMatchingRouteExists();
