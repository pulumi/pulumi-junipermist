...
import com.pulumi.junipermist.device.outputs.SwitchRemoteSyslogFileArchive;
import com.pulumi.junipermist.device.outputs.SwitchRemoteSyslogFileContent;
...
public final class SwitchRemoteSyslogFile {
    ...
    public static Builder builder(SwitchRemoteSyslogFile defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean structuredData;
        public Builder() {}
        public Builder(SwitchRemoteSyslogFile defaults) {
        ...
        @CustomType.Setter
        public Builder archive(@Nullable SwitchRemoteSyslogFileArchive archive) {

            this.archive = archive;
            return this;
        }
        @CustomType.Setter
        public Builder contents(@Nullable List<SwitchRemoteSyslogFileContent> contents) {
        ...
        public SwitchRemoteSyslogFile build() {
