...
public final class GetWlansSiteWlanAuthServer {
    ...
    public static Builder builder(GetWlansSiteWlanAuthServer defaults) {
    ...
    public static final class Builder {
        ...
        private String secret;
        public Builder() {}
        public Builder(GetWlansSiteWlanAuthServer defaults) {
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuthServer", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder keywrapEnabled(Boolean keywrapEnabled) {
            if (keywrapEnabled == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuthServer", "keywrapEnabled");
            }
        ...
        public Builder keywrapFormat(String keywrapFormat) {
            if (keywrapFormat == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuthServer", "keywrapFormat");
            }
        ...
        public Builder keywrapKek(String keywrapKek) {
            if (keywrapKek == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuthServer", "keywrapKek");
            }
        ...
        public Builder keywrapMack(String keywrapMack) {
            if (keywrapMack == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuthServer", "keywrapMack");
            }
        ...
        public Builder requireMessageAuthenticator(Boolean requireMessageAuthenticator) {
            if (requireMessageAuthenticator == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuthServer", "requireMessageAuthenticator");
            }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("GetWlansSiteWlanAuthServer", "secret");
            }
            this.secret = secret;
            return this;
        }
        public GetWlansSiteWlanAuthServer build() {
            final var _resultValue = new GetWlansSiteWlanAuthServer();
