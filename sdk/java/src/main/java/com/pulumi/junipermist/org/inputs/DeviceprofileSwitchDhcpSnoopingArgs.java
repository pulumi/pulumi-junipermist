...
public final class DeviceprofileSwitchDhcpSnoopingArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchDhcpSnoopingArgs Empty = new DeviceprofileSwitchDhcpSnoopingArgs();
    ...
    private DeviceprofileSwitchDhcpSnoopingArgs() {}

    private DeviceprofileSwitchDhcpSnoopingArgs(DeviceprofileSwitchDhcpSnoopingArgs $) {
    ...
    public static Builder builder(DeviceprofileSwitchDhcpSnoopingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchDhcpSnoopingArgs();
        }

        public Builder(DeviceprofileSwitchDhcpSnoopingArgs defaults) {
            $ = new DeviceprofileSwitchDhcpSnoopingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileSwitchDhcpSnoopingArgs build() {
            return $;
        }
    }
