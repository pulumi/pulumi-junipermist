...
@CustomType
public final class NetworktemplateBgpConfigNeighbors {
    /**
    ...
    public static Builder builder(NetworktemplateBgpConfigNeighbors defaults) {
    ...
    public static final class Builder {
        ...
        private String neighborAs;
        public Builder() {}
        public Builder(NetworktemplateBgpConfigNeighbors defaults) {
        ...
        public Builder neighborAs(String neighborAs) {
            if (neighborAs == null) {
              throw new MissingRequiredPropertyException("NetworktemplateBgpConfigNeighbors", "neighborAs");
            }
            this.neighborAs = neighborAs;
            return this;
        }
        public NetworktemplateBgpConfigNeighbors build() {
            final var _resultValue = new NetworktemplateBgpConfigNeighbors();
