...
import com.pulumi.junipermist.org.inputs.DeviceprofileGatewayTunnelConfigsSecondaryProbeHttpArgs;
...
public final class DeviceprofileGatewayTunnelConfigsSecondaryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<DeviceprofileGatewayTunnelConfigsSecondaryProbeHttpArgs> probeHttp;

    /**
     * @return HTTP probe settings for this tunnel node; success from any ICMP or HTTP probe indicates the tunnel is up
     * 
     */
    public Optional<Output<DeviceprofileGatewayTunnelConfigsSecondaryProbeHttpArgs>> probeHttp() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder probeHttp(@Nullable Output<DeviceprofileGatewayTunnelConfigsSecondaryProbeHttpArgs> probeHttp) {
            $.probeHttp = probeHttp;
            return this;
        }
         ...
         * 
         */
        public Builder probeHttp(DeviceprofileGatewayTunnelConfigsSecondaryProbeHttpArgs probeHttp) {
