...
@CustomType
public final class GatewayPortConfigTrafficShaping {
    /**
    ...
    public static Builder builder(GatewayPortConfigTrafficShaping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean enabled;
        public Builder() {}
        public Builder(GatewayPortConfigTrafficShaping defaults) {
        ...
        public GatewayPortConfigTrafficShaping build() {
            final var _resultValue = new GatewayPortConfigTrafficShaping();
