...
public final class SettingBleConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final SettingBleConfigArgs Empty = new SettingBleConfigArgs();
    ...
    private SettingBleConfigArgs() {}

    private SettingBleConfigArgs(SettingBleConfigArgs $) {
    ...
    public static Builder builder(SettingBleConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SettingBleConfigArgs();
        }

        public Builder(SettingBleConfigArgs defaults) {
            $ = new SettingBleConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SettingBleConfigArgs build() {
            return $;
        }
    }
