...
@CustomType
public final class GatewayGatewayMgmtProtectReCustom {
    /**
    ...
    public static Builder builder(GatewayGatewayMgmtProtectReCustom defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> subnets;
        public Builder() {}
        public Builder(GatewayGatewayMgmtProtectReCustom defaults) {
        ...
        public GatewayGatewayMgmtProtectReCustom build() {
            final var _resultValue = new GatewayGatewayMgmtProtectReCustom();
