...
import com.pulumi.junipermist.device.outputs.SwitchExtraRoutes6NextQualified;
...
public final class SwitchExtraRoutes6 {
    ...
    private @Nullable Map<String,SwitchExtraRoutes6NextQualified> nextQualified;
    ...
    public Map<String,SwitchExtraRoutes6NextQualified> nextQualified() {
    ...
    public static Builder builder(SwitchExtraRoutes6 defaults) {
    ...
    public static final class Builder {
        ...
        private String via;
        public Builder() {}
        public Builder(SwitchExtraRoutes6 defaults) {
        ...
        @CustomType.Setter
        public Builder nextQualified(@Nullable Map<String,SwitchExtraRoutes6NextQualified> nextQualified) {
        ...
        public Builder via(String via) {
            if (via == null) {
              throw new MissingRequiredPropertyException("SwitchExtraRoutes6", "via");
            }
            this.via = via;
            return this;
        }
        public SwitchExtraRoutes6 build() {
            final var _resultValue = new SwitchExtraRoutes6();
