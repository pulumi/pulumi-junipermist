...
@CustomType
public final class GetApStatsDeviceApStatRadioStatBand24 {
    /**
    ...
    private GetApStatsDeviceApStatRadioStatBand24() {}
    /**
     * @return channel width for the band.enum: `20`, `40`, `80` (only applicable for band_5 and band_6), `160` (only for band_6)
     * 
     */
    ...
    public static Builder builder(GetApStatsDeviceApStatRadioStatBand24 defaults) {
    ...
    public static final class Builder {
        ...
        private Integer utilUnknownWifi;
        public Builder() {}
        public Builder(GetApStatsDeviceApStatRadioStatBand24 defaults) {
        ...
        public Builder bandwidth(Integer bandwidth) {
            if (bandwidth == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "bandwidth");
            }
        ...
        public Builder channel(Integer channel) {
            if (channel == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "channel");
            }
        ...
        public Builder dynamicChainingEnabled(Boolean dynamicChainingEnabled) {
            if (dynamicChainingEnabled == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "dynamicChainingEnabled");
            }
        ...
        public Builder mac(String mac) {
            if (mac == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "mac");
            }
            this.mac = mac;
            return this;
        }
        ...
        public Builder noiseFloor(Integer noiseFloor) {
            if (noiseFloor == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "noiseFloor");
            }
        ...
        public Builder numClients(Integer numClients) {
            if (numClients == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "numClients");
            }
        ...
        public Builder numWlans(Integer numWlans) {
            if (numWlans == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "numWlans");
            }
        ...
        public Builder power(Integer power) {
            if (power == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "power");
            }
            this.power = power;
            return this;
        }
        ...
        public Builder rxBytes(Integer rxBytes) {
            if (rxBytes == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "rxBytes");
            }
        ...
        public Builder rxPkts(Integer rxPkts) {
            if (rxPkts == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "rxPkts");
            }
            this.rxPkts = rxPkts;
            return this;
        }
        ...
        public Builder txBytes(Integer txBytes) {
            if (txBytes == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "txBytes");
            }
        ...
        public Builder txPkts(Integer txPkts) {
            if (txPkts == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "txPkts");
            }
            this.txPkts = txPkts;
            return this;
        }
        ...
        public Builder usage(String usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "usage");
            }
            this.usage = usage;
            return this;
        }
        ...
        public Builder utilAll(Integer utilAll) {
            if (utilAll == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "utilAll");
            }
        ...
        public Builder utilNonWifi(Integer utilNonWifi) {
            if (utilNonWifi == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "utilNonWifi");
            }
        ...
        public Builder utilRxInBss(Integer utilRxInBss) {
            if (utilRxInBss == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "utilRxInBss");
            }
        ...
        public Builder utilRxOtherBss(Integer utilRxOtherBss) {
            if (utilRxOtherBss == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "utilRxOtherBss");
            }
        ...
        public Builder utilTx(Integer utilTx) {
            if (utilTx == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "utilTx");
            }
            this.utilTx = utilTx;
            return this;
        }
        ...
        public Builder utilUndecodableWifi(Integer utilUndecodableWifi) {
            if (utilUndecodableWifi == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "utilUndecodableWifi");
            }
        ...
        public Builder utilUnknownWifi(Integer utilUnknownWifi) {
            if (utilUnknownWifi == null) {
              throw new MissingRequiredPropertyException("GetApStatsDeviceApStatRadioStatBand24", "utilUnknownWifi");
            }
            this.utilUnknownWifi = utilUnknownWifi;
            return this;
        }
        public GetApStatsDeviceApStatRadioStatBand24 build() {
            final var _resultValue = new GetApStatsDeviceApStatRadioStatBand24();
