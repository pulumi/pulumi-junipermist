...
public final class DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs Empty = new DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs();
    ...
    private DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs() {}

    private DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs(DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs $) {
    ...
    public static Builder builder(DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs();
        }

        public Builder(DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs defaults) {
            $ = new DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceprofileGatewayPortConfigVpnPathsTrafficShapingArgs build() {
            return $;
        }
    }
