...
public final class SwitchOspfAreasNetworks {
    ...
    public static Builder builder(SwitchOspfAreasNetworks defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean passive;
        public Builder() {}
        public Builder(SwitchOspfAreasNetworks defaults) {
        ...
        public SwitchOspfAreasNetworks build() {
            final var _resultValue = new SwitchOspfAreasNetworks();
