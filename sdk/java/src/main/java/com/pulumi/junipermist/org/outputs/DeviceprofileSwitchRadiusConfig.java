...
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchRadiusConfigAcctServer;
import com.pulumi.junipermist.org.outputs.DeviceprofileSwitchRadiusConfigAuthServer;
...
@CustomType
public final class DeviceprofileSwitchRadiusConfig {
    /**
     ...
     * 
     */
    private @Nullable List<DeviceprofileSwitchRadiusConfigAcctServer> acctServers;
    /**
     ...
     * 
     */
    private @Nullable List<DeviceprofileSwitchRadiusConfigAuthServer> authServers;
    /**
    ...
    private DeviceprofileSwitchRadiusConfig() {}
    /**
     * @return Whether immediate RADIUS accounting updates are sent
     * 
     */
     ...
     * 
     */
    public List<DeviceprofileSwitchRadiusConfigAcctServer> acctServers() {
     ...
     * 
     */
    public List<DeviceprofileSwitchRadiusConfigAuthServer> authServers() {
    ...
    public static Builder builder(DeviceprofileSwitchRadiusConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceIp;
        public Builder() {}
        public Builder(DeviceprofileSwitchRadiusConfig defaults) {
        ...
        @CustomType.Setter
        public Builder acctServers(@Nullable List<DeviceprofileSwitchRadiusConfigAcctServer> acctServers) {

            this.acctServers = acctServers;
            return this;
        }
        public Builder acctServers(DeviceprofileSwitchRadiusConfigAcctServer... acctServers) {
        ...
        @CustomType.Setter
        public Builder authServers(@Nullable List<DeviceprofileSwitchRadiusConfigAuthServer> authServers) {

            this.authServers = authServers;
            return this;
        }
        public Builder authServers(DeviceprofileSwitchRadiusConfigAuthServer... authServers) {
        ...
        public DeviceprofileSwitchRadiusConfig build() {
            final var _resultValue = new DeviceprofileSwitchRadiusConfig();
