...
@CustomType
public final class SwitchRadiusConfigAcctServer {
    /**
    ...
    private SwitchRadiusConfigAcctServer() {}
    /**
     * @return IP/ hostname of RADIUS server
     * 
     */
    ...
    public static Builder builder(SwitchRadiusConfigAcctServer defaults) {
    ...
    public static final class Builder {
        ...
        private String secret;
        public Builder() {}
        public Builder(SwitchRadiusConfigAcctServer defaults) {
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("SwitchRadiusConfigAcctServer", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("SwitchRadiusConfigAcctServer", "secret");
            }
            this.secret = secret;
            return this;
        }
        public SwitchRadiusConfigAcctServer build() {
            final var _resultValue = new SwitchRadiusConfigAcctServer();
