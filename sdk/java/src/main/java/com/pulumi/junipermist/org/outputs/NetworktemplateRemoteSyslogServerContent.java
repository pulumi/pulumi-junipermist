...
@CustomType
public final class NetworktemplateRemoteSyslogServerContent {
    /**
    ...
    public static Builder builder(NetworktemplateRemoteSyslogServerContent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String severity;
        public Builder() {}
        public Builder(NetworktemplateRemoteSyslogServerContent defaults) {
        ...
        public NetworktemplateRemoteSyslogServerContent build() {
            final var _resultValue = new NetworktemplateRemoteSyslogServerContent();
