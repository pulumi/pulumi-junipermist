...
public final class ApBleConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApBleConfigArgs Empty = new ApBleConfigArgs();
    ...
    private ApBleConfigArgs() {}

    private ApBleConfigArgs(ApBleConfigArgs $) {
    ...
    public static Builder builder(ApBleConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApBleConfigArgs defaults) {
            $ = new ApBleConfigArgs(Objects.requireNonNull(defaults));
        }
