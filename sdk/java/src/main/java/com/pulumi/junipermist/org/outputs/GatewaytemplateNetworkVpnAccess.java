...
import com.pulumi.junipermist.org.outputs.GatewaytemplateNetworkVpnAccessDestinationNat;
import com.pulumi.junipermist.org.outputs.GatewaytemplateNetworkVpnAccessSourceNat;
import com.pulumi.junipermist.org.outputs.GatewaytemplateNetworkVpnAccessStaticNat;
...
@CustomType
public final class GatewaytemplateNetworkVpnAccess {
    /**
     ...
     * 
     */
    private @Nullable Map<String,GatewaytemplateNetworkVpnAccessDestinationNat> destinationNat;
    /**
     ...
     * 
     */
    private @Nullable GatewaytemplateNetworkVpnAccessSourceNat sourceNat;
    /**
     * @return Property key may be an External IP Address (i.e. &#34;63.16.0.3&#34;), a CIDR (i.e. &#34;63.16.0.12/20&#34;) or a Variable (i.e. &#34;{{myvar}}&#34;)
     * 
     */
    private @Nullable Map<String,GatewaytemplateNetworkVpnAccessStaticNat> staticNat;
    /**
     * @return toward overlay, how HUB should deal with routes it received from Spokes
     * 
     */
    ...
    private GatewaytemplateNetworkVpnAccess() {}
    /**
     * @return If `routed`==`true`, whether to advertise an aggregated subnet toward HUB this is useful when there are multiple networks on SPOKE&#39;s side
     * 
     */
     ...
     * 
     */
    public Map<String,GatewaytemplateNetworkVpnAccessDestinationNat> destinationNat() {
     ...
     * 
     */
    public Optional<GatewaytemplateNetworkVpnAccessSourceNat> sourceNat() {
     ...
     * 
     */
    public Map<String,GatewaytemplateNetworkVpnAccessStaticNat> staticNat() {
    ...
    public static Builder builder(GatewaytemplateNetworkVpnAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String summarizedSubnetToLanOspf;
        public Builder() {}
        public Builder(GatewaytemplateNetworkVpnAccess defaults) {
        ...
        @CustomType.Setter
        public Builder destinationNat(@Nullable Map<String,GatewaytemplateNetworkVpnAccessDestinationNat> destinationNat) {
        ...
        @CustomType.Setter
        public Builder sourceNat(@Nullable GatewaytemplateNetworkVpnAccessSourceNat sourceNat) {

            this.sourceNat = sourceNat;
            return this;
        }
        @CustomType.Setter
        public Builder staticNat(@Nullable Map<String,GatewaytemplateNetworkVpnAccessStaticNat> staticNat) {
        ...
        public GatewaytemplateNetworkVpnAccess build() {
            final var _resultValue = new GatewaytemplateNetworkVpnAccess();
