...
@CustomType
public final class RftemplateModelSpecificBand24 {
    ...
    public static Builder builder(RftemplateModelSpecificBand24 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String preamble;
        public Builder() {}
        public Builder(RftemplateModelSpecificBand24 defaults) {
        ...
        public RftemplateModelSpecificBand24 build() {
            final var _resultValue = new RftemplateModelSpecificBand24();
