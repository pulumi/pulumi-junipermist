...
public final class MxedgeMxedgeMgmtArgs extends com.pulumi.resources.ResourceArgs {

    public static final MxedgeMxedgeMgmtArgs Empty = new MxedgeMxedgeMgmtArgs();
    ...
    private MxedgeMxedgeMgmtArgs() {}

    private MxedgeMxedgeMgmtArgs(MxedgeMxedgeMgmtArgs $) {
    ...
    public static Builder builder(MxedgeMxedgeMgmtArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MxedgeMxedgeMgmtArgs();
        }

        public Builder(MxedgeMxedgeMgmtArgs defaults) {
            $ = new MxedgeMxedgeMgmtArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MxedgeMxedgeMgmtArgs build() {
            return $;
        }
    }
