...
@CustomType
public final class DeviceprofileGatewayPortConfigVpnPathsTrafficShaping {
    /**
    ...
    public static Builder builder(DeviceprofileGatewayPortConfigVpnPathsTrafficShaping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maxTxKbps;
        public Builder() {}
        public Builder(DeviceprofileGatewayPortConfigVpnPathsTrafficShaping defaults) {
        ...
        public DeviceprofileGatewayPortConfigVpnPathsTrafficShaping build() {
            final var _resultValue = new DeviceprofileGatewayPortConfigVpnPathsTrafficShaping();
