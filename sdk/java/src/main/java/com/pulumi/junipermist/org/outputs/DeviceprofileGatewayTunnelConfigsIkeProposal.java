...
@CustomType
public final class DeviceprofileGatewayTunnelConfigsIkeProposal {
    /**
    ...
    public static Builder builder(DeviceprofileGatewayTunnelConfigsIkeProposal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String encAlgo;
        public Builder() {}
        public Builder(DeviceprofileGatewayTunnelConfigsIkeProposal defaults) {
        ...
        public DeviceprofileGatewayTunnelConfigsIkeProposal build() {
            final var _resultValue = new DeviceprofileGatewayTunnelConfigsIkeProposal();
