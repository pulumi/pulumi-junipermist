...
import com.pulumi.junipermist.site.outputs.SettingGatewayMgmtProtectReCustom;
...
@CustomType
public final class SettingGatewayMgmtProtectRe {
    /**
    ...
    public static Builder builder(SettingGatewayMgmtProtectRe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> trustedHosts;
        public Builder() {}
        public Builder(SettingGatewayMgmtProtectRe defaults) {
        ...
        @CustomType.Setter
        public Builder customs(@Nullable List<SettingGatewayMgmtProtectReCustom> customs) {

            this.customs = customs;
            return this;
        }
        public Builder customs(SettingGatewayMgmtProtectReCustom... customs) {
        ...
        public SettingGatewayMgmtProtectRe build() {
            final var _resultValue = new SettingGatewayMgmtProtectRe();
