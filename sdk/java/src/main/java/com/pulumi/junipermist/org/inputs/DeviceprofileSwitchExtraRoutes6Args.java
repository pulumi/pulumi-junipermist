...
import com.pulumi.junipermist.org.inputs.DeviceprofileSwitchExtraRoutes6NextQualifiedArgs;
...
public final class DeviceprofileSwitchExtraRoutes6Args extends com.pulumi.resources.ResourceArgs {

    public static final DeviceprofileSwitchExtraRoutes6Args Empty = new DeviceprofileSwitchExtraRoutes6Args();
    ...
    private @Nullable Output<Map<String,DeviceprofileSwitchExtraRoutes6NextQualifiedArgs>> nextQualified;

    /**
     * @return Qualified next-hop settings keyed by IPv6 next-hop address
     * 
     */
    public Optional<Output<Map<String,DeviceprofileSwitchExtraRoutes6NextQualifiedArgs>>> nextQualified() {
    ...
    private DeviceprofileSwitchExtraRoutes6Args() {}

    private DeviceprofileSwitchExtraRoutes6Args(DeviceprofileSwitchExtraRoutes6Args $) {
    ...
    public static Builder builder(DeviceprofileSwitchExtraRoutes6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceprofileSwitchExtraRoutes6Args();
        }

        public Builder(DeviceprofileSwitchExtraRoutes6Args defaults) {
            $ = new DeviceprofileSwitchExtraRoutes6Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder nextQualified(@Nullable Output<Map<String,DeviceprofileSwitchExtraRoutes6NextQualifiedArgs>> nextQualified) {
         ...
         * 
         */
        public Builder nextQualified(Map<String,DeviceprofileSwitchExtraRoutes6NextQualifiedArgs> nextQualified) {
        ...
        public DeviceprofileSwitchExtraRoutes6Args build() {
            if ($.via == null) {
                throw new MissingRequiredPropertyException("DeviceprofileSwitchExtraRoutes6Args", "via");
            }
            return $;
        }
    }
