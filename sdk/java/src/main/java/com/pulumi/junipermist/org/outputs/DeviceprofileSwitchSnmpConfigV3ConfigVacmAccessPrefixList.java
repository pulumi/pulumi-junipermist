...
@CustomType
public final class DeviceprofileSwitchSnmpConfigV3ConfigVacmAccessPrefixList {
    /**
    ...
    public static Builder builder(DeviceprofileSwitchSnmpConfigV3ConfigVacmAccessPrefixList defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String writeView;
        public Builder() {}
        public Builder(DeviceprofileSwitchSnmpConfigV3ConfigVacmAccessPrefixList defaults) {
        ...
        public DeviceprofileSwitchSnmpConfigV3ConfigVacmAccessPrefixList build() {
            final var _resultValue = new DeviceprofileSwitchSnmpConfigV3ConfigVacmAccessPrefixList();
