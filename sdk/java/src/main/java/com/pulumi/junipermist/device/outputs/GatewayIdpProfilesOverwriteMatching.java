...
@CustomType
public final class GatewayIdpProfilesOverwriteMatching {
    ...
    public static Builder builder(GatewayIdpProfilesOverwriteMatching defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> severities;
        public Builder() {}
        public Builder(GatewayIdpProfilesOverwriteMatching defaults) {
        ...
        public GatewayIdpProfilesOverwriteMatching build() {
            final var _resultValue = new GatewayIdpProfilesOverwriteMatching();
