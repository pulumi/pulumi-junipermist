...
import com.pulumi.junipermist.device.inputs.GatewayNetworkVpnAccessDestinationNatArgs;
import com.pulumi.junipermist.device.inputs.GatewayNetworkVpnAccessSourceNatArgs;
import com.pulumi.junipermist.device.inputs.GatewayNetworkVpnAccessStaticNatArgs;
...
public final class GatewayNetworkVpnAccessArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewayNetworkVpnAccessArgs Empty = new GatewayNetworkVpnAccessArgs();
    ...
    private @Nullable Output<GatewayNetworkVpnAccessSourceNatArgs> sourceNat;

    /**
     * @return If `routed`==`false` (usually at Spoke), but some hosts needs to be reachable from Hub
     * 
     */
    public Optional<Output<GatewayNetworkVpnAccessSourceNatArgs>> sourceNat() {
    ...
    private GatewayNetworkVpnAccessArgs() {}

    private GatewayNetworkVpnAccessArgs(GatewayNetworkVpnAccessArgs $) {
    ...
    public static Builder builder(GatewayNetworkVpnAccessArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayNetworkVpnAccessArgs();
        }

        public Builder(GatewayNetworkVpnAccessArgs defaults) {
            $ = new GatewayNetworkVpnAccessArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder destinationNat(@Nullable Output<Map<String,GatewayNetworkVpnAccessDestinationNatArgs>> destinationNat) {
         ...
         * 
         */
        public Builder destinationNat(Map<String,GatewayNetworkVpnAccessDestinationNatArgs> destinationNat) {
         ...
         * 
         */
        public Builder sourceNat(@Nullable Output<GatewayNetworkVpnAccessSourceNatArgs> sourceNat) {
            $.sourceNat = sourceNat;
            return this;
        }
         ...
         * 
         */
        public Builder sourceNat(GatewayNetworkVpnAccessSourceNatArgs sourceNat) {
         ...
         * 
         */
        public Builder staticNat(@Nullable Output<Map<String,GatewayNetworkVpnAccessStaticNatArgs>> staticNat) {
            $.staticNat = staticNat;
            return this;
        }
         ...
         * 
         */
        public Builder staticNat(Map<String,GatewayNetworkVpnAccessStaticNatArgs> staticNat) {
        ...
        public GatewayNetworkVpnAccessArgs build() {
            return $;
        }
    }
