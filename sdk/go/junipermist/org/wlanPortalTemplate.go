...
func NewWlanPortalTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("junipermist:org/wlanPortalTemplate:WlanPortalTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWlanPortalTemplate(ctx *pulumi.Context,
	...
	var resource WlanPortalTemplate
	err := ctx.ReadResource("junipermist:org/wlanPortalTemplate:WlanPortalTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o WlanPortalTemplateOutput) OrgId() pulumi.StringOutput {
