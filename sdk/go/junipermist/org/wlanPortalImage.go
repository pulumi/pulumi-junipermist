...
func NewWlanPortalImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("junipermist:org/wlanPortalImage:WlanPortalImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWlanPortalImage(ctx *pulumi.Context,
	...
	var resource WlanPortalImage
	err := ctx.ReadResource("junipermist:org/wlanPortalImage:WlanPortalImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
