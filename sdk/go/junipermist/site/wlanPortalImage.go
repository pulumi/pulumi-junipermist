...
func (o WlanPortalImageOutput) SiteId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WlanPortalImage) pulumi.StringPtrOutput { return v.SiteId }).(pulumi.StringPtrOutput)
}
