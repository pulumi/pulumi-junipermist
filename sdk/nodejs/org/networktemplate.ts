...
export interface NetworktemplateState {
    ...
    bgpConfig?: pulumi.Input<{[key: string]: pulumi.Input<inputs.org.NetworktemplateBgpConfig>}>;
     ...
     * Property key is the routing policy name
     */
    routingPolicies?: pulumi.Input<{[key: string]: pulumi.Input<inputs.org.NetworktemplateRoutingPolicies>}>;
