...
class EvpnTopologyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] site_id: Site associated with the EVPN topology
...
class EvpnTopology(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `site.EvpnTopology` with:
    ...
    @_builtins.property
    @pulumi.getter(name="podNames")
    def pod_names(self) -> pulumi.Output[Mapping[str, _builtins.str]]:
        """
        Property key is the pod number
        """
        return pulumi.get(self, "pod_names")
