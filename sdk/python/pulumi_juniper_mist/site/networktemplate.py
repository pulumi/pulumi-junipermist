...
class NetworktemplateArgs:
    def __init__(__self__, *,
                 ...
                 auto_upgrade_linecard: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 disabled_system_defined_port_usages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] site_id: Unique ID of the object instance in the Mist Organization
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disabled_system_defined_port_usages: If some system-default port usages are not desired - namely, ap / iot / uplink
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ntp_servers: List of NTP servers
    ...
    def auto_upgrade_linecard(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "auto_upgrade_linecard")

    @auto_upgrade_linecard.setter
    def auto_upgrade_linecard(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def disabled_system_defined_port_usages(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def disabled_system_defined_port_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Networktemplate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoUpgradeLinecard")
    def auto_upgrade_linecard(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "auto_upgrade_linecard")

    @property
    @pulumi.getter(name="defaultPortUsage")
    def default_port_usage(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Port usage to assign to switch ports without any port usage assigned. Default: `default` to preserve default behavior
        """
        return pulumi.get(self, "default_port_usage")
    ...
    @property
    @pulumi.getter(name="disabledSystemDefinedPortUsages")
    def disabled_system_defined_port_usages(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        If some system-default port usages are not desired - namely, ap / iot / uplink
        """
        return pulumi.get(self, "disabled_system_defined_port_usages")
