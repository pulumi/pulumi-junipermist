...
class WlanPortalImageArgs:
    def __init__(__self__, *,
                 ...
                 wlan_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a WlanPortalImage resource.
        :param pulumi.Input[builtins.str] file: path to the background image file. File must be a `jpeg`, `jpg` or `png` image`
        :param pulumi.Input[builtins.str] wlan_id: Site WLAN ID
        """
    ...
    def wlan_id(self) -> pulumi.Input[builtins.str]:
        """
        Site WLAN ID
        """
    ...
    @wlan_id.setter
    def wlan_id(self, value: pulumi.Input[builtins.str]):
...
class _WlanPortalImageState:
    def __init__(__self__, *,
                 ...
                 wlan_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="wlanId")
    def wlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Site WLAN ID
        """
        return pulumi.get(self, "wlan_id")
    ...
    @wlan_id.setter
    def wlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "wlan_id", value)


@pulumi.type_token("junipermist:site/wlanPortalImage:WlanPortalImage")
class WlanPortalImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            file: Optional[pulumi.Input[builtins.str]] = None,
            site_id: Optional[pulumi.Input[builtins.str]] = None,
            wlan_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WlanPortalImage':
        """
    ...
    @property
    @pulumi.getter(name="wlanId")
    def wlan_id(self) -> pulumi.Output[builtins.str]:
        """
        Site WLAN ID
        """
        return pulumi.get(self, "wlan_id")
