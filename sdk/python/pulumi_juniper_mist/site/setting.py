...
class SettingArgs:
    def __init__(__self__, *,
                 ...
                 default_port_usage: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 sle_thresholds: Optional[pulumi.Input['SettingSleThresholdsArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] default_port_usage: Port usage to assign to switch ports without any port usage assigned. Default: `default` to preserve default behavior
        ...
        :param pulumi.Input[builtins.bool] remove_existing_configs: By default, only the configuration generated by Mist is cleaned up during the configuration process. If `true`, all the
    ...
    def default_port_usage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_port_usage(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sle_thresholds(self) -> Optional[pulumi.Input['SettingSleThresholdsArgs']]:
        return pulumi.get(self, "sle_thresholds")

    @sle_thresholds.setter
    def sle_thresholds(self, value: Optional[pulumi.Input['SettingSleThresholdsArgs']]):
...
class Setting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sle_thresholds: Optional[pulumi.Input[Union['SettingSleThresholdsArgs', 'SettingSleThresholdsArgsDict']]] = None,
    ...
    @property
    @pulumi.getter(name="defaultPortUsage")
    def default_port_usage(self) -> pulumi.Output[builtins.str]:
        """
        Port usage to assign to switch ports without any port usage assigned. Default: `default` to preserve default behavior
        """
        return pulumi.get(self, "default_port_usage")
