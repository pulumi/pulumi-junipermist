...
__all__ = [
    ...
    'NetworktemplateVrfInstancesVrfExtraRoutes',
    'SettingAnalytic',
    'SettingAutoUpgrade',
    'SettingBleConfig',
...
class NetworktemplateVrfInstances(dict):
    ...
    def __init__(__self__, *,
                 networks: Optional[Sequence[str]] = None,
                 vrf_extra_routes: Optional[Mapping[str, 'outputs.NetworktemplateVrfInstancesVrfExtraRoutes']] = None):
        """
        :param Mapping[str, 'NetworktemplateVrfInstancesVrfExtraRoutesArgs'] vrf_extra_routes: Property key is the destination CIDR (e.g. "10.0.0.0/8")
        """
        if networks is not None:
            pulumi.set(__self__, "networks", networks)
    ...
    def vrf_extra_routes(self) -> Optional[Mapping[str, 'outputs.NetworktemplateVrfInstancesVrfExtraRoutes']]:
        """
...
@pulumi.output_type
class NetworktemplateVrfInstancesVrfExtraRoutes(dict):
    def __init__(__self__, *,
                 via: str):
        """
...
class SettingGatewayMgmtAppProbingCustomApp(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str protocol: enum: `http`, `udp`
