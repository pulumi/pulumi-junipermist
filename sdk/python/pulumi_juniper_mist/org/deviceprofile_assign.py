...
class DeviceprofileAssignArgs:
    def __init__(__self__, *,
                 deviceprofile_id: pulumi.Input[_builtins.str],
    ...
    def deviceprofile_id(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "deviceprofile_id")

    @deviceprofile_id.setter
    def deviceprofile_id(self, value: pulumi.Input[_builtins.str]):
...
class DeviceprofileAssign(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="deviceprofileId")
    def deviceprofile_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "deviceprofile_id")
