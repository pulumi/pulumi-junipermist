...
class DeviceprofileAssignArgs:
    def __init__(__self__, *,
                 deviceprofile_id: pulumi.Input[builtins.str],
    ...
    def deviceprofile_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "deviceprofile_id")

    @deviceprofile_id.setter
    def deviceprofile_id(self, value: pulumi.Input[builtins.str]):
...
class DeviceprofileAssign(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            deviceprofile_id: Optional[pulumi.Input[builtins.str]] = None,
            macs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            org_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DeviceprofileAssign':
        """
    ...
    @property
    @pulumi.getter(name="deviceprofileId")
    def deviceprofile_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "deviceprofile_id")

    @property
    @pulumi.getter
    def macs(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "macs")
