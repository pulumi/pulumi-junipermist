...
def get_nac_endpoints(labels: Optional[Sequence[builtins.str]] = None,
...
def get_nac_endpoints_output(labels: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
