...
class SettingArgs:
    def __init__(__self__, *,
                 ...
                 disable_pcap: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_remote_shell: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 mxedge_fips_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 ui_idle_timeout: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] device_updown_threshold: Enable threshold-based device down delivery via * device-updowns webhooks topic, * Mist Alert Framework; e.g. send
               ...
               immediate)
        :param pulumi.Input[builtins.bool] disable_pcap: Whether to disallow Mist to analyze pcap files (this is required for marvis pcap)
        :param pulumi.Input[builtins.bool] disable_remote_shell: Whether to disable remote shell access for an entire org
        ...
        :param pulumi.Input[builtins.int] switch_updown_threshold: Enable threshold-based device down delivery for Switch devices only. When configured it takes effect for SW devices and
               `device_updown_threshold` is ignored.
        :param pulumi.Input[builtins.int] ui_idle_timeout: Automatically logout the user when UI session is inactive. `0` means disabled
        """
    ...
    def disable_pcap(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @disable_pcap.setter
    def disable_pcap(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_pcap", value)

    @property
    @pulumi.getter(name="disableRemoteShell")
    def disable_remote_shell(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_remote_shell(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mxedge_fips_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "mxedge_fips_enabled")

    @mxedge_fips_enabled.setter
    def mxedge_fips_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ui_idle_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ui_idle_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Setting(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="disablePcap")
    def disable_pcap(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to disallow Mist to analyze pcap files (this is required for marvis pcap)
        """
        return pulumi.get(self, "disable_pcap")
    ...
    @property
    @pulumi.getter(name="disableRemoteShell")
    def disable_remote_shell(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to disable remote shell access for an entire org
        """
        return pulumi.get(self, "disable_remote_shell")
    ...
    @property
    @pulumi.getter(name="mxedgeFipsEnabled")
    def mxedge_fips_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "mxedge_fips_enabled")
    ...
    @property
    @pulumi.getter(name="uiIdleTimeout")
    def ui_idle_timeout(self) -> pulumi.Output[builtins.int]:
        """
        Automatically logout the user when UI session is inactive. `0` means disabled
        """
        return pulumi.get(self, "ui_idle_timeout")
