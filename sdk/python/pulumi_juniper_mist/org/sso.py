...
class SsoArgs:
    def __init__(__self__, *,
                 idp_cert: pulumi.Input[builtins.str],
                 idp_sign_algo: pulumi.Input[builtins.str],
                 idp_sso_url: pulumi.Input[builtins.str],
                 issuer: pulumi.Input[builtins.str],
                 org_id: pulumi.Input[builtins.str],
                 custom_logout_url: Optional[pulumi.Input[builtins.str]] = None,
                 default_role: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_unmatched_roles: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 nameid_format: Optional[pulumi.Input[builtins.str]] = None,
                 role_attr_extraction: Optional[pulumi.Input[builtins.str]] = None,
                 role_attr_from: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Sso resource.
        :param pulumi.Input[builtins.str] idp_cert: IDP Cert (used to verify the signed response)
        :param pulumi.Input[builtins.str] idp_sign_algo: Signing algorithm for SAML Assertion. enum `sha1`, `sha256`, `sha384`, `sha512`
        :param pulumi.Input[builtins.str] idp_sso_url: IDP Single-Sign-On URL
        :param pulumi.Input[builtins.str] issuer: IDP issuer URL
        :param pulumi.Input[builtins.str] custom_logout_url: a URL we will redirect the user after user logout from Mist (for some IdP which supports a custom logout URL that is
               different from SP-initiated SLO process)
        :param pulumi.Input[builtins.str] default_role: default role to assign if there’s no match. By default, an assertion is treated as invalid when there’s no role
               matched
        :param pulumi.Input[builtins.bool] ignore_unmatched_roles: ignore any unmatched roles provided in assertion. By default, an assertion is treated as invalid for any unmatched role
        :param pulumi.Input[builtins.str] name: Name
        :param pulumi.Input[builtins.str] nameid_format: enum: `email`, `unspecified`
        :param pulumi.Input[builtins.str] role_attr_extraction: custom role attribute parsing scheme. Supported Role Parsing Schemes
               ...
               “cn”</td></tr></table>
        :param pulumi.Input[builtins.str] role_attr_from: name of the attribute in SAML Assertion to extract role from. Default: `Role`
        """
    ...
    def idp_cert(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @idp_cert.setter
    def idp_cert(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "idp_cert", value)

    @property
    @pulumi.getter(name="idpSignAlgo")
    def idp_sign_algo(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def idp_sign_algo(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "idp_sign_algo", value)

    @property
    @pulumi.getter(name="idpSsoUrl")
    def idp_sso_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @idp_sso_url.setter
    def idp_sso_url(self, value: pulumi.Input[builtins.str]):
    ...
    def custom_logout_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_logout_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ignore_unmatched_roles(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_unmatched_roles(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def nameid_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nameid_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nameid_format", value)

    @property
    @pulumi.getter(name="roleAttrExtraction")
    def role_attr_extraction(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def role_attr_extraction(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "role_attr_extraction", value)

    @property
    @pulumi.getter(name="roleAttrFrom")
    def role_attr_from(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def role_attr_from(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SsoState:
    def __init__(__self__, *,
                 ...
                 idp_sign_algo: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] default_role: default role to assign if there’s no match. By default, an assertion is treated as invalid when there’s no role
               matched
        :param pulumi.Input[builtins.str] domain: Random string generated during the SSO creation and used to generate the SAML URLs: * ACS URL =
    ...
    @property
    @pulumi.getter(name="idpSignAlgo")
    def idp_sign_algo(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Signing algorithm for SAML Assertion. enum `sha1`, `sha256`, `sha384`, `sha512`
        """
        return pulumi.get(self, "idp_sign_algo")
    ...
    @idp_sign_algo.setter
    def idp_sign_algo(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idp_sign_algo", value)
...
class Sso(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            role_attr_extraction: Optional[pulumi.Input[builtins.str]] = None,
            role_attr_from: Optional[pulumi.Input[builtins.str]] = None) -> 'Sso':
        """
    ...
    @property
    @pulumi.getter(name="customLogoutUrl")
    def custom_logout_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        a URL we will redirect the user after user logout from Mist (for some IdP which supports a custom logout URL that is
        different from SP-initiated SLO process)
        """
    ...
    @property
    @pulumi.getter(name="idpCert")
    def idp_cert(self) -> pulumi.Output[builtins.str]:
        """
        IDP Cert (used to verify the signed response)
        """
        return pulumi.get(self, "idp_cert")
    ...
    @property
    @pulumi.getter(name="idpSignAlgo")
    def idp_sign_algo(self) -> pulumi.Output[builtins.str]:
        """
        Signing algorithm for SAML Assertion. enum `sha1`, `sha256`, `sha384`, `sha512`
        """
        return pulumi.get(self, "idp_sign_algo")
    ...
    @property
    @pulumi.getter(name="ignoreUnmatchedRoles")
    def ignore_unmatched_roles(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        ignore any unmatched roles provided in assertion. By default, an assertion is treated as invalid for any unmatched role
        """
        return pulumi.get(self, "ignore_unmatched_roles")
    ...
    @property
    @pulumi.getter(name="nameidFormat")
    def nameid_format(self) -> pulumi.Output[builtins.str]:
        """
        enum: `email`, `unspecified`
        """
        return pulumi.get(self, "nameid_format")
    ...
    @property
    @pulumi.getter(name="roleAttrExtraction")
    def role_attr_extraction(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        custom role attribute parsing scheme. Supported Role Parsing Schemes
        <table><tr><th>Name</th><th>Scheme</th></tr><tr><td>`cn`</td><td><ul><li>The expected role attribute format in SAML
        Assertion is “CN=cn,OU=ou1,OU=ou2,…”</li><li>CN (the key) is case insensitive and exactly 1 CN is expected (or the
    ...
    @property
    @pulumi.getter(name="roleAttrFrom")
    def role_attr_from(self) -> pulumi.Output[builtins.str]:
        """
        name of the attribute in SAML Assertion to extract role from. Default: `Role`
        """
        return pulumi.get(self, "role_attr_from")
