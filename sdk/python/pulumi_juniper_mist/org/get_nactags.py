...
class GetNactagsResult:
    ...
    """
    def __init__(__self__, id=None, org_id=None, org_nactags=None):
...
def get_nactags(org_id: Optional[str] = None,
...
def get_nactags_output(org_id: Optional[pulumi.Input[str]] = None,
