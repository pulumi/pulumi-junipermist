...
class BaseArgs:
    def __init__(__self__, *,
                 ...
                 allow_mist: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 session_expiry: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    def allow_mist(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "allow_mist")

    @allow_mist.setter
    def allow_mist(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def session_expiry(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "session_expiry")

    @session_expiry.setter
    def session_expiry(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BaseState:
    def __init__(__self__, *,
                 ...
                 msp_logo_url: Optional[pulumi.Input[builtins.str]] = None,
                 msp_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 orggroup_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 session_expiry: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    def msp_logo_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @msp_logo_url.setter
    def msp_logo_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @msp_name.setter
    def msp_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def orggroup_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "orggroup_ids")

    @orggroup_ids.setter
    def orggroup_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Base(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            orggroup_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            session_expiry: Optional[pulumi.Input[builtins.int]] = None) -> 'Base':
        """
    ...
    @property
    @pulumi.getter(name="allowMist")
    def allow_mist(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "allow_mist")
    ...
    @property
    @pulumi.getter(name="mspLogoUrl")
    def msp_logo_url(self) -> pulumi.Output[builtins.str]:
        """
        logo uploaded by the MSP with advanced tier, only present if provided
        """
        return pulumi.get(self, "msp_logo_url")
    ...
    @property
    @pulumi.getter(name="orggroupIds")
    def orggroup_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "orggroup_ids")

    @property
    @pulumi.getter(name="sessionExpiry")
    def session_expiry(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "session_expiry")
