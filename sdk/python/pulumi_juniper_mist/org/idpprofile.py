...
class IdpprofileArgs:
    def __init__(__self__, *,
                 base_profile: pulumi.Input[builtins.str],
    ...
    def base_profile(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @base_profile.setter
    def base_profile(self, value: pulumi.Input[builtins.str]):
...
class Idpprofile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="baseProfile")
    def base_profile(self) -> pulumi.Output[builtins.str]:
        """
        enum: `critical`, `standard`, `strict`
        """
        return pulumi.get(self, "base_profile")
