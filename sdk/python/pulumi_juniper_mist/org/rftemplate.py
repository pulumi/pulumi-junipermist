...
class RftemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] country_code: Optional, country code to use. If specified, this gets applied to all sites using the RF Template
        ...
        :param pulumi.Input[builtins.str] name: The name of the RF template
...
class Rftemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            scanning_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Rftemplate':
        """
    ...
    @property
    @pulumi.getter(name="antGain24")
    def ant_gain24(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "ant_gain24")

    @property
    @pulumi.getter(name="antGain5")
    def ant_gain5(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "ant_gain5")

    @property
    @pulumi.getter(name="antGain6")
    def ant_gain6(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "ant_gain6")
    ...
    @property
    @pulumi.getter(name="band24Usage")
    def band24_usage(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        enum: `24`, `5`, `6`, `auto`
        """
        return pulumi.get(self, "band24_usage")
    ...
    @property
    @pulumi.getter(name="scanningEnabled")
    def scanning_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether scanning radio is enabled
        """
        return pulumi.get(self, "scanning_enabled")
