...
class NacidpArgs:
    def __init__(__self__, *,
                 idp_type: pulumi.Input[builtins.str],
                 org_id: pulumi.Input[builtins.str],
                 group_filter: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_base_dn: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_bind_dn: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_bind_password: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_cacerts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ldap_client_cert: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_client_key: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_group_attr: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_group_dn: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_resolve_groups: Optional[pulumi.Input[builtins.bool]] = None,
                 ldap_server_hosts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ldap_type: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_user_filter: Optional[pulumi.Input[builtins.str]] = None,
                 member_filter: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_cc_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_cc_client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_discovery_url: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_ping_identity_region: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_ropc_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_ropc_client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_type: Optional[pulumi.Input[builtins.str]] = None,
                 scim_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 scim_secret_token: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Nacidp resource.
        :param pulumi.Input[builtins.str] idp_type: enum: `ldap`, `mxedge_proxy`, `oauth`
        :param pulumi.Input[builtins.str] group_filter: Required if `ldap_type`==`custom`, LDAP filter that will identify the type of group
        :param pulumi.Input[builtins.str] ldap_base_dn: Required if `idp_type`==`ldap`, whole domain or a specific organization unit (container) in Search base to specify where users and groups are found in the LDAP tree
        :param pulumi.Input[builtins.str] ldap_bind_dn: Required if `idp_type`==`ldap`, the account used to authenticate against the LDAP
        :param pulumi.Input[builtins.str] ldap_bind_password: Required if `idp_type`==`ldap`, the password used to authenticate against the LDAP
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ldap_cacerts: Required if `idp_type`==`ldap`, list of CA certificates to validate the LDAP certificate
        :param pulumi.Input[builtins.str] ldap_client_cert: If `idp_type`==`ldap`, LDAPS Client certificate
        :param pulumi.Input[builtins.str] ldap_client_key: If `idp_type`==`ldap`, Key for the `ldap_client_cert`
        :param pulumi.Input[builtins.str] ldap_group_attr: If `ldap_type`==`custom`
        :param pulumi.Input[builtins.str] ldap_group_dn: If `ldap_type`==`custom`
        :param pulumi.Input[builtins.bool] ldap_resolve_groups: If `idp_type`==`ldap`, whether to recursively resolve LDAP groups
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ldap_server_hosts: If `idp_type`==`ldap`, list of LDAP/LDAPS server IP Addresses or Hostnames
        :param pulumi.Input[builtins.str] ldap_type: if `idp_type`==`ldap`. enum: `azure`, `custom`, `google`, `okta`, `ping_identity`
        :param pulumi.Input[builtins.str] ldap_user_filter: Required if `ldap_type`==`custom`, LDAP filter that will identify the type of user
        :param pulumi.Input[builtins.str] member_filter: Required if `ldap_type`==`custom`,LDAP filter that will identify the type of member
        :param pulumi.Input[builtins.str] name: Name
        :param pulumi.Input[builtins.str] oauth_cc_client_id: Required if `idp_type`==`oauth`, Client Credentials
        :param pulumi.Input[builtins.str] oauth_cc_client_secret: Required if `idp_type`==`oauth`, oauth*cc*client_secret is RSA private key, of the form "-----BEGIN RSA PRIVATE KEY--...."
        :param pulumi.Input[builtins.str] oauth_discovery_url: If `idp_type`==`oauth`
        :param pulumi.Input[builtins.str] oauth_ping_identity_region: enum: `us` (United States, default), `ca` (Canada), `eu` (Europe), `asia` (Asia), `au` (Australia)
        :param pulumi.Input[builtins.str] oauth_ropc_client_id: If `idp_type`==`oauth`, ropc = Resource Owner Password Credentials
        :param pulumi.Input[builtins.str] oauth_ropc_client_secret: If `oauth_type`==`azure` or `oauth_type`==`azure-gov`. oauth*ropc*client_secret can be empty
        :param pulumi.Input[builtins.str] oauth_tenant_id: Required if `idp_type`==`oauth`, oauth*tenant*id
        :param pulumi.Input[builtins.str] oauth_type: if `idp_type`==`oauth`. enum: `azure`, `azure-gov`, `okta`, `ping_identity`
        :param pulumi.Input[builtins.bool] scim_enabled: If `idp_type`==`oauth`, indicates if SCIM provisioning is enabled for the OAuth IDP
        :param pulumi.Input[builtins.str] scim_secret_token: If `idp_type`==`oauth`, scim*secret*token (auto-generated when not provided by caller and `scim_enabled`==`true`, empty string when `scim_enabled`==`false`) is used as the Bearer token in the Authorization header of SCIM provisioning requests by the IDP
        """
    ...
    def idp_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @idp_type.setter
    def idp_type(self, value: pulumi.Input[builtins.str]):
    ...
    def group_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @group_filter.setter
    def group_filter(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ldap_bind_dn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ldap_bind_dn.setter
    def ldap_bind_dn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_bind_dn", value)

    @property
    @pulumi.getter(name="ldapBindPassword")
    def ldap_bind_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ldap_bind_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_bind_password", value)

    @property
    @pulumi.getter(name="ldapCacerts")
    def ldap_cacerts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @ldap_cacerts.setter
    def ldap_cacerts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "ldap_cacerts", value)

    @property
    @pulumi.getter(name="ldapClientCert")
    def ldap_client_cert(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ldap_client_cert(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_client_cert", value)

    @property
    @pulumi.getter(name="ldapClientKey")
    def ldap_client_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ldap_client_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_client_key", value)

    @property
    @pulumi.getter(name="ldapGroupAttr")
    def ldap_group_attr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If `ldap_type`==`custom`
        """
    ...
    def ldap_group_attr(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ldap_resolve_groups(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ldap_resolve_groups(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ldap_resolve_groups", value)

    @property
    @pulumi.getter(name="ldapServerHosts")
    def ldap_server_hosts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ldap_server_hosts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def ldap_user_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ldap_user_filter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_user_filter", value)

    @property
    @pulumi.getter(name="memberFilter")
    def member_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def member_filter(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def oauth_cc_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth_cc_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_cc_client_id", value)

    @property
    @pulumi.getter(name="oauthCcClientSecret")
    def oauth_cc_client_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth_cc_client_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_cc_client_secret", value)

    @property
    @pulumi.getter(name="oauthDiscoveryUrl")
    def oauth_discovery_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If `idp_type`==`oauth`
        """
    ...
    def oauth_discovery_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_discovery_url", value)

    @property
    @pulumi.getter(name="oauthPingIdentityRegion")
    def oauth_ping_identity_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth_ping_identity_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_ping_identity_region", value)

    @property
    @pulumi.getter(name="oauthRopcClientId")
    def oauth_ropc_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth_ropc_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_ropc_client_id", value)

    @property
    @pulumi.getter(name="oauthRopcClientSecret")
    def oauth_ropc_client_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth_ropc_client_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_ropc_client_secret", value)

    @property
    @pulumi.getter(name="oauthTenantId")
    def oauth_tenant_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth_tenant_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_tenant_id", value)

    @property
    @pulumi.getter(name="oauthType")
    def oauth_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @oauth_type.setter
    def oauth_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth_type", value)

    @property
    @pulumi.getter(name="scimEnabled")
    def scim_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @scim_enabled.setter
    def scim_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "scim_enabled", value)

    @property
    @pulumi.getter(name="scimSecretToken")
    def scim_secret_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scim_secret_token(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Nacidp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            scim_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            scim_secret_token: Optional[pulumi.Input[builtins.str]] = None) -> 'Nacidp':
        """
    ...
    @property
    @pulumi.getter(name="groupFilter")
    def group_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `ldap_type`==`custom`, LDAP filter that will identify the type of group
        """
        return pulumi.get(self, "group_filter")
    ...
    @property
    @pulumi.getter(name="ldapBaseDn")
    def ldap_base_dn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `idp_type`==`ldap`, whole domain or a specific organization unit (container) in Search base to specify where users and groups are found in the LDAP tree
        """
        return pulumi.get(self, "ldap_base_dn")
    ...
    @property
    @pulumi.getter(name="ldapBindDn")
    def ldap_bind_dn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `idp_type`==`ldap`, the account used to authenticate against the LDAP
        """
        return pulumi.get(self, "ldap_bind_dn")
    ...
    @property
    @pulumi.getter(name="ldapBindPassword")
    def ldap_bind_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `idp_type`==`ldap`, the password used to authenticate against the LDAP
        """
        return pulumi.get(self, "ldap_bind_password")
    ...
    @property
    @pulumi.getter(name="ldapCacerts")
    def ldap_cacerts(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Required if `idp_type`==`ldap`, list of CA certificates to validate the LDAP certificate
        """
        return pulumi.get(self, "ldap_cacerts")
    ...
    @property
    @pulumi.getter(name="ldapClientCert")
    def ldap_client_cert(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `idp_type`==`ldap`, LDAPS Client certificate
        """
        return pulumi.get(self, "ldap_client_cert")
    ...
    @property
    @pulumi.getter(name="ldapClientKey")
    def ldap_client_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `idp_type`==`ldap`, Key for the `ldap_client_cert`
        """
        return pulumi.get(self, "ldap_client_key")
    ...
    @property
    @pulumi.getter(name="ldapGroupAttr")
    def ldap_group_attr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `ldap_type`==`custom`
        """
        return pulumi.get(self, "ldap_group_attr")
    ...
    @property
    @pulumi.getter(name="ldapResolveGroups")
    def ldap_resolve_groups(self) -> pulumi.Output[builtins.bool]:
        """
        If `idp_type`==`ldap`, whether to recursively resolve LDAP groups
        """
        return pulumi.get(self, "ldap_resolve_groups")
    ...
    @property
    @pulumi.getter(name="ldapServerHosts")
    def ldap_server_hosts(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        If `idp_type`==`ldap`, list of LDAP/LDAPS server IP Addresses or Hostnames
        """
        return pulumi.get(self, "ldap_server_hosts")
    ...
    @property
    @pulumi.getter(name="ldapUserFilter")
    def ldap_user_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `ldap_type`==`custom`, LDAP filter that will identify the type of user
        """
        return pulumi.get(self, "ldap_user_filter")
    ...
    @property
    @pulumi.getter(name="memberFilter")
    def member_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `ldap_type`==`custom`,LDAP filter that will identify the type of member
        """
        return pulumi.get(self, "member_filter")
    ...
    @property
    @pulumi.getter(name="oauthCcClientId")
    def oauth_cc_client_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `idp_type`==`oauth`, Client Credentials
        """
        return pulumi.get(self, "oauth_cc_client_id")
    ...
    @property
    @pulumi.getter(name="oauthCcClientSecret")
    def oauth_cc_client_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `idp_type`==`oauth`, oauth*cc*client_secret is RSA private key, of the form "-----BEGIN RSA PRIVATE KEY--...."
        """
        return pulumi.get(self, "oauth_cc_client_secret")
    ...
    @property
    @pulumi.getter(name="oauthDiscoveryUrl")
    def oauth_discovery_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `idp_type`==`oauth`
        """
        return pulumi.get(self, "oauth_discovery_url")
    ...
    @property
    @pulumi.getter(name="oauthPingIdentityRegion")
    def oauth_ping_identity_region(self) -> pulumi.Output[builtins.str]:
        """
        enum: `us` (United States, default), `ca` (Canada), `eu` (Europe), `asia` (Asia), `au` (Australia)
        """
        return pulumi.get(self, "oauth_ping_identity_region")
    ...
    @property
    @pulumi.getter(name="oauthRopcClientId")
    def oauth_ropc_client_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `idp_type`==`oauth`, ropc = Resource Owner Password Credentials
        """
        return pulumi.get(self, "oauth_ropc_client_id")
    ...
    @property
    @pulumi.getter(name="oauthRopcClientSecret")
    def oauth_ropc_client_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `oauth_type`==`azure` or `oauth_type`==`azure-gov`. oauth*ropc*client_secret can be empty
        """
        return pulumi.get(self, "oauth_ropc_client_secret")
    ...
    @property
    @pulumi.getter(name="oauthTenantId")
    def oauth_tenant_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Required if `idp_type`==`oauth`, oauth*tenant*id
        """
        return pulumi.get(self, "oauth_tenant_id")
    ...
    @property
    @pulumi.getter(name="oauthType")
    def oauth_type(self) -> pulumi.Output[builtins.str]:
        """
        if `idp_type`==`oauth`. enum: `azure`, `azure-gov`, `okta`, `ping_identity`
        """
        return pulumi.get(self, "oauth_type")
    ...
    @property
    @pulumi.getter(name="scimEnabled")
    def scim_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        If `idp_type`==`oauth`, indicates if SCIM provisioning is enabled for the OAuth IDP
        """
        return pulumi.get(self, "scim_enabled")
    ...
    @property
    @pulumi.getter(name="scimSecretToken")
    def scim_secret_token(self) -> pulumi.Output[builtins.str]:
        """
        If `idp_type`==`oauth`, scim*secret*token (auto-generated when not provided by caller and `scim_enabled`==`true`, empty string when `scim_enabled`==`false`) is used as the Bearer token in the Authorization header of SCIM provisioning requests by the IDP
        """
        return pulumi.get(self, "scim_secret_token")
