...
def get_versions(model: Optional[_builtins.str] = None,
    ...
    :param _builtins.str model: Fetch version for device model, use/combine with `type` as needed (for switch and gateway devices)
