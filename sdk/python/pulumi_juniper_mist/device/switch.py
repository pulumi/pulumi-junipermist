...
class SwitchArgs:
    def __init__(__self__, *,
                 ...
                 disable_auto_config: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 use_router_id_as_source_ip: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] router_id: Used for OSPF / BGP / EVPN
        :param pulumi.Input['SwitchSwitchMgmtArgs'] switch_mgmt: Switch settings
        :param pulumi.Input[builtins.bool] use_router_id_as_source_ip: Whether to use it for snmp / syslog / tacplus / radius
    ...
    def disable_auto_config(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def use_router_id_as_source_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_router_id_as_source_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SwitchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SwitchSwitchMgmtArgs'] switch_mgmt: Switch settings
        :param pulumi.Input[builtins.str] type: Device Type. enum: `switch`
        :param pulumi.Input[builtins.bool] use_router_id_as_source_ip: Whether to use it for snmp / syslog / tacplus / radius
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] vars: Dictionary of name->value, the vars can then be used in Wlans. This can overwrite those from Site Vars
        :param pulumi.Input['SwitchVirtualChassisArgs'] virtual_chassis: Required for preprovisioned Virtual Chassis
        :param pulumi.Input[Mapping[str, pulumi.Input['SwitchVrfInstancesArgs']]] vrf_instances: Property key is the network name
...
class Switch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vrrp_config: Optional[pulumi.Input[Union['SwitchVrrpConfigArgs', 'SwitchVrrpConfigArgsDict']]] = None,
            x: Optional[pulumi.Input[builtins.float]] = None,
            y: Optional[pulumi.Input[builtins.float]] = None) -> 'Switch':
        """
    ...
    @property
    @pulumi.getter(name="useRouterIdAsSourceIp")
    def use_router_id_as_source_ip(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to use it for snmp / syslog / tacplus / radius
        """
        return pulumi.get(self, "use_router_id_as_source_ip")
