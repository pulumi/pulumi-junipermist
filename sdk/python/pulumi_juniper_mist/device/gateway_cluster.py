...
class GatewayClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GatewayClusterNodeArgs']]] nodes: Gateway nodes that form the HA cluster
        """
...
class GatewayCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['GatewayClusterNodeArgs', 'GatewayClusterNodeArgsDict']]]] nodes: Gateway nodes that form the HA cluster
        """
        ...
    @overload
    def __init__(__self__,
