...
class ApArgs:
    def __init__(__self__, *,
                 ...
                 disable_eth1: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_eth2: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_eth3: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] disable_eth1: Whether to disable eth1 port
        :param pulumi.Input[builtins.bool] disable_eth2: Whether to disable eth2 port
        :param pulumi.Input[builtins.bool] disable_eth3: Whether to disable eth3 port
        :param pulumi.Input[builtins.bool] disable_module: Whether to disable module port
        :param pulumi.Input[builtins.bool] flow_control: For some AP models, flow_control can be enabled to address some switch compatibility issue
        :param pulumi.Input[builtins.float] height: Height, in meters, optional
        :param pulumi.Input['ApIpConfigArgs'] ip_config: IP AP settings
        :param pulumi.Input['ApLedArgs'] led: LED AP settings
        :param pulumi.Input[builtins.bool] locked: Whether this map is considered locked down
        ...
        :param pulumi.Input[builtins.float] x: X in pixel
        :param pulumi.Input[builtins.float] y: Y in pixel
        """
    ...
    def disable_eth1(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @disable_eth1.setter
    def disable_eth1(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_eth1", value)

    @property
    @pulumi.getter(name="disableEth2")
    def disable_eth2(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @disable_eth2.setter
    def disable_eth2(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_eth2", value)

    @property
    @pulumi.getter(name="disableEth3")
    def disable_eth3(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @disable_eth3.setter
    def disable_eth3(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_eth3", value)

    @property
    @pulumi.getter(name="disableModule")
    def disable_module(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_module(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def flow_control(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @flow_control.setter
    def flow_control(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def orientation(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @orientation.setter
    def orientation(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "orientation", value)

    @property
    @pulumi.getter(name="poePassthrough")
    def poe_passthrough(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def poe_passthrough(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ApState:
    def __init__(__self__, *,
                 ...
                 flow_control: Optional[pulumi.Input[builtins.bool]] = None,
                 height: Optional[pulumi.Input[builtins.float]] = None,
                 image1_url: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def image1_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "image1_url")

    @image1_url.setter
    def image1_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image1_url", value)

    @property
    @pulumi.getter(name="image2Url")
    def image2_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "image2_url")

    @image2_url.setter
    def image2_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image2_url", value)

    @property
    @pulumi.getter(name="image3Url")
    def image3_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "image3_url")

    @image3_url.setter
    def image3_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Ap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vars: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            x: Optional[pulumi.Input[builtins.float]] = None,
            y: Optional[pulumi.Input[builtins.float]] = None) -> 'Ap':
        """
    ...
    @property
    @pulumi.getter(name="disableEth1")
    def disable_eth1(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to disable eth1 port
        """
        return pulumi.get(self, "disable_eth1")
    ...
    @property
    @pulumi.getter(name="disableEth2")
    def disable_eth2(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to disable eth2 port
        """
        return pulumi.get(self, "disable_eth2")
    ...
    @property
    @pulumi.getter(name="disableEth3")
    def disable_eth3(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to disable eth3 port
        """
        return pulumi.get(self, "disable_eth3")
    ...
    @property
    @pulumi.getter(name="disableModule")
    def disable_module(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to disable module port
        """
        return pulumi.get(self, "disable_module")
    ...
    @property
    @pulumi.getter(name="flowControl")
    def flow_control(self) -> pulumi.Output[builtins.bool]:
        """
        For some AP models, flow_control can be enabled to address some switch compatibility issue
        """
        return pulumi.get(self, "flow_control")
    ...
    @property
    @pulumi.getter
    def height(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Height, in meters, optional
        """
        return pulumi.get(self, "height")
    ...
    @property
    @pulumi.getter(name="image1Url")
    def image1_url(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "image1_url")

    @property
    @pulumi.getter(name="image2Url")
    def image2_url(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "image2_url")

    @property
    @pulumi.getter(name="image3Url")
    def image3_url(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "image3_url")
    ...
    @property
    @pulumi.getter
    def orientation(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Orientation, 0-359, in degrees, up is 0, right is 90.
        """
        return pulumi.get(self, "orientation")
    ...
    @property
    @pulumi.getter(name="poePassthrough")
    def poe_passthrough(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable power out through module port (for APH) or eth1 (for APL/BT11)
        """
        return pulumi.get(self, "poe_passthrough")
