...
@pulumi.type_token("junipermist:device/gateway:Gateway")
class Gateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vrf_instances: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union['GatewayVrfInstancesArgs', 'GatewayVrfInstancesArgsDict']]]]] = None,
            x: Optional[pulumi.Input[builtins.float]] = None,
            y: Optional[pulumi.Input[builtins.float]] = None) -> 'Gateway':
        """
    ...
    @property
    @pulumi.getter(name="mspId")
    def msp_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "msp_id")
