...
namespace Pulumi.JuniperMist.Device.Inputs
{
    ...
    public sealed class GatewayTunnelProviderOptionsZscalerGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("subLocations")]
        private InputList<Inputs.GatewayTunnelProviderOptionsZscalerSubLocationGetArgs>? _subLocations;

        /// <summary>
        /// `sub-locations` can be used for specific uses cases to define different configuration based on the user network
        /// </summary>
        public InputList<Inputs.GatewayTunnelProviderOptionsZscalerSubLocationGetArgs> SubLocations
        {
            get => _subLocations ?? (_subLocations = new InputList<Inputs.GatewayTunnelProviderOptionsZscalerSubLocationGetArgs>());
        ...
        public GatewayTunnelProviderOptionsZscalerGetArgs()
        {
        }
        public static new GatewayTunnelProviderOptionsZscalerGetArgs Empty => new GatewayTunnelProviderOptionsZscalerGetArgs();
    }
}
