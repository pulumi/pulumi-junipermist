...
namespace Pulumi.JuniperMist.Device.Inputs
{
    ...
    public sealed class SwitchPortUsagesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("rules")]
        private InputList<Inputs.SwitchPortUsagesRuleArgs>? _rules;

        /// <summary>
        /// Only if `Mode`==`Dynamic`
        /// </summary>
        public InputList<Inputs.SwitchPortUsagesRuleArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.SwitchPortUsagesRuleArgs>());
            set => _rules = value;
        }
        ...
        /// </summary>
        [Input("stormControl")]
        public Input<Inputs.SwitchPortUsagesStormControlArgs>? StormControl { get; set; }
        ...
        public SwitchPortUsagesArgs()
        {
        }
        public static new SwitchPortUsagesArgs Empty => new SwitchPortUsagesArgs();
    }
}
