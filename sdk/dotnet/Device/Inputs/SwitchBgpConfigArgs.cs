...
namespace Pulumi.JuniperMist.Device.Inputs
{
    ...
    public sealed class SwitchBgpConfigArgs : global::Pulumi.ResourceArgs
    {
        [Input("authKey")]
        ...
        [Input("neighbors")]
        private InputMap<Inputs.SwitchBgpConfigNeighborsArgs>? _neighbors;

        /// <summary>
        /// Property key is the BGP Neighbor IP Address.
        /// </summary>
        public InputMap<Inputs.SwitchBgpConfigNeighborsArgs> Neighbors
        {
            get => _neighbors ?? (_neighbors = new InputMap<Inputs.SwitchBgpConfigNeighborsArgs>());
        ...
        public SwitchBgpConfigArgs()
        {
        }
        public static new SwitchBgpConfigArgs Empty => new SwitchBgpConfigArgs();
    }
}
