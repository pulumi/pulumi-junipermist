...
namespace Pulumi.JuniperMist.Device.Inputs
{
    ...
    public sealed class GatewayPortConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ipConfig")]
        public Input<Inputs.GatewayPortConfigIpConfigArgs>? IpConfig { get; set; }
        ...
        public Input<Inputs.GatewayPortConfigTrafficShapingArgs>? TrafficShaping { get; set; }
        ...
        [Input("vpnPaths")]
        private InputMap<Inputs.GatewayPortConfigVpnPathsArgs>? _vpnPaths;

        /// <summary>
        /// Property key is the VPN name
        /// </summary>
        public InputMap<Inputs.GatewayPortConfigVpnPathsArgs> VpnPaths
        {
            get => _vpnPaths ?? (_vpnPaths = new InputMap<Inputs.GatewayPortConfigVpnPathsArgs>());
            set => _vpnPaths = value;
        }
        ...
        {
            get => _wanExtraRoutes ?? (_wanExtraRoutes = new InputMap<Inputs.GatewayPortConfigWanExtraRoutesArgs>());
            set => _wanExtraRoutes = value;
        }

        [Input("wanExtraRoutes6")]
        private InputMap<Inputs.GatewayPortConfigWanExtraRoutes6Args>? _wanExtraRoutes6;

        /// <summary>
        /// Only if `usage`==`wan`. Property Key is the destination CIDR (e.g. "2a02:1234:420a:10c9::/64")
        /// </summary>
        public InputMap<Inputs.GatewayPortConfigWanExtraRoutes6Args> WanExtraRoutes6
        {
            get => _wanExtraRoutes6 ?? (_wanExtraRoutes6 = new InputMap<Inputs.GatewayPortConfigWanExtraRoutes6Args>());
        ...
        public Input<Inputs.GatewayPortConfigWanProbeOverrideArgs>? WanProbeOverride { get; set; }

        /// <summary>
        /// Only if `usage`==`wan`, optional. By default, source-NAT is performed on all WAN Ports using the interface-ip
        /// </summary>
        [Input("wanSourceNat")]
        public Input<Inputs.GatewayPortConfigWanSourceNatArgs>? WanSourceNat { get; set; }
        ...
        public GatewayPortConfigArgs()
        {
        }
        public static new GatewayPortConfigArgs Empty => new GatewayPortConfigArgs();
    }
}
