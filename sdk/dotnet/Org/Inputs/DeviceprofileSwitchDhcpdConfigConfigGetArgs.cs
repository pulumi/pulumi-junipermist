...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchDhcpdConfigConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("dnsServers")]
        ...
        [Input("fixedBindings")]
        private InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigFixedBindingsGetArgs>? _fixedBindings;

        /// <summary>
        /// If `Type`==`Server` or `Type6`==`Server`, fixed client bindings for DHCP service
        /// </summary>
        public InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigFixedBindingsGetArgs> FixedBindings
        {
            get => _fixedBindings ?? (_fixedBindings = new InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigFixedBindingsGetArgs>());
        ...
        [Input("options")]
        private InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigOptionsGetArgs>? _options;

        /// <summary>
        /// If `Type`==`Server` or `Type6`==`Server`, custom DHCP options advertised to clients
        /// </summary>
        public InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigOptionsGetArgs> Options
        {
            get => _options ?? (_options = new InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigOptionsGetArgs>());
            set => _options = value;
        }
        ...
        private InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulatedGetArgs>? _vendorEncapsulated;

        /// <summary>
        /// If `Type`==`Server` or `Type6`==`Server`, vendor-encapsulated DHCP options advertised to clients
        /// </summary>
        public InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulatedGetArgs> VendorEncapsulated
        {
            get => _vendorEncapsulated ?? (_vendorEncapsulated = new InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulatedGetArgs>());
            set => _vendorEncapsulated = value;
        }

        public DeviceprofileSwitchDhcpdConfigConfigGetArgs()
        {
        }
        public static new DeviceprofileSwitchDhcpdConfigConfigGetArgs Empty => new DeviceprofileSwitchDhcpdConfigConfigGetArgs();
    }
}
