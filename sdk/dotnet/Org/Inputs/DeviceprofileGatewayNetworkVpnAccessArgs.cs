...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileGatewayNetworkVpnAccessArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputMap<Inputs.DeviceprofileGatewayNetworkVpnAccessDestinationNatArgs>? _destinationNat;
        ...
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayNetworkVpnAccessDestinationNatArgs> DestinationNat
        {
            get => _destinationNat ?? (_destinationNat = new InputMap<Inputs.DeviceprofileGatewayNetworkVpnAccessDestinationNatArgs>());
        ...
        /// </summary>
        [Input("sourceNat")]
        public Input<Inputs.DeviceprofileGatewayNetworkVpnAccessSourceNatArgs>? SourceNat { get; set; }

        [Input("staticNat")]
        private InputMap<Inputs.DeviceprofileGatewayNetworkVpnAccessStaticNatArgs>? _staticNat;

        /// <summary>
        /// Property key may be an External IP Address (i.e. "63.16.0.3"), a CIDR (i.e. "63.16.0.12/20") or a Variable (i.e. "{{myvar}}")
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayNetworkVpnAccessStaticNatArgs> StaticNat
        {
            get => _staticNat ?? (_staticNat = new InputMap<Inputs.DeviceprofileGatewayNetworkVpnAccessStaticNatArgs>());
        ...
        public DeviceprofileGatewayNetworkVpnAccessArgs()
        {
        }
        public static new DeviceprofileGatewayNetworkVpnAccessArgs Empty => new DeviceprofileGatewayNetworkVpnAccessArgs();
    }
}
