...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileApPortConfigRadsecArgs : global::Pulumi.ResourceArgs
    {
        [Input("coaEnabled")]
        ...
        [Input("servers")]
        private InputList<Inputs.DeviceprofileApPortConfigRadsecServerArgs>? _servers;

        /// <summary>
        /// List of RadSec Servers. Only if not Mist Edge.
        /// </summary>
        public InputList<Inputs.DeviceprofileApPortConfigRadsecServerArgs> Servers
        {
            get => _servers ?? (_servers = new InputList<Inputs.DeviceprofileApPortConfigRadsecServerArgs>());
            set => _servers = value;
        }
        ...
        public DeviceprofileApPortConfigRadsecArgs()
        {
        }
        public static new DeviceprofileApPortConfigRadsecArgs Empty => new DeviceprofileApPortConfigRadsecArgs();
    }
}
