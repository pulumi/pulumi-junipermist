...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchExtraRoutesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("nextQualified")]
        private InputMap<Inputs.DeviceprofileSwitchExtraRoutesNextQualifiedArgs>? _nextQualified;

        /// <summary>
        /// Qualified next-hop settings keyed by IPv4 next-hop address
        /// </summary>
        public InputMap<Inputs.DeviceprofileSwitchExtraRoutesNextQualifiedArgs> NextQualified
        {
            get => _nextQualified ?? (_nextQualified = new InputMap<Inputs.DeviceprofileSwitchExtraRoutesNextQualifiedArgs>());
        ...
        public DeviceprofileSwitchExtraRoutesArgs()
        {
        }
        public static new DeviceprofileSwitchExtraRoutesArgs Empty => new DeviceprofileSwitchExtraRoutesArgs();
    }
}
