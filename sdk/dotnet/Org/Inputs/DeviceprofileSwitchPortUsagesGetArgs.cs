...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchPortUsagesGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("rules")]
        private InputList<Inputs.DeviceprofileSwitchPortUsagesRuleGetArgs>? _rules;

        /// <summary>
        /// Only if `Mode`==`Dynamic`. Dynamic matching rules that select the port usage to apply
        /// </summary>
        public InputList<Inputs.DeviceprofileSwitchPortUsagesRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.DeviceprofileSwitchPortUsagesRuleGetArgs>());
            set => _rules = value;
        }
        ...
        /// </summary>
        [Input("stormControl")]
        public Input<Inputs.DeviceprofileSwitchPortUsagesStormControlGetArgs>? StormControl { get; set; }
        ...
        /// </summary>
        [Input("stpDisable")]
        public Input<bool>? StpDisable { get; set; }
        ...
        /// </summary>
        [Input("stpRequired")]
        public Input<bool>? StpRequired { get; set; }
        ...
        public DeviceprofileSwitchPortUsagesGetArgs()
        {
        }
        public static new DeviceprofileSwitchPortUsagesGetArgs Empty => new DeviceprofileSwitchPortUsagesGetArgs();
    }
}
