...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileGatewayDhcpdConfigConfigArgs : global::Pulumi.ResourceArgs
    {
        [Input("dnsServers")]
        ...
        [Input("fixedBindings")]
        private InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigFixedBindingsArgs>? _fixedBindings;

        /// <summary>
        /// If `type`==`local` or `type6`==`local`. Property key is the MAC Address. Format is `[0-9a-f]{12}` (e.g. "5684dae9ac8b")
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigFixedBindingsArgs> FixedBindings
        {
            get => _fixedBindings ?? (_fixedBindings = new InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigFixedBindingsArgs>());
        ...
        [Input("options")]
        private InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigOptionsArgs>? _options;

        /// <summary>
        /// If `type`==`local` or `type6`==`local`. Property key is the DHCP option number
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigOptionsArgs> Options
        {
            get => _options ?? (_options = new InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigOptionsArgs>());
            set => _options = value;
        }
        ...
        private InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigVendorEncapsulatedArgs>? _vendorEncapsulated;
        ...
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigVendorEncapsulatedArgs> VendorEncapsulated
        {
            get => _vendorEncapsulated ?? (_vendorEncapsulated = new InputMap<Inputs.DeviceprofileGatewayDhcpdConfigConfigVendorEncapsulatedArgs>());
            set => _vendorEncapsulated = value;
        }

        public DeviceprofileGatewayDhcpdConfigConfigArgs()
        {
        }
        public static new DeviceprofileGatewayDhcpdConfigConfigArgs Empty => new DeviceprofileGatewayDhcpdConfigConfigArgs();
    }
}
