...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchDhcpdConfigConfigArgs : global::Pulumi.ResourceArgs
    {
        [Input("dnsServers")]
        ...
        [Input("fixedBindings")]
        private InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigFixedBindingsArgs>? _fixedBindings;

        /// <summary>
        /// If `Type`==`Server` or `Type6`==`Server`, fixed client bindings for DHCP service
        /// </summary>
        public InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigFixedBindingsArgs> FixedBindings
        {
            get => _fixedBindings ?? (_fixedBindings = new InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigFixedBindingsArgs>());
        ...
        [Input("options")]
        private InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigOptionsArgs>? _options;

        /// <summary>
        /// If `Type`==`Server` or `Type6`==`Server`, custom DHCP options advertised to clients
        /// </summary>
        public InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigOptionsArgs> Options
        {
            get => _options ?? (_options = new InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigOptionsArgs>());
            set => _options = value;
        }
        ...
        private InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulatedArgs>? _vendorEncapsulated;

        /// <summary>
        /// If `Type`==`Server` or `Type6`==`Server`, vendor-encapsulated DHCP options advertised to clients
        /// </summary>
        public InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulatedArgs> VendorEncapsulated
        {
            get => _vendorEncapsulated ?? (_vendorEncapsulated = new InputMap<Inputs.DeviceprofileSwitchDhcpdConfigConfigVendorEncapsulatedArgs>());
            set => _vendorEncapsulated = value;
        }

        public DeviceprofileSwitchDhcpdConfigConfigArgs()
        {
        }
        public static new DeviceprofileSwitchDhcpdConfigConfigArgs Empty => new DeviceprofileSwitchDhcpdConfigConfigArgs();
    }
}
