...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchRemoteSyslogServerGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("contents")]
        private InputList<Inputs.DeviceprofileSwitchRemoteSyslogServerContentGetArgs>? _contents;

        /// <summary>
        /// Syslog facilities and severities sent to this server
        /// </summary>
        public InputList<Inputs.DeviceprofileSwitchRemoteSyslogServerContentGetArgs> Contents
        {
            get => _contents ?? (_contents = new InputList<Inputs.DeviceprofileSwitchRemoteSyslogServerContentGetArgs>());
            set => _contents = value;
        }
        ...
        public DeviceprofileSwitchRemoteSyslogServerGetArgs()
        {
        }
        public static new DeviceprofileSwitchRemoteSyslogServerGetArgs Empty => new DeviceprofileSwitchRemoteSyslogServerGetArgs();
    }
}
