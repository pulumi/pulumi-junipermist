...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class NetworkVpnAccessGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputMap<Inputs.NetworkVpnAccessDestinationNatGetArgs>? _destinationNat;

        /// <summary>
        /// Property key may be an IP/Port (i.e. "63.16.0.3:443"), or a port (i.e. ":2222")
        /// </summary>
        public InputMap<Inputs.NetworkVpnAccessDestinationNatGetArgs> DestinationNat
        {
            get => _destinationNat ?? (_destinationNat = new InputMap<Inputs.NetworkVpnAccessDestinationNatGetArgs>());
        ...
        [Input("staticNat")]
        private InputMap<Inputs.NetworkVpnAccessStaticNatGetArgs>? _staticNat;
        ...
        /// </summary>
        public InputMap<Inputs.NetworkVpnAccessStaticNatGetArgs> StaticNat
        {
            get => _staticNat ?? (_staticNat = new InputMap<Inputs.NetworkVpnAccessStaticNatGetArgs>());
        ...
        public NetworkVpnAccessGetArgs()
        {
        }
        public static new NetworkVpnAccessGetArgs Empty => new NetworkVpnAccessGetArgs();
    }
}
