...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchAclTagsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("etherTypes")]
        ...
        [Input("specs")]
        private InputList<Inputs.DeviceprofileSwitchAclTagsSpecGetArgs>? _specs;

        /// <summary>
        /// Layer 4 protocol and destination-port constraints for this ACL tag
        /// </summary>
        public InputList<Inputs.DeviceprofileSwitchAclTagsSpecGetArgs> Specs
        {
            get => _specs ?? (_specs = new InputList<Inputs.DeviceprofileSwitchAclTagsSpecGetArgs>());
            set => _specs = value;
        }
        ...
        public DeviceprofileSwitchAclTagsGetArgs()
        {
        }
        public static new DeviceprofileSwitchAclTagsGetArgs Empty => new DeviceprofileSwitchAclTagsGetArgs();
    }
}
