...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class GatewaytemplateDhcpdConfigConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("dnsServers")]
        ...
        {
            get => _fixedBindings ?? (_fixedBindings = new InputMap<Inputs.GatewaytemplateDhcpdConfigConfigFixedBindingsGetArgs>());
        ...
        {
            get => _options ?? (_options = new InputMap<Inputs.GatewaytemplateDhcpdConfigConfigOptionsGetArgs>());
            set => _options = value;
        }
        ...
        /// </summary>
        public InputMap<Inputs.GatewaytemplateDhcpdConfigConfigVendorEncapulatedGetArgs> VendorEncapulated
        {
            get => _vendorEncapulated ?? (_vendorEncapulated = new InputMap<Inputs.GatewaytemplateDhcpdConfigConfigVendorEncapulatedGetArgs>());
            set => _vendorEncapulated = value;
        }

        public GatewaytemplateDhcpdConfigConfigGetArgs()
        {
        }
        public static new GatewaytemplateDhcpdConfigConfigGetArgs Empty => new GatewaytemplateDhcpdConfigConfigGetArgs();
    }
}
