...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class NetworkVpnAccessArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputMap<Inputs.NetworkVpnAccessDestinationNatArgs>? _destinationNat;
        ...
        /// </summary>
        public InputMap<Inputs.NetworkVpnAccessDestinationNatArgs> DestinationNat
        {
            get => _destinationNat ?? (_destinationNat = new InputMap<Inputs.NetworkVpnAccessDestinationNatArgs>());
        ...
        /// </summary>
        [Input("sourceNat")]
        public Input<Inputs.NetworkVpnAccessSourceNatArgs>? SourceNat { get; set; }

        [Input("staticNat")]
        private InputMap<Inputs.NetworkVpnAccessStaticNatArgs>? _staticNat;

        /// <summary>
        /// Property key may be an External IP Address (i.e. "63.16.0.3"), a CIDR (i.e. "63.16.0.12/20") or a Variable (i.e. "{{myvar}}")
        /// </summary>
        public InputMap<Inputs.NetworkVpnAccessStaticNatArgs> StaticNat
        {
            get => _staticNat ?? (_staticNat = new InputMap<Inputs.NetworkVpnAccessStaticNatArgs>());
        ...
        public NetworkVpnAccessArgs()
        {
        }
        public static new NetworkVpnAccessArgs Empty => new NetworkVpnAccessArgs();
    }
}
