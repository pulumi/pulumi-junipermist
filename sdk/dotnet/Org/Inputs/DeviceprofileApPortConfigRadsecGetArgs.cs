...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileApPortConfigRadsecGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("coaEnabled")]
        ...
        [Input("servers")]
        private InputList<Inputs.DeviceprofileApPortConfigRadsecServerGetArgs>? _servers;

        /// <summary>
        /// List of RadSec Servers. Only if not Mist Edge.
        /// </summary>
        public InputList<Inputs.DeviceprofileApPortConfigRadsecServerGetArgs> Servers
        {
            get => _servers ?? (_servers = new InputList<Inputs.DeviceprofileApPortConfigRadsecServerGetArgs>());
            set => _servers = value;
        }
        ...
        public DeviceprofileApPortConfigRadsecGetArgs()
        {
        }
        public static new DeviceprofileApPortConfigRadsecGetArgs Empty => new DeviceprofileApPortConfigRadsecGetArgs();
    }
}
