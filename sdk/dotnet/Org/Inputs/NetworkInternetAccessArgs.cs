...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class NetworkInternetAccessArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _destinationNat ?? (_destinationNat = new InputMap<Inputs.NetworkInternetAccessDestinationNatArgs>());
        ...
        [Input("staticNat")]
        private InputMap<Inputs.NetworkInternetAccessStaticNatArgs>? _staticNat;

        /// <summary>
        /// Property key may be an External IP Address (i.e. "63.16.0.3"), a CIDR (i.e. "63.16.0.12/20") or a Variable (i.e. "{{myvar}}")
        /// </summary>
        public InputMap<Inputs.NetworkInternetAccessStaticNatArgs> StaticNat
        {
            get => _staticNat ?? (_staticNat = new InputMap<Inputs.NetworkInternetAccessStaticNatArgs>());
            set => _staticNat = value;
        }

        public NetworkInternetAccessArgs()
        {
        }
        public static new NetworkInternetAccessArgs Empty => new NetworkInternetAccessArgs();
    }
}
