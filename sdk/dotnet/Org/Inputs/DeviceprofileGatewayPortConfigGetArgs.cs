...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileGatewayPortConfigGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ipConfig")]
        public Input<Inputs.DeviceprofileGatewayPortConfigIpConfigGetArgs>? IpConfig { get; set; }
        ...
        public Input<Inputs.DeviceprofileGatewayPortConfigTrafficShapingGetArgs>? TrafficShaping { get; set; }
        ...
        [Input("vpnPaths")]
        private InputMap<Inputs.DeviceprofileGatewayPortConfigVpnPathsGetArgs>? _vpnPaths;

        /// <summary>
        /// Property key is the VPN name
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayPortConfigVpnPathsGetArgs> VpnPaths
        {
            get => _vpnPaths ?? (_vpnPaths = new InputMap<Inputs.DeviceprofileGatewayPortConfigVpnPathsGetArgs>());
            set => _vpnPaths = value;
        }
        ...
        private InputMap<Inputs.DeviceprofileGatewayPortConfigWanExtraRoutesGetArgs>? _wanExtraRoutes;

        /// <summary>
        /// Only if `usage`==`wan`. Property Key is the destination CIDR (e.g. "100.100.100.0/24")
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayPortConfigWanExtraRoutesGetArgs> WanExtraRoutes
        {
            get => _wanExtraRoutes ?? (_wanExtraRoutes = new InputMap<Inputs.DeviceprofileGatewayPortConfigWanExtraRoutesGetArgs>());
            set => _wanExtraRoutes = value;
        }

        [Input("wanExtraRoutes6")]
        private InputMap<Inputs.DeviceprofileGatewayPortConfigWanExtraRoutes6GetArgs>? _wanExtraRoutes6;

        /// <summary>
        /// Only if `usage`==`wan`. Property Key is the destination CIDR (e.g. "2a02:1234:420a:10c9::/64")
        /// </summary>
        public InputMap<Inputs.DeviceprofileGatewayPortConfigWanExtraRoutes6GetArgs> WanExtraRoutes6
        {
            get => _wanExtraRoutes6 ?? (_wanExtraRoutes6 = new InputMap<Inputs.DeviceprofileGatewayPortConfigWanExtraRoutes6GetArgs>());
        ...
        public Input<Inputs.DeviceprofileGatewayPortConfigWanProbeOverrideGetArgs>? WanProbeOverride { get; set; }

        /// <summary>
        /// Only if `usage`==`wan`, optional. By default, source-NAT is performed on all WAN Ports using the interface-ip
        /// </summary>
        [Input("wanSourceNat")]
        public Input<Inputs.DeviceprofileGatewayPortConfigWanSourceNatGetArgs>? WanSourceNat { get; set; }
        ...
        public DeviceprofileGatewayPortConfigGetArgs()
        {
        }
        public static new DeviceprofileGatewayPortConfigGetArgs Empty => new DeviceprofileGatewayPortConfigGetArgs();
    }
}
