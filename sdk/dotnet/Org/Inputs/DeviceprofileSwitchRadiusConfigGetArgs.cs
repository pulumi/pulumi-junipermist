...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchRadiusConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("acctServers")]
        private InputList<Inputs.DeviceprofileSwitchRadiusConfigAcctServerGetArgs>? _acctServers;

        /// <summary>
        /// RADIUS accounting servers used by this switch configuration
        /// </summary>
        public InputList<Inputs.DeviceprofileSwitchRadiusConfigAcctServerGetArgs> AcctServers
        {
            get => _acctServers ?? (_acctServers = new InputList<Inputs.DeviceprofileSwitchRadiusConfigAcctServerGetArgs>());
        ...
        [Input("authServers")]
        private InputList<Inputs.DeviceprofileSwitchRadiusConfigAuthServerGetArgs>? _authServers;

        /// <summary>
        /// RADIUS authentication servers used by this switch configuration
        /// </summary>
        public InputList<Inputs.DeviceprofileSwitchRadiusConfigAuthServerGetArgs> AuthServers
        {
            get => _authServers ?? (_authServers = new InputList<Inputs.DeviceprofileSwitchRadiusConfigAuthServerGetArgs>());
        ...
        public DeviceprofileSwitchRadiusConfigGetArgs()
        {
        }
        public static new DeviceprofileSwitchRadiusConfigGetArgs Empty => new DeviceprofileSwitchRadiusConfigGetArgs();
    }
}
