...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchRemoteSyslogServerArgs : global::Pulumi.ResourceArgs
    {
        [Input("contents")]
        private InputList<Inputs.DeviceprofileSwitchRemoteSyslogServerContentArgs>? _contents;

        /// <summary>
        /// Syslog facilities and severities sent to this server
        /// </summary>
        public InputList<Inputs.DeviceprofileSwitchRemoteSyslogServerContentArgs> Contents
        {
            get => _contents ?? (_contents = new InputList<Inputs.DeviceprofileSwitchRemoteSyslogServerContentArgs>());
            set => _contents = value;
        }
        ...
        public DeviceprofileSwitchRemoteSyslogServerArgs()
        {
        }
        public static new DeviceprofileSwitchRemoteSyslogServerArgs Empty => new DeviceprofileSwitchRemoteSyslogServerArgs();
    }
}
