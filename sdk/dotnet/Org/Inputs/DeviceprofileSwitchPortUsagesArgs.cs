...
namespace Pulumi.JuniperMist.Org.Inputs
{
    ...
    public sealed class DeviceprofileSwitchPortUsagesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("rules")]
        private InputList<Inputs.DeviceprofileSwitchPortUsagesRuleArgs>? _rules;

        /// <summary>
        /// Only if `Mode`==`Dynamic`. Dynamic matching rules that select the port usage to apply
        /// </summary>
        public InputList<Inputs.DeviceprofileSwitchPortUsagesRuleArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.DeviceprofileSwitchPortUsagesRuleArgs>());
            set => _rules = value;
        }
        ...
        /// </summary>
        [Input("stormControl")]
        public Input<Inputs.DeviceprofileSwitchPortUsagesStormControlArgs>? StormControl { get; set; }
        ...
        public DeviceprofileSwitchPortUsagesArgs()
        {
        }
        public static new DeviceprofileSwitchPortUsagesArgs Empty => new DeviceprofileSwitchPortUsagesArgs();
    }
}
