...
namespace Pulumi.JuniperMist.Org.Outputs
{
    ...
    [OutputType]
    public sealed class GetWlansOrgWlanBonjourResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.GetWlansOrgWlanBonjourServicesResult> Services;

        [OutputConstructor]
        private GetWlansOrgWlanBonjourResult(
            ImmutableArray<string> additionalVlanIds,

            bool enabled,

            ImmutableDictionary<string, Outputs.GetWlansOrgWlanBonjourServicesResult> services)
        {
