...
namespace Pulumi.JuniperMist.Org.Outputs
{
    ...
    [OutputType]
    public sealed class GetNetworksOrgNetworkVpnAccessResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.GetNetworksOrgNetworkVpnAccessDestinationNatResult> DestinationNat;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetNetworksOrgNetworkVpnAccessSourceNatResult SourceNat;
        /// <summary>
        /// Property key may be an External IP Address (i.e. "63.16.0.3"), a CIDR (i.e. "63.16.0.12/20") or a Variable (i.e. "{{myvar}}")
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.GetNetworksOrgNetworkVpnAccessStaticNatResult> StaticNat;
        /// <summary>
        /// toward overlay, how HUB should deal with routes it received from Spokes
        /// </summary>
        ...
        [OutputConstructor]
        private GetNetworksOrgNetworkVpnAccessResult(
            string advertisedSubnet,

            bool allowPing,

            ImmutableDictionary<string, Outputs.GetNetworksOrgNetworkVpnAccessDestinationNatResult> destinationNat,
            ...
            Outputs.GetNetworksOrgNetworkVpnAccessSourceNatResult sourceNat,

            ImmutableDictionary<string, Outputs.GetNetworksOrgNetworkVpnAccessStaticNatResult> staticNat,
