...
namespace Pulumi.JuniperMist
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi/pulumi-junipermist";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.JuniperMist.version.txt");
    ...
    internal sealed class JuniperMistResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public JuniperMistResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
