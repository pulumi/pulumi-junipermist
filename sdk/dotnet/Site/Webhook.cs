...
namespace Pulumi.JuniperMist.Site
{
    ...
    /// ```
    /// </summary>
    [JuniperMistResourceType("junipermist:site/webhook:Webhook")]
    public partial class Webhook : global::Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("junipermist:site/webhook:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, WebhookState? state = null, CustomResourceOptions? options = null)
            : base("junipermist:site/webhook:Webhook", name, state, MakeResourceOptions(options, id))
        {
        }
