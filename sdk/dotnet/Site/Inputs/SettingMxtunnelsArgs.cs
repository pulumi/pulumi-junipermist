...
namespace Pulumi.JuniperMist.Site.Inputs
{
    ...
    public sealed class SettingMxtunnelsArgs : global::Pulumi.ResourceArgs
    {
        [Input("additionalMxtunnels")]
        private InputMap<Inputs.SettingMxtunnelsAdditionalMxtunnelsArgs>? _additionalMxtunnels;

        /// <summary>
        /// Additional named Mist Tunnel definitions configured for the site
        /// </summary>
        public InputMap<Inputs.SettingMxtunnelsAdditionalMxtunnelsArgs> AdditionalMxtunnels
        {
            get => _additionalMxtunnels ?? (_additionalMxtunnels = new InputMap<Inputs.SettingMxtunnelsAdditionalMxtunnelsArgs>());
        ...
        public Input<Inputs.SettingMxtunnelsAutoPreemptionArgs>? AutoPreemption { get; set; }

        [Input("clusters")]
        private InputList<Inputs.SettingMxtunnelsClusterArgs>? _clusters;

        /// <summary>
        /// Tunnel peer clusters used by APs for this site Mist Tunnel
        /// </summary>
        public InputList<Inputs.SettingMxtunnelsClusterArgs> Clusters
        {
            get => _clusters ?? (_clusters = new InputList<Inputs.SettingMxtunnelsClusterArgs>());
            set => _clusters = value;
        }
        ...
        /// </summary>
        [Input("radsec")]
        public Input<Inputs.SettingMxtunnelsRadsecArgs>? Radsec { get; set; }
        ...
        public SettingMxtunnelsArgs()
        {
        }
        public static new SettingMxtunnelsArgs Empty => new SettingMxtunnelsArgs();
    }
}
