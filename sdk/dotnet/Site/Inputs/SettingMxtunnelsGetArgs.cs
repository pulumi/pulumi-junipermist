...
namespace Pulumi.JuniperMist.Site.Inputs
{
    ...
    public sealed class SettingMxtunnelsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("additionalMxtunnels")]
        private InputMap<Inputs.SettingMxtunnelsAdditionalMxtunnelsGetArgs>? _additionalMxtunnels;

        /// <summary>
        /// Additional named Mist Tunnel definitions configured for the site
        /// </summary>
        public InputMap<Inputs.SettingMxtunnelsAdditionalMxtunnelsGetArgs> AdditionalMxtunnels
        {
            get => _additionalMxtunnels ?? (_additionalMxtunnels = new InputMap<Inputs.SettingMxtunnelsAdditionalMxtunnelsGetArgs>());
        ...
        public Input<Inputs.SettingMxtunnelsAutoPreemptionGetArgs>? AutoPreemption { get; set; }

        [Input("clusters")]
        private InputList<Inputs.SettingMxtunnelsClusterGetArgs>? _clusters;

        /// <summary>
        /// Tunnel peer clusters used by APs for this site Mist Tunnel
        /// </summary>
        public InputList<Inputs.SettingMxtunnelsClusterGetArgs> Clusters
        {
            get => _clusters ?? (_clusters = new InputList<Inputs.SettingMxtunnelsClusterGetArgs>());
            set => _clusters = value;
        }
        ...
        /// </summary>
        [Input("radsec")]
        public Input<Inputs.SettingMxtunnelsRadsecGetArgs>? Radsec { get; set; }
        ...
        public SettingMxtunnelsGetArgs()
        {
        }
        public static new SettingMxtunnelsGetArgs Empty => new SettingMxtunnelsGetArgs();
    }
}
