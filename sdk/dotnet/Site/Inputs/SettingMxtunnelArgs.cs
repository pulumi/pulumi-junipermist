...
namespace Pulumi.JuniperMist.Site.Inputs
{
    ...
    public sealed class SettingMxtunnelArgs : global::Pulumi.ResourceArgs
    {
        [Input("additionalMxtunnels")]
        private InputMap<Inputs.SettingMxtunnelAdditionalMxtunnelsArgs>? _additionalMxtunnels;

        /// <summary>
        /// Additional named Mist Tunnel definitions configured for the site
        /// </summary>
        public InputMap<Inputs.SettingMxtunnelAdditionalMxtunnelsArgs> AdditionalMxtunnels
        {
            get => _additionalMxtunnels ?? (_additionalMxtunnels = new InputMap<Inputs.SettingMxtunnelAdditionalMxtunnelsArgs>());
        ...
        public Input<Inputs.SettingMxtunnelAutoPreemptionArgs>? AutoPreemption { get; set; }

        [Input("clusters")]
        private InputList<Inputs.SettingMxtunnelClusterArgs>? _clusters;

        /// <summary>
        /// Tunnel peer clusters used by APs for this site Mist Tunnel
        /// </summary>
        public InputList<Inputs.SettingMxtunnelClusterArgs> Clusters
        {
            get => _clusters ?? (_clusters = new InputList<Inputs.SettingMxtunnelClusterArgs>());
            set => _clusters = value;
        }
        ...
        /// </summary>
        [Input("radsec")]
        public Input<Inputs.SettingMxtunnelRadsecArgs>? Radsec { get; set; }
        ...
        public SettingMxtunnelArgs()
        {
        }
        public static new SettingMxtunnelArgs Empty => new SettingMxtunnelArgs();
    }
}
